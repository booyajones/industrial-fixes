...
PARTS = {
    ...
    "refrigerator": ["water inlet valve", "evaporator fan motor", "condenser fan motor",
                     ...
                     "water filter", "door gasket", "start relay"],
    ...
    "water heater": ["heating element", "thermostat", "igniter", "flame sensor", "gas valve",
                     "thermocouple", "anode rod", "dip tube"],
}
BRANDS = {
    "washer": ["Whirlpool", "Samsung", "LG", "Maytag", "GE", "Frigidaire"],
    "dryer": ["Whirlpool", "Samsung", "LG", "Maytag", "GE"],
    "refrigerator": ["Samsung", "LG", "Whirlpool", "GE", "Frigidaire"],
    "dishwasher": ["Bosch", "Whirlpool", "Samsung", "LG", "KitchenAid", "GE"],
    "oven": ["Samsung", "LG", "Whirlpool", "GE", "Frigidaire"],
