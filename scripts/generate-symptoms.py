...
SYMPTOMS = {
    "washer": ["wont drain", "wont spin", "wont start", "leaking water", "wont fill with water",
               ...
               "not draining completely", "burning smell", "wont agitate", "smells like mildew",
               "overflowing", "not dispensing detergent", "stuck on one cycle"],
    "dryer": ["not heating", "wont start", "takes too long to dry", "wont tumble",
              "stops mid cycle", "no power", "squeaking", "shuts off early",
              "burning smell", "clothes still damp", "loud banging", "wont stop", "gets too hot"],
    "refrigerator": ["not cooling", "freezer not freezing", "too warm", "ice maker not working",
                     ...
                     "running constantly", "not making ice", "making loud noise",
                     "water leaking on floor", "fresh food warm but freezer cold", "light not working"],
    "dishwasher": ["not draining", "not cleaning dishes", "not drying", "leaking",
                   "wont start", "wont fill with water", "stuck mid cycle", "smells bad",
                   "not dispensing detergent", "standing water in bottom", "buttons not working", "wont latch"],
    "oven": ["not heating", "wont turn on", "temperature not accurate", "broiler not working",
             ...
             "wont stop beeping", "heats too hot", "clicking but wont light", "display not working"],
    "microwave": ["not heating", "turntable not turning", "wont start", "sparking",
                  "buttons not working", "runs but no heat", "wont turn off", "making loud noise", "door wont open"],
    "furnace": ["not heating", "wont turn on", "blowing cold air", "short cycling",
                "blower wont shut off", "igniter not working", "keeps shutting off", "making loud noise"],
    "mini split": ["not cooling", "not heating", "leaking water", "wont turn on",
                   "blowing warm air", "ice on coils", "not responding to remote", "making noise"],
    "water heater": ["no hot water", "not enough hot water", "water too hot", "leaking", "no ignition",
                     "pilot wont stay lit", "making popping noise", "rusty water"],
}
# Brands per appliance (US consumer demand).
BRANDS = {
    "washer": ["Samsung", "LG", "Whirlpool", "Maytag", "GE", "Frigidaire", "Kenmore", "Electrolux", "Amana", "Speed Queen", "Bosch"],
    "dryer": ["Samsung", "LG", "Whirlpool", "Maytag", "GE", "Kenmore", "Frigidaire", "Electrolux", "Amana"],
    "refrigerator": ["Samsung", "LG", "Whirlpool", "GE", "Frigidaire", "KitchenAid", "Kenmore", "Maytag", "Bosch", "Amana"],
    "dishwasher": ["Bosch", "Samsung", "LG", "Whirlpool", "KitchenAid", "GE", "Frigidaire", "Maytag", "Kenmore"],
    "oven": ["Samsung", "LG", "Whirlpool", "GE", "Frigidaire", "KitchenAid", "Maytag", "Kenmore"],
    "microwave": ["Samsung", "LG", "GE", "Whirlpool", "Frigidaire", "KitchenAid"],
    "furnace": ["Carrier", "Goodman", "Lennox", "Trane", "Rheem", "York"],
    "mini split": ["Mitsubishi", "Daikin", "LG", "Fujitsu", "Samsung"],
    "water heater": ["Rheem", "Navien", "Rinnai", "A.O. Smith", "Bradford White"],
}
...
def gen_one(t: dict, have: set[str]) -> tuple[str, str, str]:
    ...
    try:
        ...
        verdict = G.claude_review(topic, content, research)  # score logged only; the code-gate is mismatched for symptom pages
        publish = len(content.get("causes", [])) >= 3 and len(content.get("steps", [])) >= 4 and bool(content.get("parts"))
        with _lock:
            have_snap = set(have)
