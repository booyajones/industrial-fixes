---
title: "LG Dishwasher Leaking - Causes & Fix"
description: "Most LG dishwasher leaks come from a dirty or damaged door gasket. Clean debris from the seal or replace it if torn or deformed."
pubDatetime: 2026-06-10T12:48:51Z
modDatetime: 2026-06-10T12:48:51Z
...
1. Turn off power to the dishwasher at the circuit breaker or unplug the unit before any inspection or repair work.
2. Pull the dishwasher out and tip it back slightly to access the base pan, then remove any standing water with towels or a wet-dry vacuum and let the pan dry completely.
3. Inspect the door gasket for food debris, grease, tears, or gaps in contact with the tub and clean it thoroughly with warm soapy water or replace it if damaged.
4. Remove each spray arm and check for cracks, clogs in the spray holes, or broken mounting tabs, then clean or replace as needed.
5. Use a bubble level on the top edge of the open door to confirm the dishwasher is level side-to-side and front-to-back, and adjust the leveling feet if it tilts.
6. Check the water supply line connection under the sink at the 90-degree elbow and inlet valve threads for moisture, corrosion, or loose fittings and tighten or replace the joint if leaking.
7. Confirm household water pressure is above 20 PSI using a pressure gauge at a nearby faucet, as low pressure can cause erratic filling and potential leaks.
8. Run a short test cycle and monitor for new water in the base pan or at external connection points to verify the repair resolved the leak.

## Parts You Might Need

| Part | Notes |
|------|-------|
| LG dishwasher door gasket | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lg-dishwasher-leaking&k=LG+dishwasher+door+gasket&tag=errorcodefixes-20) \| Tub seal that runs around the door opening. |
| LG dishwasher spray arm | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lg-dishwasher-leaking&k=LG+dishwasher+spray+arm&tag=errorcodefixes-20) \| Upper or lower rotating wash arm, model-specific. |
| 90-degree water inlet elbow fitting | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lg-dishwasher-leaking&k=90-degree+water+inlet+elbow+fitting&tag=errorcodefixes-20) \| Compression or threaded elbow at the supply connection. |
