...
| Part | Notes |
|------|-------|
| Encoder backup battery | Okuma-specific lithium battery; replace every 3–5 years preventively |
| Encoder feedback cable | OEM Okuma cable; match to motor and drive model |
| Absolute encoder (Okuma OEM) | Requires Okuma service for replacement and calibration |
| Servo drive (SERVOPACK) | Replace if drive's encoder interface has failed |
