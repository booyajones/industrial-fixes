---
title: "Samsung Mini Split Making Noise - Causes & Fix"
description: "A dirty air filter or loose mounting is the most common cause. Clean the filter and check that the indoor unit sits level and secure."
pubDatetime: 2026-06-11T22:40:55Z
modDatetime: 2026-06-11T22:40:55Z
...
1. Identify the noise type (clicking, buzzing, squealing, rattling, whistling) and note whether it comes from the indoor or outdoor unit and when it occurs (startup, shutdown, steady run).
2. Confirm operating mode and remember that Samsung describes clicking at start-up or shutdown as normal operation.
3. Remove and inspect the indoor air filter for dust buildup, wash or replace it if clogged, and confirm nothing blocks the return or discharge grilles.
4. Check that the indoor unit hangs level on the wall bracket and that all mounting hardware is tight, then verify the outdoor unit sits flat on its pad or stand.
5. Remove the indoor front panel and grille, then look for foreign objects, loose screws, or anything contacting the blower wheel or fan shroud.
6. Spin the indoor blower wheel by hand (power off) and listen for bearing roughness, rubbing, or grinding that indicates motor or wheel wear.
7. Run the system in cooling, heating, and fan-only modes at different fan speeds to see whether the noise changes or disappears.
8. If you hear high-pitched whistling or screaming, shut the unit off immediately and call a technician for refrigerant or compressor diagnostics as Samsung instructs.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Samsung mini split air filter | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-mini-split-making-noise&k=Samsung+mini+split+air+filter&tag=errorcodefixes-20) \| Washable or replaceable depending on your indoor-unit model. |
| Indoor blower motor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-mini-split-making-noise&k=Indoor+blower+motor&tag=errorcodefixes-20) \| Required when bearing noise or squeal persists and the motor will not spin smoothly by hand. |
| Cabinet or grille mounting screws | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-mini-split-making-noise&k=Cabinet+or+grille+mounting+screws&tag=errorcodefixes-20) \| Replace any missing or stripped fasteners to eliminate vibration rattle. |
