...
| Part | Notes |
|------|-------|
| NTC temperature sensor | [Amazon](https://www.amazon.com/s?k=NTC+temperature+sensor&tag=errorcodefixes-20) \| Match to model — Turbo Air uses several sensor variants |
