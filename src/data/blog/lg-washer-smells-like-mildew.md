---
title: "LG Washer Smells Like Mildew - Causes & Fix"
description: "Usually caused by residue and trapped moisture in the gasket, drum, or detergent drawer. Run monthly Tub Clean cycles and leave the door open after use."
pubDatetime: 2026-06-08T12:47:48Z
modDatetime: 2026-06-08T12:47:48Z
...
1. Inspect the door gasket for slime, mold, or foreign objects trapped in the folds, and wipe it down with a damp cloth.
2. Remove and clean the detergent drawer with a brush to remove soap and fabric softener residue from the compartment and the drawer cavity.
3. Check the drain pump filter for debris, hair, or coins that can block drainage and leave water standing in the tub.
4. Run LG's Tub Clean cycle with an approved washer cleaner, and repeat monthly or more often if odor persists.
5. Verify that the drain hose is not inserted more than a few inches into the drainpipe, and check for kinks or slime inside the hose.
6. Confirm the customer is using the correct amount of HE detergent and leaving the door and detergent drawer open after every load to air out.
7. Run a second Tub Clean cycle if the first does not eliminate the smell, and inspect the gasket and drawer again for remaining residue.
8. If the odor continues after multiple cleanings, schedule a service call because LG states that severe mildew buildup may require professional cleaning or part replacement.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Door gasket (bellows) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lg-washer-smells-like-mildew&k=Door+gasket+%28bellows%29&tag=errorcodefixes-20) \| Replace if mold has penetrated the rubber or cleaning does not remove the odor. |
| Detergent drawer assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lg-washer-smells-like-mildew&k=Detergent+drawer+assembly&tag=errorcodefixes-20) \| Replace if residue buildup is severe or the drawer does not clean effectively. |
| Drain hose | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lg-washer-smells-like-mildew&k=Drain+hose&tag=errorcodefixes-20) \| Replace if the hose is slime-coated inside, kinked, or retaining odor after cleaning. |
