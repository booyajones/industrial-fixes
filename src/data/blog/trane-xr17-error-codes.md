...
| [Trane XR17 Control Board](https://www.amazon.com/s?k=Trane+XR17+outdoor+control+board+heat+pump&tag=errorcodefixes-20) | Replace on persistent defrost faults (code 184) or board failure | $150–$350 |
...
| [Start/Run Capacitor for Heat Pump](https://www.amazon.com/s?k=dual+run+capacitor+45+5+uf+440V+heat+pump&tag=errorcodefixes-20) | Failed capacitor causes compressor and fan start faults (5 blinks) | $15–$35 |
