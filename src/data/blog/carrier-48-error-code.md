...
| Part | Notes |
|---|---|
| Inducer motor | Match HP, RPM, and frame — Carrier HC21ZE117 is common |
| Run capacitor | Match µF and voltage — 370V minimum |
| Pressure switch | Match the negative pressure trip point |
| Pressure switch hose | Check for cracks at both ends |
