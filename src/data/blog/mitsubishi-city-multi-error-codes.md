...
| Part | Notes |
|------|-------|
| Electronic expansion valve (EEV) | Replace if P8 persists with adequate refrigerant charge |
| Communication cable (VCTF 0.75mm²) | Replace if continuity test shows broken communication conductor |
| Refrigerant charge (R-410A) | Add only after locating and repairing leak; EPA 608 certification required |
