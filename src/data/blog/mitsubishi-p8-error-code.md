...
| Part | Notes |
|------|-------|
| IPM (Intelligent Power Module) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-mitsubishi-p8-error-code&k=IPM+%28Intelligent+Power+Module%29&tag=errorcodefixes-20) \| Mitsubishi OEM; match outdoor unit model exactly |
| Outdoor unit main control board | [Amazon](https://www.amazon.com/dp/B0CNZGZ1HS?ascsubtag=ecf-mitsubishi-p8-error-code&tag=errorcodefixes-20) \| Often bundled with IPM on smaller units |
| Compressor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-mitsubishi-p8-error-code&k=Compressor&tag=errorcodefixes-20) \| Major repair; compare to new system cost for older units |
| Refrigerant (R-410A or R-32) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-mitsubishi-p8-error-code&k=Refrigerant+%28R-410A+or+R-32%29&tag=errorcodefixes-20) \| Requires licensed tech for handling |
## When to Call a Pro
