---
title: "HVAC Error Code Troubleshooting: Beginner's Complete Guide"
...
| [Equipment Type](https://www.amazon.com/s?ascsubtag=ecf-hvac-error-codes-guide&k=Equipment+Type&tag=errorcodefixes-20) | How Codes Display | Where to Look |
|---------------|------------------|---------------|
| [Gas furnace](https://www.amazon.com/s?ascsubtag=ecf-hvac-error-codes-guide&k=Gas+furnace&tag=errorcodefixes-20) | Blinking LED (flash count) | Lower access panel or sight glass |
| [Mini-split](https://www.amazon.com/s?ascsubtag=ecf-hvac-error-codes-guide&k=Mini-split&tag=errorcodefixes-20) | Alphanumeric display | Indoor unit LED or remote display |
| [Heat pump](https://www.amazon.com/s?ascsubtag=ecf-hvac-error-codes-guide&k=Heat+pump&tag=errorcodefixes-20) | Flash codes or display | Air handler control board |
| [Boiler](https://www.amazon.com/s?ascsubtag=ecf-hvac-error-codes-guide&k=Boiler&tag=errorcodefixes-20) | Alphanumeric display | Boiler control panel or display |
| VFD | Numeric/alphanumeric fault | Drive keypad display |
| [CNC machine](https://www.amazon.com/s?ascsubtag=ecf-hvac-error-codes-guide&k=CNC+machine&tag=errorcodefixes-20) | Alarm number + message | Controller screen |
| [Commercial refrigeration](https://www.amazon.com/s?ascsubtag=ecf-hvac-error-codes-guide&k=Commercial+refrigeration&tag=errorcodefixes-20) | E-codes or numeric | Controller display on unit |

## How to Read Flash Codes on a Furnace

1. Turn the thermostat to Heat and set the setpoint above room temperature
2. Open the lower furnace access panel
3. Find the LED light on the control board (usually green or amber)
4. Count the flashes in one complete cycle (the pattern repeats)
5. Match the count to your furnace's code chart (often printed on the inside of the access panel door)
