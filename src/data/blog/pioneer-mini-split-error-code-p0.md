...
| Part | Notes |
|------|-------|
| Condenser fan run capacitor | [Amazon](https://www.amazon.com/dp/B01M05L7B3?ascsubtag=ecf-pioneer-mini-split-error-code-p0&tag=errorcodefixes-20) \| Most common cause of fan-not-running high-pressure faults |
| Condenser fan motor | [Amazon](https://www.amazon.com/dp/B0D2L5NSMM?ascsubtag=ecf-pioneer-mini-split-error-code-p0&tag=errorcodefixes-20) \| Replace if capacitor check is good but motor is seized |
| High-pressure switch | [Amazon](https://www.amazon.com/dp/B013J2J97A?ascsubtag=ecf-pioneer-mini-split-error-code-p0&tag=errorcodefixes-20) \| Replace if opens below rated cutout pressure |
| Refrigerant (R-410A) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-pioneer-mini-split-error-code-p0&k=Refrigerant+%28R-410A%29&tag=errorcodefixes-20) \| Adjust charge only via certified technician with gauges |
## When to Call a Pro
