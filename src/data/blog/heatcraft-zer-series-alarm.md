...
| Part | Notes |
|------|-------|
| Room temperature probe | Replace on P1 alarms |
| Coil defrost probe | Replace on P2 alarms |
| Defrost heater | Check continuity if ice builds heavily |
| Evaporator fan motor | Replace on fan alarms or no airflow |
