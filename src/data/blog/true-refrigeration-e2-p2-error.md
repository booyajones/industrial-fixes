---
title: "True Refrigerator Error Code E2 / P2: Evaporator Probe Failure Causes and Fix"
...
- **Failed evaporator temperature probe**. The thermistor has gone open, shorted, or drifted far enough to trigger the alarm.
- **Probe wire damage near the evaporator cover**. Ice, vibration, and sheet metal edges can damage the lead where it enters the evaporator compartment.
- **Moisture intrusion at the connector**. Defrost water and condensation can corrode low voltage sensor connectors.
- **Probe pulled out of position**. If the sensor is no longer clipped to the evaporator where it belongs, the controller may read an impossible temperature.
- **Wrong sensor type installed**. A mismatched probe resistance curve can fool the controller into posting E2 or P2.
- **Controller input failure**. Less common, but possible after power surges or moisture damage.
...
- True Refrigeration E5 Error Code: Defrost Sensor Causes and Fix
