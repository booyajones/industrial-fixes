...
## Industrial Control Panel Faults — How to Diagnose Them
...
| Indicator | Meaning |
|-----------|---------|
| Power ON lamp off | No input power to panel — check supply breaker |
| Run lamp off (should be on) | Motor or drive not running — check fault log |
| Fault lamp on | Active fault — check fault display or PLC fault log |
| E-stop lamp on | Emergency stop activated — find and release |
| Overload lamp on | Motor thermal overload tripped — check motor |
| Comm fault lamp on | Communication error — check fieldbus cables |
