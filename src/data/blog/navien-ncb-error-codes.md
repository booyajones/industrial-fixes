...
| Part | Notes |
|------|-------|
| 3-way valve motor | E040; replace motor before full valve assembly |
| Condensate pressure switch | E010 after drain confirmed clear |
| Expansion tank | For E022 (overpressure) — check pre-charge |
| Fan motor assembly | E024; includes wheel |
| DHW flow sensor | E028; descale before replacing |
| 3-way valve seal kit | If valve leaks internally |
