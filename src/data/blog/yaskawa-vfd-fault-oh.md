...
| Part | Notes |
|------|-------|
| Drive cooling fan | Match voltage (24VDC common), CFM rating, and connector; order by drive model |
| Enclosure fan/filter | Add to panel or enclosure if ambient is too high |
| Drive (upsized) | If drive is running consistently near full current on an undersized application |
