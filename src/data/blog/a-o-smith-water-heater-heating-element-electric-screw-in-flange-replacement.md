---
title: "A.O. Smith Water Heater Heating Element Replacement Guide"
description: "No hot water, lukewarm showers, slow recovery, or only the top half heating? A failed electric heating element is the cause. Replacing it restores full heating."
pubDatetime: 2026-06-01T21:32:10Z
modDatetime: 2026-06-01T21:32:10Z
...
| Part | Notes |
|------|-------|
| Electric water heater heating element (screw-in or flange type) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-a-o-smith-water-heater-heating-element-electric-screw-in-flange-replacement&k=Electric+water+heater+heating+element+%28screw-in+or+flange+type%29&tag=errorcodefixes-20) \| Match the wattage, voltage, and style (screw-in or flange mount) to your heater. Find your exact model and serial number on the data plate label on the side of the tank and use A.O. Smith's serial-number-based part lookup or cross-reference to identify the correct OEM replacement element for your unit. |
| Heating element gasket | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-a-o-smith-water-heater-heating-element-electric-screw-in-flange-replacement&k=Heating+element+gasket&tag=errorcodefixes-20) \| Often included with the replacement element. Always use a new gasket when installing a new element to prevent leaks at the seal. |
