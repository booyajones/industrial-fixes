...
| Part | Notes |
|------|-------|
| Door contact (Schindler spec) | Replace when worn |
| Door operator drive | Replace on door fault |
| Brake coil assembly | Replace on brake fault |
| Encoder | Replace on feedback fault |
| IC3/IC5 control board | Replace on controller fault |
