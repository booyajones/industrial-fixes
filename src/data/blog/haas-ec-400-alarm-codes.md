...
| Part | Notes |
|------|-------|
| Servo motors | Alpha series — match axis |
| Encoder cables | Check at both motor and drive connectors |
| ATC solenoid valves | Check for proper operation |
| Lube pump | Check for seized impeller |
| Retention knobs | Replace damaged/worn 40-taper knobs |
| Way wipers | Inspect and replace if worn |
