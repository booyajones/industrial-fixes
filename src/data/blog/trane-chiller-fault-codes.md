...
| Part | Notes |
|------|-------|
| Flow switch (evap or cond) | Check on flow-loss faults |
| Oil filter — CenTraVac | Replace on oil pressure faults |
| Condenser tube cleaning | Required on high condenser pressure |
| Refrigerant charge | After leak repair |
