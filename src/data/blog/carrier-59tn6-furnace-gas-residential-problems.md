---
title: "Carrier 59TN6 Furnace Problems & Error Codes"
description: "Code 33 (limit or rollout switch lockout) is most common, usually caused by restricted airflow from a dirty filter or blocked blower wheel."
pubDatetime: 2026-06-01T17:24:55Z
modDatetime: 2026-06-01T17:24:55Z
author: "Marcus Webb"
featured: false
draft: false
tags:
...
| Part | Notes |
|------|-------|
| Limit switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-carrier-59tn6-furnace-gas-residential-problems&k=Limit+switch&tag=errorcodefixes-20) \| Opens on overheating from airflow restriction or fails open with age; part of the Code 33 limit circuit. |
| Flame rollout switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-carrier-59tn6-furnace-gas-residential-problems&k=Flame+rollout+switch&tag=errorcodefixes-20) \| Trips when flame spillage is detected; also part of the Code 33 fault path and must be inspected for cause before reset. |
| Blower motor or blower wheel | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-carrier-59tn6-furnace-gas-residential-problems&k=Blower+motor+or+blower+wheel&tag=errorcodefixes-20) \| Dirty wheel or motor failure reduces airflow and causes limit switch trips; cleaning or replacement restores proper operation. |
| Control board | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-carrier-59tn6-furnace-gas-residential-problems&k=Control+board&tag=errorcodefixes-20) \| Replace only after verifying all field wiring, switches, and voltages are correct; board misreads or cannot process limit circuit in rare cases. |
