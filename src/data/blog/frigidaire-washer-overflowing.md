---
title: "Frigidaire Washer Overflowing - Causes & Fix"
description: "Most often caused by a stuck-open water inlet valve or failed pressure switch that can't stop the fill cycle correctly."
pubDatetime: 2026-06-08T12:56:19Z
modDatetime: 2026-06-08T12:56:19Z
...
1. Confirm whether you see suds spilling out or actual water overflowing, since suds overflow is a detergent problem and water overflow is mechanical.
2. If suds are the issue, switch to HE detergent, reduce the amount per load, and run an empty Quick Wash cycle to clear residual soap from the tub.
3. If water is overfilling, unplug the washer during a fill cycle and watch whether water still enters the tub.
4. If water continues to flow with power removed, replace the water inlet valve because it is stuck open or leaking internally.
5. If water stops when unplugged, pull the cabinet and locate the pressure tube running from the outer tub to the pressure switch.
6. Inspect the pressure tube for kinks, cracks, cuts, blockage, or disconnection and clean or replace it as needed.
7. Test the pressure switch by blowing gently into the tube while listening for audible clicks, or replace the switch if the tube is clear and the washer still overfills.
8. Check the main control board for burned traces or shorted relay outputs only if the valve and switch have both been confirmed good and the board is still energizing the valve incorrectly.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Water inlet valve | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-washer-overflowing&k=Water+inlet+valve&tag=errorcodefixes-20) \| Dual or single solenoid depending on model, requires at least 20 psi supply pressure to close properly. |
| Pressure switch or water level switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-washer-overflowing&k=Pressure+switch+or+water+level+switch&tag=errorcodefixes-20) \| Senses air pressure in the tub via the pressure tube and signals the board to stop fill. |
| Pressure tube or air hose | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-washer-overflowing&k=Pressure+tube+or+air+hose&tag=errorcodefixes-20) \| Clear vinyl or rubber tube connecting the outer tub to the pressure switch. |
