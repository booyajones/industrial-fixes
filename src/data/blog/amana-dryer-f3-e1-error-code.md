---
title: "Amana Dryer F3 E1 Error Code - Causes & Fix"
description: "F3 E1 means exhaust thermistor fault on Amana dryers. Power down 5 minutes, restart, and run a timed cycle to test the thermistor."
pubDatetime: 2026-05-31T04:31:59Z
modDatetime: 2026-05-31T04:31:59Z
...
- **Failed exhaust thermistor** The thermistor itself has gone open, shorted, or is reading out of range.
- **Loose or corroded connector** The plug between the thermistor and the wiring harness has backed out or developed corrosion.
- **Broken wire in the harness** A wire running from the thermistor to the control board has been pinched, cut, or fatigued.
- **Control-board input failure** The main control is not reading the thermistor signal correctly even when the sensor is good.
...
| Part | Notes |
|------|-------|
| Exhaust thermistor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-amana-dryer-f3-e1-error-code&k=Exhaust+thermistor&tag=errorcodefixes-20) \| Match the part number to your dryer model (usually printed on the cabinet or inside the door frame). |
| Dryer wiring harness (thermistor section) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-amana-dryer-f3-e1-error-code&k=Dryer+wiring+harness+%28thermistor+section%29&tag=errorcodefixes-20) \| Only if wires are cut, pinched, or connectors are damaged beyond cleaning. |
