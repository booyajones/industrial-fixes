...
| [Trip Code](https://www.amazon.com/s?ascsubtag=ecf-emerson-control-techniques-fault&k=Trip+Code&tag=errorcodefixes-20) | Meaning | Common Cause | Quick Fix |
|-----------|---------|-------------|-----------|
| [OI.AC](https://www.amazon.com/s?ascsubtag=ecf-emerson-control-techniques-fault&k=OI.AC&tag=errorcodefixes-20) | Overcurrent — AC output | Short circuit; too fast acceleration | Check motor wiring; increase accel time |
| [OI.DC](https://www.amazon.com/s?ascsubtag=ecf-emerson-control-techniques-fault&k=OI.DC&tag=errorcodefixes-20) | Overcurrent — DC bus | Braking energy; voltage spike | Add brake resistor; check decel |
...
| [t.dEF](https://www.amazon.com/s?ascsubtag=ecf-emerson-control-techniques-fault&k=t.dEF&tag=errorcodefixes-20) | Thermistor fault — motor PTC | PTC resistance out of range | Check PTC wiring; check motor temp |
...
| [O.SPd](https://www.amazon.com/s?ascsubtag=ecf-emerson-control-techniques-fault&k=O.SPd&tag=errorcodefixes-20) | Overspeed | Speed feedback exceeded limit | Check speed reference; check encoder |
