---
title: "GE GTW720BSNWS Washer Problems & Error Codes"
description: "Motor and drive system faults are most common, causing codes 5, 6, 8, or 10. Check belt, motor, mode shifter, and control board wiring in diagnostic mode."
pubDatetime: 2026-06-08T09:05:22Z
modDatetime: 2026-06-08T09:05:22Z
...
| Part | Notes |
|------|-------|
| Drive motor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-gtw720bsnws-washer-problems&k=Drive+motor&tag=errorcodefixes-20) \| Fails with locked rotor, overheating, or communication loss to the control board, causing codes 5, 6, 8, or 10. |
| Mode shifter actuator | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-gtw720bsnws-washer-problems&k=Mode+shifter+actuator&tag=errorcodefixes-20) \| Sticks or breaks, preventing the transmission from switching between agitate and spin modes (code 4 or 6). |
| Drive belt | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-gtw720bsnws-washer-problems&k=Drive+belt&tag=errorcodefixes-20) \| Stretches, cracks, or gets contaminated, causing slipping, noise, or incomplete spin cycles (code 2). |
| Main control board or timer | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-gtw720bsnws-washer-problems&k=Main+control+board+or+timer&tag=errorcodefixes-20) \| Loses communication with the motor, fails to send power to components, or corrupts diagnostic data (code 10). |
