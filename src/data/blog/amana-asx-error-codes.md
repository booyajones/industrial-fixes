...
| Part | Notes |
|---|---|
| Dual run capacitor | Most common ASX failure; shared compressor and fan capacitor |
| Contactor | 2-pole; check contact gap and coil pull-in voltage |
| High-pressure switch | Spade terminals; direct swap |
| Low-pressure switch | 50 PSIG cutout for R-410A |
| Ambient thermistor | For Code 6; usually on a pigtail connector |
| Control board | For Code 5; verify fuse and transformer first |
