---
title: "Samsung Dryer Loud Banging - Causes & Fix"
description: "Usually an unbalanced load or foreign object in the drum. Check load size, inspect for coins or keys, verify level, then check rollers."
pubDatetime: 2026-06-08T23:25:30Z
modDatetime: 2026-06-08T23:25:30Z
...
1. Run the dryer empty for 30 seconds to determine if the noise is load-related or machine-related.
2. Open the drum and inspect thoroughly for coins, keys, buttons, zipper pulls, or any loose objects.
3. Check the load size and distribution, then reduce or rebalance the load and retest if the symptom appeared with laundry inside.
4. Verify all four leveling feet are stable and the dryer is level front-to-back and side-to-side, adjusting feet as needed.
5. Inspect the rear vent duct connection and tighten or reseat it if loose or disconnected.
6. If noise persists, unplug the dryer and remove the front or top panel to access the drum support system.
7. Spin the drum by hand and check the drum rollers, roller shafts, idler pulley, and drum bearings for flat spots, wobble, looseness, or visible wear.
8. Inspect the drum itself for cracks, warping, or separation at seams, and replace the drum assembly if damaged.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Drum rollers | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-dryer-loud-banging&k=Drum+rollers&tag=errorcodefixes-20) \| Support the rear of the drum and fail with flat spots or worn shafts. |
| Drum support bearings | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-dryer-loud-banging&k=Drum+support+bearings&tag=errorcodefixes-20) \| Front or rear bearings that allow wobble or noise when worn. |
| Drum assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-dryer-loud-banging&k=Drum+assembly&tag=errorcodefixes-20) \| Required if the drum is cracked or warped, a more involved replacement. |
