...
| Part | Notes |
|------|-------|
| Spindle motor cooling fan | Match motor frame size and voltage; Fanuc OEM or equivalent |
| Motor thermistor | Fanuc OEM; 120Ω PTC type; match motor model |
| Spindle bearings | Matched pair; angular contact; require precision installation |
