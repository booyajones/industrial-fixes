...
| Part | Notes |
|------|-------|
| Defrost control board | Match to unit model number |
| Defrost sensor | Clip-on type — confirm placement on tube |
| Reversing valve | Match refrigerant and tonnage |
| Run capacitor | Dual-capacitor — check both sections |
| Contactor | Check for pitted contacts |
| Low-pressure switch | Match pressure setpoint |
