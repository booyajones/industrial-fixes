...
| Part | Notes |
|------|-------|
| Mitsubishi servo amplifier (MR-J series) | Match the specific model for the axis — voltage, current rating, and feedback type |
| Servo motor | Mazak typically uses Mitsubishi HF/HC series motors; match by model number |
| Encoder cable | Replace if feedback is the confirmed cause of the fault |
