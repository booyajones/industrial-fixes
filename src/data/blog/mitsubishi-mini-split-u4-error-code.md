...
| Part | Notes |
|------|-------|
| Outdoor thermistor (discharge or ambient) | Confirm which thermistor is flagged; Mitsubishi part numbers vary by model series |
| Inter-unit communication cable (3-conductor) | Replace damaged run; use same gauge as OEM wiring |
| Outdoor control PCB | Replace if thermistors test good but fault persists |
