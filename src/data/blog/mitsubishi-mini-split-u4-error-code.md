...
| Part | Notes |
|------|-------|
| Outdoor thermistor (discharge or ambient) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-mitsubishi-mini-split-u4-error-code&k=Outdoor+thermistor+%28discharge+or+ambient%29&tag=errorcodefixes-20) \| Confirm which thermistor is flagged; Mitsubishi part numbers vary by model series |
| Inter-unit communication cable (3-conductor) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-mitsubishi-mini-split-u4-error-code&k=Inter-unit+communication+cable+%283-conductor%29&tag=errorcodefixes-20) \| Replace damaged run; use same gauge as OEM wiring |
| Outdoor control PCB | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-mitsubishi-mini-split-u4-error-code&k=Outdoor+control+PCB&tag=errorcodefixes-20) \| Replace if thermistors test good but fault persists |
## When to Call a Pro
