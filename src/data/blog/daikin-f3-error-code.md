...
| Part | Notes |
|------|-------|
| Discharge temperature sensor (thermistor) | Must match Daikin model; resistance spec varies by series |
| Sensor harness wiring | If the harness is damaged; use equivalent gauge wire |
