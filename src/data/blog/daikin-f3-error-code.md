...
| Part | Notes |
|------|-------|
| Discharge temperature sensor (thermistor) | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-daikin-f3-error-code&k=Daikin+Discharge+temperature+sensor+%28thermistor%29&tag=errorcodefixes-20) \| Must match Daikin model; resistance spec varies by series |
