---
title: "Maytag Refrigerator Ice Maker Not Working - Causes & Fix"
description: "Most often the ice maker is accidentally switched off or needs a reset. Unplug the refrigerator for one minute, then wait two hours."
pubDatetime: 2026-06-09T23:17:28Z
modDatetime: 2026-06-09T23:17:28Z
...
1. Verify the ice maker is turned on using the control switch or display panel.
2. Perform a reset by unplugging the refrigerator for one minute, then plug it back in and wait two hours to see if ice production resumes.
3. Check the water filter and confirm it is the correct model and fully locked in place, then remove it temporarily to see if water flow returns.
4. Inspect the water supply line for kinks, pinches, or disconnections, and confirm the refrigerator is connected to a cold water source using 1/4 in. (6.35 mm) O.D. soft copper or PEX tubing.
5. Confirm the freezer is cold enough by checking that the temperature is well below 10°F and that airflow is not blocked.
6. Check for ice buildup in the ice maker mold or fill tube, and remove any frozen blockages that may prevent the mechanism from cycling.
7. Test for water at the inlet valve during a fill cycle and verify the valve is being energized.
8. On side-by-side models with in-door ice makers, inspect the lower door harness for broken or damaged wires where the door flexes, and check for power and continuity across the ice maker circuit if operation does not resume.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Maytag refrigerator ice maker assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-maytag-refrigerator-ice-maker-not-working&k=Maytag+refrigerator+ice+maker+assembly&tag=errorcodefixes-20) \| Replace if the module has no continuity or does not cycle when powered. |
| Water inlet valve | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-maytag-refrigerator-ice-maker-not-working&k=Water+inlet+valve&tag=errorcodefixes-20) \| Replace if the valve does not open during the fill cycle or has no power. |
| Refrigerator door wiring harness (side-by-side models) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-maytag-refrigerator-ice-maker-not-working&k=Refrigerator+door+wiring+harness+%28side-by-side+models%29&tag=errorcodefixes-20) \| Replace if conductors are broken at the lower freezer door hinge area. |
