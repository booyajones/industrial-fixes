...
| Part | Notes |
|------|-------|
| WEBs-4S controller | Replace on hardware fault |
| XL15B field controller | Replace on hardware failure |
| Spyder controller | Replace on Sylk bus fault |
| Honeywell actuator (M7415) | Replace on valve fault |
| LON network interface card | Replace on LON fault |
