...
| Part | Notes |
|---|---|
| High-pressure switch | ClimateMaster part 65D83 or equivalent |
| TXV valve | Must match capacity and refrigerant type |
| Blower run capacitor | Match µF and voltage rating |
| Loop pump | Check flow rate — minimum 1.5 GPM/ton |
