...
| Part | Notes |
|------|-------|
| Indoor ambient (room) thermistor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-pioneer-mini-split-error-code-f1&k=Indoor+ambient+%28room%29+thermistor&tag=errorcodefixes-20) \| Typically labeled T1 on the PCB |
| Evaporator coil thermistor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-pioneer-mini-split-error-code-f1&k=Evaporator+coil+thermistor&tag=errorcodefixes-20) \| Typically labeled T2; clips to the coil fins |
## When to Call a Pro
