---
title: "Whirlpool Dishwasher Diverter Motor Replacement - Signs & How-To"
description: "Water missing the upper rack, leaks from the sump area, or no spray at all mean the diverter motor has likely failed. Replacing it restores spray rotation and wash coverage."
pubDatetime: 2026-06-01T20:53:24Z
modDatetime: 2026-06-01T20:53:24Z
author: "Marcus Webb"
featured: false
draft: true
tags:
...
- **Upper rack dishes stay dirty while lower dishes are clean** The diverter motor is stuck in one position and water never reaches the upper spray arm.
- **Water pooling under the dishwasher or inside the door frame** The diverter seal or grommet has failed and water leaks from the sump area during the wash cycle.
- **No spray from any arm even though you hear the pump running** The diverter disc is misaligned or the motor shaft is seized, blocking all water flow.
- **Weak spray from one zone and normal spray from another** The diverter motor is not rotating fully or the hub is binding on the shaft.
- **Grinding or clicking noise from the sump area during wash** The motor gear mechanism is stripped or the diverter wheel keyway is damaged and slipping.
- **Motor hums but the diverter shaft does not turn** The motor has failed internally or the shaft is seized with mineral buildup or debris.
...
| Part | Notes |
|------|-------|
| Whirlpool dishwasher diverter motor assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-whirlpool-dishwasher-diverter-motor-valve-replacement&k=Whirlpool+dishwasher+diverter+motor+assembly&tag=errorcodefixes-20) \| Common part number W10537869 for many Whirlpool, KitchenAid, and Maytag models. Check the model and serial number tag inside the door frame or on the left side wall of the tub to confirm fitment. |
| Diverter hub or disc (if not included with motor kit) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-whirlpool-dishwasher-diverter-motor-valve-replacement&k=Diverter+hub+or+disc+%28if+not+included+with+motor+kit%29&tag=errorcodefixes-20) \| Some kits include the disc and hub, others require ordering the hub separately. Verify what is included in the motor kit before ordering. |
