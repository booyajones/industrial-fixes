---
title: "Samsung Mini Split Not Heating - Causes & Fix"
description: "Most likely the system is in the wrong mode or the set temperature is too low. Switch to Heat mode and raise the setpoint above room temperature."
pubDatetime: 2026-06-11T22:39:15Z
modDatetime: 2026-06-11T22:39:15Z
...
| Part | Notes |
|------|-------|
| Indoor heat exchanger temperature sensor (thermistor) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-mini-split-not-heating&k=Indoor+heat+exchanger+temperature+sensor+%28thermistor%29&tag=errorcodefixes-20) \| Typically a 10 kΩ thermistor, used for E1, 22, or E123 faults. |
| Indoor air filter (washable or replacement) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-mini-split-not-heating&k=Indoor+air+filter+%28washable+or+replacement%29&tag=errorcodefixes-20) \| Model-specific; clean monthly or replace every three months. |
| Indoor fan motor or capacitor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-mini-split-not-heating&k=Indoor+fan+motor+or+capacitor&tag=errorcodefixes-20) \| Required if the indoor fan fails to spin and triggers a fan-fault code. |
