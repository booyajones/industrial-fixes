---
title: "Whirlpool Oven Igniter Not Working - Causes & Fix"
description: "A failed igniter is the most common cause. If the igniter glows but does not light the gas, replace the igniter assembly."
pubDatetime: 2026-06-01T18:43:57Z
modDatetime: 2026-06-01T18:43:57Z
...
1. Switch off the circuit breaker supplying the range for one minute, then switch it back on to reset the control and verify the breaker is not tripped.
2. Check the display for error codes, particularly F9 or F9 E0, which indicate the electrical outlet or appliance connection may be miswired or seeing incorrect voltage.
3. Confirm the appliance is plugged into a properly grounded 120 Volt AC outlet (or that the 240V receptacle for electric ranges is wired correctly) and that the outlet is live.
4. Observe the igniter during an oven start cycle to see if it glows orange or produces a spark, and note whether gas ignites after a few seconds.
5. If the igniter glows but gas does not light, treat the igniter as faulty and plan to replace it per Whirlpool guidance.
6. If there is no glow or spark, inspect the igniter visually for cracks, damage, or contamination, and check wiring connections at the igniter and control board for burns or looseness.
7. Use a multimeter to test the thermal fuse for continuity and verify power is reaching the igniter circuit.
8. Remove the oven bottom panel, flame diverter, and burner assembly to access the igniter and burner ports, then clean any restricted burner ports and verify proper burner alignment before reassembling and retesting.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Whirlpool oven igniter | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-whirlpool-oven-igniter-not-working&k=Whirlpool+oven+igniter&tag=errorcodefixes-20) \| Model-specific hot-surface igniter or spark electrode assembly |
| Spark module or control board | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-whirlpool-oven-igniter-not-working&k=Spark+module+or+control+board&tag=errorcodefixes-20) \| Required if the igniter receives no spark signal or command voltage |
| Thermal fuse | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-whirlpool-oven-igniter-not-working&k=Thermal+fuse&tag=errorcodefixes-20) \| Safety device that opens the circuit if overheated |
