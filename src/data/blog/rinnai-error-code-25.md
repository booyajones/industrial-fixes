...
| Part | Notes |
|------|-------|
| Thermal fuse (one-time trip) | Model-specific; Rinnai part number stamped on old fuse — must match |
| Vent termination cap (Rinnai-approved) | Replace if blockage was in the cap |
| Vent pipe (3" or 4" PVC schedule 40) | Reroute if run length exceeded spec |
