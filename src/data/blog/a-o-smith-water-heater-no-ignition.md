---
title: "A.O. Smith Water Heater No Ignition - Causes & Fix"
description: "Usually a failed igniter or loose igniter wiring preventing spark. Check wiring and replace the igniter if no spark is present."
pubDatetime: 2026-06-11T22:45:26Z
modDatetime: 2026-06-11T22:45:26Z
...
1. Verify the exact model and ignition type from the rating plate, and note any LED status code or flash pattern in the manual before diagnosing.
2. Confirm the manual gas shutoff valve upstream of the heater is fully open and that other gas appliances in the home are operating (to verify supply).
3. Observe an ignition attempt through the sight glass or access port and watch for a visible spark at the pilot or igniter.
4. If no spark is present, turn off power and gas, then inspect the igniter wiring and connectors for damage, corrosion, or loose contacts and repair any faults.
5. If wiring is intact but still no spark, test or replace the igniter (most igniters fail internally and show no visible spark even when powered).
6. If there is spark but no ignition, remove and clean the pilot tube, burner orifice, and nearby passages to clear any blockage or debris.
7. On standing-pilot models with spark but no light, use a multimeter to measure thermopile output at the gas-valve connector: below 350 mV means replace the thermopile, above 350 mV with secure wiring means replace the gas valve per A.O. Smith guidance.
8. After any repair, restore power and gas, cycle the thermostat or reset the control, and verify repeated successful ignition and stable flame before closing access panels.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Igniter (spark igniter or hot-surface igniter) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-a-o-smith-water-heater-no-ignition&k=Igniter+%28spark+igniter+or+hot-surface+igniter%29&tag=errorcodefixes-20) \| Model-specific. Verify part number from the rating plate or service manual before ordering. |
| Thermopile | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-a-o-smith-water-heater-no-ignition&k=Thermopile&tag=errorcodefixes-20) \| For standing-pilot models. Replace if millivolt output is below 350 mV at the gas-valve connector. |
| Gas valve | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-a-o-smith-water-heater-no-ignition&k=Gas+valve&tag=errorcodefixes-20) \| Replace if thermopile reads above 350 mV, wiring is secure, and valve still will not open or deliver gas. |
