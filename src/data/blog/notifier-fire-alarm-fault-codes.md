...
| Part | Notes |
|------|-------|
| Battery (12V 7Ah or 12V 18Ah) | Replace if below 80% capacity |
| Smoke detector head | Replace FAPT/FSP heads periodically |
| End-of-line device (EOLR) | Required on all NAC circuits |
| SLC loop card | Replace on persistent loop faults |
