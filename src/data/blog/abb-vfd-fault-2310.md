...
| Part | Notes |
|------|-------|
| Motor (rewind or replace) | If megger confirms winding fault; rewinding is cost-effective on larger motors |
| Output cable | Replace full run if insulation is compromised |
| Output line reactor (choke) | Install when cable run exceeds drive manufacturer's maximum without reactor |
