...
| Part | Notes |
|------|-------|
| Ekip trip unit | Replace on electronics failure |
| Ekip Com module | Replace on communication fault |
| Arc chutes | Replace after multiple fault trips |
| Auxiliary contact blocks | Replace on worn contacts |
| Undervoltage release (UVR) | Replace on no-trip-open fault |
