...
| Part | Notes |
|------|-------|
| Output contactor | Match to Lincoln part number — coil voltage and contact current rating vary by model |
| Control board | If no drive signal reaches the contactor coil |
| Contactor wiring harness | If leads are damaged or terminals are corroded |
