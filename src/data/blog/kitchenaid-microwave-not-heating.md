---
title: "KitchenAid Microwave Not Heating - Causes & Fix"
description: "A faulty door switch is the most common cause. The microwave thinks the door is open and disables heating. Test the switch first."
pubDatetime: 2026-06-11T11:34:27Z
modDatetime: 2026-06-11T11:34:27Z
...
1. Check the control panel for a control lock icon or demo mode setting and disable it according to the user manual.
2. Open and close the door firmly to verify it latches completely and listen for a click from the door switches.
3. Run a short heating test with a cup of water on high power for 30 seconds to confirm no heat is generated.
4. Unplug the microwave and remove the outer cabinet screws to access internal components.
5. Discharge the high-voltage capacitor by touching an insulated screwdriver across both terminals before touching any other parts.
6. Test the door switches with a multimeter for continuity when the door is closed and no continuity when open.
7. Use a multimeter to test the high-voltage diode for continuity in one direction only (it should block reverse current).
8. Inspect the magnetron for visible burn marks, a broken antenna, or a burnt smell, and test the thermal fuse for continuity.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Door Interlock Switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-kitchenaid-microwave-not-heating&k=Door+Interlock+Switch&tag=errorcodefixes-20) \| Usually sold in sets of two or three switches per door latch assembly. |
| High-Voltage Diode | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-kitchenaid-microwave-not-heating&k=High-Voltage+Diode&tag=errorcodefixes-20) \| Rectifies AC current for the magnetron. Test with a multimeter before replacing. |
| Magnetron | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-kitchenaid-microwave-not-heating&k=Magnetron&tag=errorcodefixes-20) \| The microwave generator. Most expensive part and often the last to test. |
| Thermal Fuse | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-kitchenaid-microwave-not-heating&k=Thermal+Fuse&tag=errorcodefixes-20) \| One-time safety fuse that opens on overheat. Check continuity before ordering. |
