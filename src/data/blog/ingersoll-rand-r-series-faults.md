...
| Part | Notes |
|------|-------|
| Inlet air filter | Replace at scheduled interval |
| Oil filter element | IR-specific — match model |
| Oil separator element | Replace at Level 2 interval |
| Compressor oil | IR synthetic — model-specific |
| Auto-drain solenoid valve | Check for stuck-open or stuck-closed |
| Temperature sensor | Match Intellisys controller input type |
