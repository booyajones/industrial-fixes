...
| Part | Notes |
|------|-------|
| Servo amplifier module | Replace when amplifier LED shows internal fault or drive current is limited |
| Encoder cable (axis-specific) | Replace if cable shows abrasion, kinks, or intermittent continuity |
| Servo motor (axis-specific) | Replace when motor phase resistance is unbalanced or winding is grounded |
| Ballscrew support bearing | Replace if manual axis movement is notchy or rough |
