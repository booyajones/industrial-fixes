...
| Part | Notes |
|------|-------|
| ComfortLink II thermostat | Replace when thermostat communication circuit has failed |
| Outdoor unit control board | Replace after lightning strike or if board shows burn marks |
| Communication wire (18-gauge, 2-conductor) | Replace entire run if wire is damaged; don't splice communication wire |
| Air handler control board | Replace if air handler shows its own separate communication fault |
