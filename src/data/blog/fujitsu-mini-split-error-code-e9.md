...
| Part | Notes |
|---|---|
| EEV coil (stepper motor coil) | Fujitsu OEM — match connector and winding resistance |
| EEV valve body | Replace as assembly if mechanically stuck |
| Outdoor PCB | Last resort — expensive; verify all other causes first |
