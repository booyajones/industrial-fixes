...
| Part | Notes |
|------|-------|
| Trane outdoor ambient temp sensor | [Amazon](https://www.amazon.com/s?k=trane+outdoor+ambient+temperature+sensor&tag=errorcodefixes-20) — Match by model number; many Trane OAT sensors share part numbers across product lines |
