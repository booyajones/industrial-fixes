...
| Part | Notes |
|------|-------|
| NTC temperature sensor | [Amazon](https://www.amazon.com/s?k=NTC+temperature+sensor&tag=errorcodefixes-20) \| Nor-Lake OEM — resistance spec varies by model generation |
