...
| Part | Notes |
|------|-------|
| EXV stepper motor coil | Replace on valve mechanical fault |
| S1 NTC thermistor | Replace on sensor fault |
| S2 pressure transducer | Replace on sensor fault |
| EBC controller board | Replace on electronics failure |
| EXV body assembly | Replace on stuck valve |
