...
| Part | Notes |
|------|-------|
| Battery module (GXT/EXS) | Replace complete set |
| Fan module (APM/NXL) | Hot-swappable |
| IntelliSlot network card | Replace on communication fault |
| Bypass module (APM) | Replace on bypass fault |
| Rectifier module | Factory service or replacement |
