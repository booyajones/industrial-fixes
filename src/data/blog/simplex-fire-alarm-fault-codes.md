...
| Part | Notes |
|------|-------|
| TrueAlarm detector head | Replace on failed device trouble |
| Sealed lead-acid battery | 24V system, typically 12V in series |
| MAPNET end-of-line device | Required for loop termination |
| IDC module card | Replace on persistent IDC faults |
