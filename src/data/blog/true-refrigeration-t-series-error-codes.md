---
title: "True Refrigeration T-Series Error Codes — Complete Fix Guide"
...
| Part | Notes |
|------|-------|
| NTC air sensor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-true-refrigeration-t-series-error-codes&k=NTC+air+sensor&tag=errorcodefixes-20) \| True OEM only — controller is calibrated to specific sensor curve |
| Defrost heater | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-true-refrigeration-t-series-error-codes&k=Defrost+heater&tag=errorcodefixes-20) \| Match to model and voltage (115V or 208-230V) |
| Defrost termination thermostat | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-true-refrigeration-t-series-error-codes&k=Defrost+termination+thermostat&tag=errorcodefixes-20) \| Clips to evaporator; opens at ~50°F to terminate defrost |
| Door gasket | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-true-refrigeration-t-series-error-codes&k=Door+gasket&tag=errorcodefixes-20) \| True model-specific — measure and order by model number |
| Condenser fan motor | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-true-refrigeration-t-series-error-codes&k=Condenser+fan+motor&tag=errorcodefixes-20) \| Replace if not running with compressor on |
## When to Call a Pro
