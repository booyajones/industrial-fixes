...
| Part | Notes |
|------|-------|
| NTC air sensor | True OEM only — controller is calibrated to specific sensor curve |
| Defrost heater | Match to model and voltage (115V or 208-230V) |
| Defrost termination thermostat | Clips to evaporator; opens at ~50°F to terminate defrost |
| Door gasket | True model-specific — measure and order by model number |
