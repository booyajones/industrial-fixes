...
| Part | Notes |
|------|-------|
| Thermocouple | For standing pilot models; $10–20 |
| Ignition module (Beckett/Honeywell) | For electronic ignition lockout |
| Circulator pump | For limit trips with zone valve confirmed open |
| Low water cutoff (LWCO) | For LWCO lockout with normal water level |
| Expansion tank | For pressure relief weeping; confirm pre-charge |
| Aquastat relay | For control failures on older ECG models |
