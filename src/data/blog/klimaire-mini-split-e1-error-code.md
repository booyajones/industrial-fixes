...
| Part | Notes |
|------|-------|
| Outdoor unit control PCB | Match exact model; Klimaire parts are available from Klimaire direct and HVAC suppliers |
| 3-conductor signal wire | 18 AWG or as specified in the installation manual |
| Indoor unit control PCB | Replace if outdoor board swap doesn't clear E1 |
