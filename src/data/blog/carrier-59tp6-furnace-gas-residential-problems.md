---
title: "Carrier 59TP6 Furnace Problems & Error Codes"
description: "The most common 59TP6 problem is limit-switch lockout (code 33) caused by dirty filters or blocked airflow. Clear obstructions and reset."
pubDatetime: 2026-06-01T17:23:43Z
modDatetime: 2026-06-01T17:23:43Z
author: "Marcus Webb"
featured: false
draft: false
tags:
...
| Part | Notes |
|------|-------|
| Control board | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-carrier-59tp6-furnace-gas-residential-problems&k=Control+board&tag=errorcodefixes-20) \| Houses the diagnostic LED and manages all furnace functions, fuse, and safety circuits. |
| Pressure switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-carrier-59tp6-furnace-gas-residential-problems&k=Pressure+switch&tag=errorcodefixes-20) \| Proves inducer airflow and can stick closed or fail to close due to mechanical wear or debris. |
| Flame sensor (flame rod) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-carrier-59tp6-furnace-gas-residential-problems&k=Flame+sensor+%28flame+rod%29&tag=errorcodefixes-20) \| Detects flame presence and commonly fails due to oxidation or contamination from combustion gases. |
| Limit switch and rollout switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-carrier-59tp6-furnace-gas-residential-problems&k=Limit+switch+and+rollout+switch&tag=errorcodefixes-20) \| High-temperature safety devices that open on overheating or flame spillage and may fail mechanically over time. |
