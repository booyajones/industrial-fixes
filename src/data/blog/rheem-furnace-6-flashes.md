...
tags:
  ...
  - furnace
  - rollout-switch
description: "Rheem furnace 6 flashes means the rollout switch has tripped due to flame rollout. This guide covers diagnosis and fixes for the Rheem/Ruud 6-flash rollout fault."
---
...
1. Do not immediately reset the rollout switch. Investigate first.
2. Open the furnace cabinet and inspect the burner compartment for soot deposits on the walls, draft diverter, or surrounding surfaces. Soot outside the heat exchanger confirms flame rollout.
3. Manually start the inducer (using test mode if available) before ignition. Hold your hand near the burner area — you should feel a strong inward draft. Weak or reversed airflow points to inducer or flue issues.
4. Inspect the vent system: metal flue or PVC pipes must be fully intact, connected, and unobstructed at all joints and terminations.
5. If flue and inducer check out, the rollout is likely caused by a heat exchanger breach. Have a tech inspect with a combustion analyzer or inspection camera.
...
| Part | Where to Buy |
|------|-------------|
| [Rollout limit switch](https://www.amazon.com/dp/B0BN3TRG9R?ascsubtag=ecf-rheem-furnace-6-flashes&tag=errorcodefixes-20) | RepairClinic, SupplyHouse |
| [Inducer motor assembly](https://www.amazon.com/dp/B00FDZ90B2?ascsubtag=ecf-rheem-furnace-6-flashes&tag=errorcodefixes-20) | RepairClinic, Grainger |
| [Inducer motor capacitor](https://www.amazon.com/dp/B01M05L7B3?ascsubtag=ecf-rheem-furnace-6-flashes&tag=errorcodefixes-20) | Grainger, Amazon |
