...
| Part | Notes |
|------|-------|
| Outdoor PCB | Match Multi V model exactly |
| Indoor PCB | Match indoor unit model |
| EEV (electronic expansion valve) | Match valve size and refrigerant |
| Outdoor fan motor | DC motor type on most Multi V |
| Communication cable | 2-wire shielded — check polarity |
