...
| Part | Notes |
|---|---|
| Cooling fan | Common thermal trip cause |
| Keypad | For damaged display/buttons |
| Replacement FR-D700 drive | For CPU faults |
| Braking resistor | If fast stop is application-critical |
