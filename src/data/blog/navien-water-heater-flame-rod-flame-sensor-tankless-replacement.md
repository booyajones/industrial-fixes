---
title: "Navien Flame Rod Replacement - Signs & How-To"
description: "Code 003 ignition failure, unit clicks but won't light, or repeated lockouts mean a dirty or failed flame rod. Replacing it restores ignition."
pubDatetime: 2026-06-01T21:37:33Z
modDatetime: 2026-06-01T21:37:33Z
...
## Navien Flame Rod Replacement — What This Part Does
...
- **Code 003 or ignition failure error on the display** The unit shows Code 003, which means the control board did not detect a valid flame during startup.
- **Unit clicks or sparks but won't light** You hear the ignitor clicking and see sparks, but the burner never catches or stays lit.
- **Burner lights briefly then shuts off immediately** The flame starts but the unit locks out within a few seconds because the flame rod didn't confirm stable ignition.
- **Repeated lockout cycles with no hot water** The heater tries to light multiple times, fails, and goes into lockout mode requiring a manual reset.
- **Visible carbon buildup or corrosion on the flame rod tip** When you inspect the assembly, the rod or ignitor surface shows heavy contamination or discoloration.
- **Cracked, chipped, or broken flame rod or ignitor ceramic** Physical damage to the rod or ignitor insulator means the assembly must be replaced.
...
| Part | Notes |
|------|-------|
| Navien flame rod and ignitor assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-navien-water-heater-flame-rod-flame-sensor-tankless-replacement&k=Navien+flame+rod+and+ignitor+assembly&tag=errorcodefixes-20) \| Check the model and serial plate on the right side of the unit to identify your series (NPE, NPN, NCB). Common OEM part numbers include 30026265A for NPE/NCB models, 30022787A for NPN series, and 3002665A for some NPE units. Match the part number to your exact model. |
