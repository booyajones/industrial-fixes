---
title: "A.O. Smith Water Heater Not Enough Hot Water - Causes & Fix"
description: "Most often caused by a failed lower heating element on electric models or undersized tank capacity for your demand."
pubDatetime: 2026-06-11T22:44:34Z
modDatetime: 2026-06-11T22:44:34Z
...
1. Test hot water at multiple faucets and showers to confirm the problem is system-wide and not a single fixture valve issue.
2. Check the circuit breaker or fuses (electric) or verify the pilot light is lit and the gas valve is open (gas).
3. Press the red reset button on the upper thermostat if it has tripped, then wait 30 minutes and retest. Repeated tripping points to a grounded element or other fault.
4. Use a multimeter to measure voltage at the upper thermostat terminals. A.O. Smith says it should match the nameplate rating, usually 240 V AC on electric models.
5. Test the lower heating element for continuity. A.O. Smith maintenance guides list a typical resistance of 12.5 ohms. Replace the element if the reading is far outside that range or shows infinite resistance.
6. If the lower element tests good, check the upper element and both thermostats for continuity and correct operation.
7. Inspect any thermostatic mixing valve or tempering valve for correct setpoint or internal failure.
8. Drain a bucket from the tank drain valve and check for sediment. If heavy mineral buildup is present, flush the tank or replace the heater if sediment is hardened.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Lower heating element (electric) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-a-o-smith-water-heater-not-enough-hot-water&k=Lower+heating+element+%28electric%29&tag=errorcodefixes-20) \| Match wattage and voltage to your nameplate. Typical resistance when new is around 12.5 ohms. |
| Upper heating element (electric) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-a-o-smith-water-heater-not-enough-hot-water&k=Upper+heating+element+%28electric%29&tag=errorcodefixes-20) \| Required if the upper element has failed or was damaged during a dry-fire condition after installation. |
| Upper thermostat with high-limit reset | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-a-o-smith-water-heater-not-enough-hot-water&k=Upper+thermostat+with+high-limit+reset&tag=errorcodefixes-20) \| Controls sequencing and houses the red ECO reset button. Replace if the thermostat won't close or the reset trips repeatedly without cause. |
