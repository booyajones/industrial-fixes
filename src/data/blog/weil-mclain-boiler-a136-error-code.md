---
title: "Weil-McLain A136 Error - Causes & Fix"
description: "A136 error meaning varies by Weil-McLain model. Check your service manual or call a tech. Most common: sensor fault or control issue."
pubDatetime: 2026-06-17T11:29:02Z
modDatetime: 2026-06-17T11:29:02Z
...
diy_or_pro: "pro"
free_checks:
  - "Record the exact A136 code, your boiler model number, and CP/serial number from the data plate."
  - "Power-cycle the boiler once (turn it off for 30 seconds, then back on) and see if the fault clears or returns."
...
| Part | Notes |
|------|-------|
| Temperature or pressure sensor (model-specific) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-weil-mclain-boiler-a136-error-code&k=Temperature+or+pressure+sensor+%28model-specific%29&tag=errorcodefixes-20) \| Supply your exact boiler model and CP number so the supplier can match the correct sensor connector and resistance spec. |
| Main control board (model-specific) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-weil-mclain-boiler-a136-error-code&k=Main+control+board+%28model-specific%29&tag=errorcodefixes-20) \| Only replace after verifying all sensors and wiring test good. Board part numbers vary by series and control type. |
