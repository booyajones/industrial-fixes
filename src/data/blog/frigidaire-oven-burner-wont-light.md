---
title: "Frigidaire Oven Burner Won't Light - Causes & Fix"
description: "A weak or failed oven igniter is the most common cause. The igniter glows but does not draw enough current to open the gas valve."
pubDatetime: 2026-06-01T18:48:23Z
modDatetime: 2026-06-01T18:48:23Z
author: "Marcus Webb"
featured: false
draft: false
tags:
...
1. Verify the range has power and the gas supply valve to the unit is fully open.
2. Turn off power and gas, then remove the oven bottom panel or drawer to access the oven burner and igniter assembly.
3. Inspect the igniter visually for cracks, breaks in the porcelain, or heavy contamination around the element and burner head.
4. Clean the burner head, igniter area, and burner ports carefully to remove grease, debris, or food buildup that could block gas flow or ignition.
5. Restore power and start a bake cycle, watching whether the igniter glows and whether the burner lights within about 90 seconds.
6. If the igniter glows but the burner does not light, measure igniter current with an amp clamp on the igniter lead during the glow period to confirm it is drawing enough to open the valve (typically around 3 amps or higher as a field guideline, though this varies by model).
7. If igniter current is low or the element is visibly damaged, replace the oven igniter.
8. If the igniter tests good but the burner still does not light, check igniter wiring connections and test the gas safety valve for proper operation or replace it as needed.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Frigidaire oven igniter | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-oven-burner-wont-light&k=Frigidaire+oven+igniter&tag=errorcodefixes-20) \| Hot-surface igniter for gas oven, model-specific fit. |
| Oven gas safety valve | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-oven-burner-wont-light&k=Oven+gas+safety+valve&tag=errorcodefixes-20) \| Replace only after confirming igniter performance. |
