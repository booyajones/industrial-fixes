...
| Part | Notes |
|------|-------|
| Drive motor encoder | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-raymond-forklift-fault-codes&k=Drive+motor+encoder&tag=errorcodefixes-20) \| Replace on 105 fault |
| Operator presence switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-raymond-forklift-fault-codes&k=Operator+presence+switch&tag=errorcodefixes-20) \| Replace on 601 fault |
| Brake coil | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-raymond-forklift-fault-codes&k=Brake+coil&tag=errorcodefixes-20) \| Replace on brake fault |
| Battery connector | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-raymond-forklift-fault-codes&k=Battery+connector&tag=errorcodefixes-20) \| Replace on 505 fault |
| Drive controller | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-raymond-forklift-fault-codes&k=Drive+controller&tag=errorcodefixes-20) \| Replace on persistent 100-series fault |
## When to Call a Pro
