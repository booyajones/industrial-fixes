...
| Part | Notes |
|------|-------|
| Aurora Base Control board | ABC — match to unit model and software version |
| IntelliZone2 thermostat | Communication interface for fault codes |
| Loop pump | Verify GPM meets unit minimum |
| TXV | Match refrigerant and tonnage |
| Reversing valve | Match unit model |
| Pressure transducer | Check calibration before replacing |
