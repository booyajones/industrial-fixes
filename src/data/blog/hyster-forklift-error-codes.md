...
| Part | Notes |
|------|-------|
| Motor thermal sensor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-hyster-forklift-error-codes&k=Motor+thermal+sensor&tag=errorcodefixes-20) \| Replace on thermal fault |
| CAN bus harness | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-hyster-forklift-error-codes&k=CAN+bus+harness&tag=errorcodefixes-20) \| Replace on communication fault |
| Brake coil | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-hyster-forklift-error-codes&k=Brake+coil&tag=errorcodefixes-20) \| Replace on brake fault |
| Battery charger | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-hyster-forklift-error-codes&k=Battery+charger&tag=errorcodefixes-20) \| Replace on charging issues |
| Drive controller | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-hyster-forklift-error-codes&k=Drive+controller&tag=errorcodefixes-20) \| Replace on persistent fault |
## When to Call a Pro
