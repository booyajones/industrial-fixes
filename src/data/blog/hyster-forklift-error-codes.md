...
| Part | Notes |
|------|-------|
| Motor thermal sensor | Replace on thermal fault |
| CAN bus harness | Replace on communication fault |
| Brake coil | Replace on brake fault |
| Battery charger | Replace on charging issues |
| Drive controller | Replace on persistent fault |
