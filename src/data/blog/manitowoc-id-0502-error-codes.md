...
| Part | Notes |
|---|---|
| Remote condenser fan motor | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-manitowoc-id-0502-error-codes&k=Manitowoc+Remote+condenser+fan+motor&tag=errorcodefixes-20) \| Multiple motors on large remote units |
...
| Float switch | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-manitowoc-id-0502-error-codes&k=Manitowoc+Float+switch&tag=errorcodefixes-20) \| Water trough level sensor |
