---
title: "State Water Heater E57 Error Code - Causes & Fix"
description: "E57 is not documented in available State manuals. Verify your model number and check the control board for correct code display."
pubDatetime: 2026-05-31T15:19:07Z
modDatetime: 2026-05-31T15:19:07Z
author: "Marcus Webb"
featured: false
draft: false
tags:
...
1. **Write down the full model and serial number** from the data plate on the water heater and note the exact characters shown on the display.
2. **Power off the unit** at the circuit breaker or by turning the gas control knob to Off, wait thirty seconds, then restore power to see if the code reappears or changes.
3. **Photograph the display** clearly so you have a record of the code, including any flashing pattern or accompanying indicators.
4. **Search the model number** on the State Water Heaters website or call their technical support line with the photo and model data to request the correct fault definition.
5. **Do not proceed with parts replacement** until you have confirmed what E57 means for your specific model, since misdiagnosis can lead to unnecessary expense and safety risks.

## Parts Often Needed

| Part | Notes |
|------|-------|
| Control board (model-specific) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-state-water-heater-e57-error-code&k=Control+board+%28model-specific%29&tag=errorcodefixes-20) \| Only order after confirming the fault definition and verifying the board is faulty, not a sensor or wiring issue. |
| Temperature sensor or thermistor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-state-water-heater-e57-error-code&k=Temperature+sensor+or+thermistor&tag=errorcodefixes-20) \| Common failure point if E57 turns out to be a sensor-related code on your model. |
