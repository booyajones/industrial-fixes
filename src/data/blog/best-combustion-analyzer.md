---
title: "Best Combustion Analyzer for HVAC Techs (2026) — 4 Tested Picks"
description: "For most residential and light-commercial HVAC techs, the Testo 320 is the analyzer to buy — it has the sensor accuracy and durability to last 8+ years, the..."
pubDatetime: 2026-05-21T17:00:00Z
modDatetime: 2026-05-21T17:00:00Z
author: "Dana Kowalski"
slug: best-combustion-analyzer
featured: false
draft: false
tags:
  - buying-guide
...
- **O2 and CO sensors at minimum** — these are the two cells that let the analyzer back-calculate CO2, excess air, and efficiency. CO range needs at least 0–4000 ppm; cheap analyzers cap at 1000 ppm which won't read a misadjusted appliance.
- **Sensor accuracy spec** — O2 within ±0.2%, CO within ±10 ppm or ±10% of reading. Anything looser and your "8.5% O2" reading might really be 7.5%, which changes the combustion adjustment completely.
- **Documented sensor life and replacement program** — combustion sensors are wear items. They live 2–4 years. The manufacturer's sensor swap or factory recalibration program is what determines the analyzer's total cost of ownership.
- **Integrated draft / pressure measurement** — most modern analyzers include a low-pressure transducer for gas manifold pressure and a draft channel for negative draft on atmospheric vents. Without these, you're carrying a manometer too.
- **Stack temperature thermocouple** — K-type, integrated with the probe, rated to at least 1200°F for residential and 1800°F for commercial work.
- **Bluetooth + app integration** — Testo Smart Probes app and Fieldpiece Job Link let you generate combustion reports on the phone. Useful for commercial work where the customer wants a printout.
- **Sample conditioning** — water trap and particulate filter on the probe. Without these, condensate gets into the cell housing and kills the CO sensor in months.
...
- Integrated draft pressure (±0.03 inWC) and manifold pressure (up to 80 inWC with adapter)
- 1112°F stack thermocouple, 21°F ambient
- 240+ hour battery, IP40 rated, includes water trap and particle filter
- Color graphic display readable in sunlight on a roof
...
- CO range 0–2000 ppm
- 999°F stack temp, 158°F ambient
- Rugged rubber overmold, includes water trap
...
- 1800°F stack thermocouple — handles commercial water heaters and boilers
- Integrated draft pressure, fits standard 1/4" probe ports
...
- Printer-ready outputs to IR or thermal printer
- Sensor diagnostic built into firmware — tells you when each cell is approaching end of life
- Rugged industrial housing, IP54
...
- **Digital manometer** for static pressure and gas manifold pressure — Fieldpiece SDMN6 (covered in [best manometer for HVAC](/posts/best-manometer-for-hvac))
- **Multimeter with µA DC** for flame current — Fluke 117 (covered in [best multimeter for HVAC](/posts/best-multimeter-for-hvac))
- **Personal CO monitor** that stays on your belt — Sensorcon Inspector or BW Clip. Separate from the analyzer; it's there to save your life, not measure stack chemistry.
- **Drill brush + flue brushes** — for cleaning the burner area before tuning
- **Spare K-type thermocouple** — the integrated probe thermocouple is the most likely failure point on a 5-year-old analyzer

## FAQs

**How often does the CO sensor need to be replaced?**
...
**Do I need NO measurement?**
Only if you do work in jurisdictions that regulate NOx emissions on commercial appliances (parts of CA, NYC, certain industrial permits). For residential and standard commercial work, no.

**Why is my analyzer reading 0% O2 right out of the bag?**
The O2 sensor needs to "wake up" with ambient oxygen exposure. Pull the probe out, leave it in fresh air with the analyzer powered on for 60 seconds. If it doesn't read 20.9% in clean room air, the O2 cell is dead and needs replacement.
