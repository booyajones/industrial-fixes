...
| Part | Notes |
|------|-------|
| Inverter board | High cost — verify with Trane tech support before ordering |
| ComfortLink II thermostat | Required for fault code display |
| Defrost sensor | Clip-on thermistor — verify resistance |
| Reversing valve | Match refrigerant type |
| Electronic expansion valve (EXV) | Variable speed units use EXV not TXV |
