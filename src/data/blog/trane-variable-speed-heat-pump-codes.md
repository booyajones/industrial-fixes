...
| Part | Notes |
|------|-------|
| Inverter board | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-trane-variable-speed-heat-pump-codes&k=Inverter+board&tag=errorcodefixes-20) \| High cost — verify with Trane tech support before ordering |
| ComfortLink II thermostat | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-trane-variable-speed-heat-pump-codes&k=ComfortLink+II+thermostat&tag=errorcodefixes-20) \| Required for fault code display |
| Defrost sensor | [Amazon](https://www.amazon.com/dp/B09FFFPF5L?ascsubtag=ecf-trane-variable-speed-heat-pump-codes&tag=errorcodefixes-20) \| Clip-on thermistor — verify resistance |
| Reversing valve | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-trane-variable-speed-heat-pump-codes&k=Reversing+valve&tag=errorcodefixes-20) \| Match refrigerant type |
| Electronic expansion valve (EXV) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-trane-variable-speed-heat-pump-codes&k=Electronic+expansion+valve+%28EXV%29&tag=errorcodefixes-20) \| Variable speed units use EXV not TXV |
