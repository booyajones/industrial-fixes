...
| Part | Notes |
|------|-------|
| Flame sensor | Most common; clean first, replace if cracked |
| Hot surface ignitor | 120V silicon nitride type for 58UX |
| Pressure switch | Confirm correct water column rating (typically 0.85" or 1.2") |
| Inducer motor | If inducer is weak or noisy, pressure switch faults follow |
| High-limit switch | Auto-reset type; check continuity before replacing |
| Rollout switch | Manual reset; investigate cause before resetting |
