...
| Part | Notes |
|------|-------|
| Micrologic trip unit | Replacement when electronics fail |
| Arc chutes | Replace after multiple SC trips |
| BSCM communication module | Replace on communication fault |
| Auxiliary contact blocks | Replace on worn auxiliary contacts |
| Breaker body (NW/NT) | Replace at end of contact life |
