---
title: "Frigidaire Refrigerator Not Making Ice - Causes & Fix"
description: "Usually caused by a clogged water filter or closed supply valve. Replace the filter and verify the water line is open and not kinked."
pubDatetime: 2026-06-01T18:21:00Z
modDatetime: 2026-06-01T18:21:00Z
author: "Marcus Webb"
featured: false
draft: false
tags:
...
1. Verify the refrigerator is connected to the water supply and the shutoff valve is fully open.
2. Inspect the water supply line behind the refrigerator for kinks, crushing, or disconnection.
3. Check that the ice maker is switched on and that the wire signal arm moves freely and is not obstructed by ice or a misaligned bin.
4. Measure the freezer temperature to confirm it is near 0°F. If the freezer is too warm, diagnose and fix the cooling problem first.
5. Remove and reinstall the water filter to confirm it is seated correctly, then replace the filter if it is older than six months or visibly clogged.
6. Listen for the ice maker fill cycle or manually trigger a test cycle if your model supports it. If the ice maker tries to cycle but no water enters, test the water inlet valve for power and continuity.
7. If the inlet valve has supply water and electrical power but does not open, replace the valve.
8. If all upstream checks pass and the ice maker still does not cycle or harvest, remove the ice maker assembly and test the thermostat and control head for continuity, then replace the ice maker if defective.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Frigidaire refrigerator water filter | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-refrigerator-not-making-ice&k=Frigidaire+refrigerator+water+filter&tag=errorcodefixes-20) \| Replace every six months or when flow is restricted. |
| Water inlet valve | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-refrigerator-not-making-ice&k=Water+inlet+valve&tag=errorcodefixes-20) \| Solenoid valve that controls water fill to the ice maker. |
| Ice maker assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-refrigerator-not-making-ice&k=Ice+maker+assembly&tag=errorcodefixes-20) \| Complete module including thermostat, control head, and harvest mechanism. |
