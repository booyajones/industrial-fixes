...
| Part | Notes |
|------|-------|
| Valve coil (MFH/MEBH) | [Amazon](https://www.amazon.com/s?k=Valve+coil+%28MFH%2FMEBH%29&tag=errorcodefixes-20) \| Replace on short circuit |
| CPX module | [Amazon](https://www.amazon.com/s?k=CPX+module&tag=errorcodefixes-20) \| Replace on persistent CPU fault |
| Encoder cable (CMMT) | [Amazon](https://www.amazon.com/s?k=Encoder+cable+%28CMMT%29&tag=errorcodefixes-20) \| Common EMI/damage point |
| Pressure regulator (LFR series) | [Amazon](https://www.amazon.com/s?k=Pressure+regulator+%28LFR+series%29&tag=errorcodefixes-20) \| Replace when flow drops |
| Filter element | [Amazon](https://www.amazon.com/s?k=Filter+element&tag=errorcodefixes-20) \| Replace per maintenance schedule |
## When to Call a Pro
