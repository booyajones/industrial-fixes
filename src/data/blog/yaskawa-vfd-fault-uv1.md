...
| Part | Notes |
|------|-------|
| Input fuses (semiconductor type) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-yaskawa-vfd-fault-uv1&k=Input+fuses+%28semiconductor+type%29&tag=errorcodefixes-20) \| Yaskawa specifies fuse type and current rating in the drive manual |
| DC bus capacitors | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-yaskawa-vfd-fault-uv1&k=DC+bus+capacitors&tag=errorcodefixes-20) \| Replacement is practical on larger drives; requires capacitor reformation procedure |
| Line reactor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-yaskawa-vfd-fault-uv1&k=Line+reactor&tag=errorcodefixes-20) \| Reduces the impact of utility voltage sags on the DC bus |
## When to Call a Pro
