...
| Continuous on | Module locked in fault | Cycle power to reset |
...
| Motor Family | Module Style | Common HP |
|-------------|-------------|-----------|
| ECM 2.3 | Separate slide-on module | 1/2–1 HP |
| ECM X13 | Integrated module | 1/3–3/4 HP |
| ECM 3.0 | Separate bolt-on module | 1/2–1-1/2 HP |
