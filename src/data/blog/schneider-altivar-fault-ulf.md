...
| Part | Notes |
|------|-------|
| Drive belt (V-belt or synchronous) | Replace if worn, cracked, or broken |
| Flexible coupling insert | Replace if rubber insert or spider has failed |
| Pump foot valve / check valve | Replace if pump is losing prime repeatedly |
