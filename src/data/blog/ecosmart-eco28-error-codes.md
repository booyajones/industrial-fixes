---
title: "EcoSmart Eco 28 Error Codes - Causes & Fix"
description: "Troubleshoot EcoSmart Eco 28 error codes E1, E2, E3, E4, and E5. Step-by-step repair guide for thermistor, temperature, and flow faults."
pubDatetime: 2026-05-25T20:48:53Z
modDatetime: 2026-05-25T20:48:53Z
author: "Marcus Webb"
featured: false
draft: false
tags:
...
1. **Verify the error code displayed** and note whether it is E1, E2, E3, E4, or E5 before beginning diagnosis.
2. **For E1, E2, or E3, perform the reset test** by opening a hot water faucet, pressing and holding the round control knob for 3 to 5 seconds until the display changes to CE1 or CE2, then running water for 2 to 3 minutes to see if heating resumes.
3. **For E4, measure and reduce incoming water temperature** to below 140 °F by adjusting recirculation settings, tempering valves, or solar preheat loops.
4. **For E5, reduce flow rate** by partially closing the inlet or outlet shutoff valve or installing a flow restrictor so the heater can keep up with demand.
5. **Check main breaker power and measure supply voltage** at the unit terminals to confirm you have at least 240 V or 208 V depending on model configuration.
6. **Inspect terminal block connections and thermistor wiring** for crossed wires, loose screws, or corrosion that would prevent accurate sensor readings.
7. **Replace the failed thermistor** if the code persists after reset and wiring checks, and inspect the heat exchanger for freeze damage, sediment, or mineral scale that could affect sensor contact.

## Parts Often Needed

| Part | Notes |
|------|-------|
| EcoSmart inlet thermistor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ecosmart-eco28-error-codes&k=EcoSmart+inlet+thermistor&tag=errorcodefixes-20) \| Factory replacement sensor for E1 faults. |
| EcoSmart outlet thermistor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ecosmart-eco28-error-codes&k=EcoSmart+outlet+thermistor&tag=errorcodefixes-20) \| Factory replacement sensor for E2 faults. |
| Flow restrictor or flow control valve | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ecosmart-eco28-error-codes&k=Flow+restrictor+or+flow+control+valve&tag=errorcodefixes-20) \| Reduces flow rate to resolve E5 high-flow errors. |
