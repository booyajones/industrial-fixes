...
| Part | Notes |
|------|-------|
| Internal battery module | Size to UPS model |
| External battery module (EBM) | For extended runtime systems |
| Network management card | Replace on communication fault |
| Fan tray / fan module | Replace on fan fault |
| Static bypass assembly | Replace on switching fault |
