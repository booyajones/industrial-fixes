...
| Part | Notes |
|------|-------|
| Internal battery module | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-eaton-ups-fault-codes&k=Internal+battery+module&tag=errorcodefixes-20) \| Size to UPS model |
| External battery module (EBM) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-eaton-ups-fault-codes&k=External+battery+module+%28EBM%29&tag=errorcodefixes-20) \| For extended runtime systems |
| Network management card | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-eaton-ups-fault-codes&k=Network+management+card&tag=errorcodefixes-20) \| Replace on communication fault |
| Fan tray / fan module | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-eaton-ups-fault-codes&k=Fan+tray+%2F+fan+module&tag=errorcodefixes-20) \| Replace on fan fault |
| Static bypass assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-eaton-ups-fault-codes&k=Static+bypass+assembly&tag=errorcodefixes-20) \| Replace on switching fault |
## When to Call a Pro
