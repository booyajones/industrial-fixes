...
- **No gas or low gas pressure** — The most common cause. A closed gas shutoff valve, low line pressure, or insufficient BTU capacity on the supply line prevents the burner from establishing flame.
- **Dirty flame rod** — The ionization rod (flame sensor) accumulates silicon oxide deposits from combustion byproducts. A coated rod cannot pass the microamp signal needed to confirm flame to the control board.
- **Failed igniter** — A cracked or failed spark igniter won't produce the spark arc needed to light the gas-air mixture.
- **Blocked air intake or exhaust** — A restricted combustion air supply or blocked exhaust prevents proper combustion, causing the flame to go out immediately after ignition.
...
| Part | Notes |
|------|-------|
| Flame rod / ionization sensor | [Amazon](https://www.amazon.com/s?k=Flame+rod+%2F+ionization+sensor&tag=errorcodefixes-20) \| Clean first; replace if corroded or wire insulation is damaged |
| Igniter assembly | [Amazon](https://www.amazon.com/s?k=Igniter+assembly&tag=errorcodefixes-20) \| Match Noritz model (NRC, NRCR, EZ series vary) |
| Gas valve | [Amazon](https://www.amazon.com/s?k=Gas+valve&tag=errorcodefixes-20) \| Replace if voltage present at coil but valve won't open |
| Air intake screen | [Amazon](https://www.amazon.com/s?k=Air+intake+screen&tag=errorcodefixes-20) \| Clean or replace if blocked |
## When to Call a Pro
