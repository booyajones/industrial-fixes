---
title: "Bosch Fridge Freezer Cold but Fresh Food Warm - Causes & Fix"
description: "Blocked air vents or a failed evaporator fan prevent cold air from reaching the fresh-food section. Clear obstructions and verify fan operation."
pubDatetime: 2026-06-09T23:23:23Z
modDatetime: 2026-06-09T23:23:23Z
...
1. Verify the symptom with independent thermometers in both compartments, not relying only on the display readout.
2. Move perishable food to safe storage if the fresh-food section is warm enough to threaten food safety.
3. Check temperature settings, special zone controls, and any cooling-drawer configurations to confirm they are set correctly.
4. Inspect for blocked vents by looking at rear air outlets and internal vent grilles, and remove any food, bins, or packaging obstructing airflow.
5. Inspect the door gasket and cabinet sealing surface for debris, tears, folds, or misalignment, then clean and correct as needed.
6. Look for frost or ice on the back wall, around air passages, or on the evaporator area, noting that recurring frost points to a defrost or airflow failure.
7. Confirm evaporator fan operation when the door switch is actuated and the unit is calling for cooling, replacing the fan if it is not running.
8. Check the damper for opening and closing action and for ice obstruction, replacing it if mechanically failed or electrically unresponsive.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Evaporator fan motor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-bosch-refrigerator-fresh-food-warm-but-freezer-cold&k=Evaporator+fan+motor&tag=errorcodefixes-20) \| Circulates cold air from freezer to fresh-food section. |
| Air damper assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-bosch-refrigerator-fresh-food-warm-but-freezer-cold&k=Air+damper+assembly&tag=errorcodefixes-20) \| Regulates cold air flow to refrigerator compartment. |
| Door gasket (refrigerator section) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-bosch-refrigerator-fresh-food-warm-but-freezer-cold&k=Door+gasket+%28refrigerator+section%29&tag=errorcodefixes-20) \| Seals fresh-food compartment to prevent warm air infiltration. |
