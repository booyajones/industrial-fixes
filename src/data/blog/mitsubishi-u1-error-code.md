...
| Part | Notes |
|------|-------|
| Supply wire upsizing | [Amazon](https://www.amazon.com/s?k=Supply+wire+upsizing&tag=errorcodefixes-20) \| Consult NEC and unit ampacity specs; undersized wire is a fire risk |
| Fuse holder or cartridge fuse | [Amazon](https://www.amazon.com/s?k=Fuse+holder+or+cartridge+fuse&tag=errorcodefixes-20) \| Replace blown fuses; identify the short or overload that caused the blow first |
| Inverter PCB | [Amazon](https://www.amazon.com/s?k=Inverter+PCB&tag=errorcodefixes-20) \| Replace only after confirming supply voltage is within specification |
## When to Call a Pro
