...
| Part | Where to Buy |
|------|-------------|
| [Communication / control cable (per foot)](https://www.amazon.com/s?ascsubtag=ecf-mitsubishi-e1-error-code&k=Communication+%2F+control+cable+%28per+foot%29&tag=errorcodefixes-20) | Grainger, Amazon |
| [Indoor unit main PCB](https://www.amazon.com/s?ascsubtag=ecf-mitsubishi-e1-error-code&k=Indoor+unit+main+PCB&tag=errorcodefixes-20) | SupplyHouse, Grainger |
| [Outdoor main PCB](https://www.amazon.com/s?ascsubtag=ecf-mitsubishi-e1-error-code&k=Outdoor+main+PCB&tag=errorcodefixes-20) | SupplyHouse, Grainger |
