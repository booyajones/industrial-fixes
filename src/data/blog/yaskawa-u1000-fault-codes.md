...
| Part | Notes |
|------|-------|
| Cooling fan | Match U1000 frame size |
| Control board | Contact Yaskawa before ordering |
| Input filter | Required for matrix drive installations |
| Bypass contactor | For maintenance bypass configurations |
