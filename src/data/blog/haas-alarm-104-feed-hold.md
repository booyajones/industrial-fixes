...
| Part | Notes |
|------|-------|
| Door interlock switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-haas-alarm-104-feed-hold&k=Door+interlock+switch&tag=errorcodefixes-20) \| Replace if door cycling resolves the fault; Haas part numbers vary by machine |
| Feed Hold push button | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-haas-alarm-104-feed-hold&k=Feed+Hold+push+button&tag=errorcodefixes-20) \| Replace if the button is mechanically stuck in the pressed position |
## When to Call a Pro
