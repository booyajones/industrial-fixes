...
| Part | Notes |
|------|-------|
| Door interlock switch | Replace if door cycling resolves the fault; Haas part numbers vary by machine |
| Feed Hold push button | Replace if the button is mechanically stuck in the pressed position |
