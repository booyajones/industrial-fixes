...
| Part | Notes |
|------|-------|
| Input fuses (class J or CC) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-allen-bradley-powerflex-fault-f004&k=Input+fuses+%28class+J+or+CC%29&tag=errorcodefixes-20) \| Use properly rated fuses; wrong rating will not protect the drive |
| DC bus capacitor kit | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-allen-bradley-powerflex-fault-f004&k=DC+bus+capacitor+kit&tag=errorcodefixes-20) \| Available from Rockwell or aftermarket repair kits for common models |
| Input line reactor (3–5%) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-allen-bradley-powerflex-fault-f004&k=Input+line+reactor+%283%E2%80%935%25%29&tag=errorcodefixes-20) \| Install if supply impedance is causing voltage dips |
## When to Call a Pro
