...
| Part | Notes |
|------|-------|
| Input fuses (class J or CC) | Use properly rated fuses; wrong rating will not protect the drive |
| DC bus capacitor kit | Available from Rockwell or aftermarket repair kits for common models |
| Input line reactor (3–5%) | Install if supply impedance is causing voltage dips |
