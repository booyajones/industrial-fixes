---
title: "Trane XR90 Furnace Problems & Error Codes"
description: "The most common problem on the XR90 is a 3-flash pressure switch error caused by blocked venting or a failed pressure switch."
...
| Part | Notes |
|------|-------|
| Pressure switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-trane-xr90-furnace-gas-residential-problems&k=Pressure+switch&tag=errorcodefixes-20) \| Fails mechanically or electrically and won't close to prove draft, causing repeated 3-flash errors even after venting is cleared. |
| High-limit switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-trane-xr90-furnace-gas-residential-problems&k=High-limit+switch&tag=errorcodefixes-20) \| Opens on overheating or fails in the open position, triggering 4-flash codes and preventing ignition. |
| Pressure switch tubing | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-trane-xr90-furnace-gas-residential-problems&k=Pressure+switch+tubing&tag=errorcodefixes-20) \| Small rubber or silicone hose that cracks, disconnects, or fills with water over time. |
| Inducer motor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-trane-xr90-furnace-gas-residential-problems&k=Inducer+motor&tag=errorcodefixes-20) \| Can develop worn bearings or fail to create adequate draft, leading to pressure switch faults. |
