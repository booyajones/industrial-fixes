...
| Part | Notes |
|------|-------|
| Replacement motor | If windings are confirmed overheated (insulation resistance test) |
| System components (impeller, filter) | If overload is caused by blocked system elements |
