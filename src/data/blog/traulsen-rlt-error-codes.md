...
| Part | Notes |
|---|---|
| Box temperature sensor | Traulsen specific; verify probe length and connector |
| Defrost heater | Match wattage; multiple heaters on some RLT models |
| Defrost termination thermostat | Check cutout temperature |
| DCS relay board | For Er fault; verify cable before replacing board |
| Door gasket | Traulsen magnetic gasket; order by door and hinge orientation |
| Evaporator fan motor | Match existing specifications |
