...
| Part | Notes |
|---|---|
| Box temperature sensor | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-traulsen-rlt-error-codes&k=Traulsen+Box+temperature+sensor&tag=errorcodefixes-20) \| Traulsen specific; verify probe length and connector |
| Defrost heater | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-traulsen-rlt-error-codes&k=Traulsen+Defrost+heater&tag=errorcodefixes-20) \| Match wattage; multiple heaters on some RLT models |
| Defrost termination thermostat | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-traulsen-rlt-error-codes&k=Traulsen+Defrost+termination+thermostat&tag=errorcodefixes-20) \| Check cutout temperature |
...
| Door gasket | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-traulsen-rlt-error-codes&k=Traulsen+Door+gasket&tag=errorcodefixes-20) \| Traulsen magnetic gasket; order by door and hinge orientation |
| Evaporator fan motor | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-traulsen-rlt-error-codes&k=Traulsen+Evaporator+fan+motor&tag=errorcodefixes-20) \| Match existing specifications |
## When to Call a Pro
