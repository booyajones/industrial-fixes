...
| Part | Notes |
|------|-------|
| Motor thermal sensor | Replace on E1/E2 overheat |
| Drive motor brushes (older models) | Replace on current fault |
| Battery charger | Replace on charging faults |
| Engine oil pressure sender | Replace on A01 fault |
| Thermostat | Replace on A02 coolant fault |
