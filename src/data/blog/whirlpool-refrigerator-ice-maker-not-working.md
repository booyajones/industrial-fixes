---
title: "Whirlpool Refrigerator Ice Maker Not Working - Causes & Fix"
description: "Most often the ice maker is turned off or the water filter isn't sealing. Check the ice maker switch, reset the unit, and reseat the filter."
...
| Part | Notes |
|------|-------|
| Whirlpool ice maker assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-whirlpool-refrigerator-ice-maker-not-working&k=Whirlpool+ice+maker+assembly&tag=errorcodefixes-20) \| Replace if water supply, temperature, and inlet valve test good but the unit still will not cycle. |
| Water inlet valve | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-whirlpool-refrigerator-ice-maker-not-working&k=Water+inlet+valve&tag=errorcodefixes-20) \| Replace if the ice maker completes harvest cycles but no water enters the mold and voltage is present at the valve. |
| Whirlpool refrigerator water filter | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-whirlpool-refrigerator-ice-maker-not-working&k=Whirlpool+refrigerator+water+filter&tag=errorcodefixes-20) \| Replace if removing the old filter restores water flow or if the filter is overdue for replacement. |
