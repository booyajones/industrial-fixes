...
| Part | Notes |
|------|-------|
| NTC temperature sensor | Match the Buderus part number for the specific model (GB142, GB162, etc.) |
| Condensate siphon / trap | Buderus OEM; condensing models require the correct internal volume |
