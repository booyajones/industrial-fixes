...
| Part | Notes |
|------|-------|
| NTC temperature sensor | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-buderus-boiler-fault-code-a1&k=Buderus+NTC+temperature+sensor&tag=errorcodefixes-20) \| Match the Buderus part number for the specific model (GB142, GB162, etc.) |
