---
title: "York TG9S Furnace Problems & Error Codes"
description: "Rapid red flash (fault 9) from reversed line-voltage polarity or bad ground is most common. Check supply polarity and chassis ground first."
pubDatetime: 2026-06-08T09:10:14Z
modDatetime: 2026-06-08T09:10:14Z
...
| Part | Notes |
|------|-------|
| Ignition control board | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-york-tg9s-furnace-gas-residential-problems&k=Ignition+control+board&tag=errorcodefixes-20) \| Fails after polarity faults or internal component wear, always verify wiring and grounding before replacement |
| Hot-surface igniter | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-york-tg9s-furnace-gas-residential-problems&k=Hot-surface+igniter&tag=errorcodefixes-20) \| Cracks from thermal cycling or rough handling, visible hairline cracks require replacement |
| Flame sensor rod | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-york-tg9s-furnace-gas-residential-problems&k=Flame+sensor+rod&tag=errorcodefixes-20) \| Carbon buildup on the sensor tip causes weak signal and flame-loss codes, clean with fine abrasive or replace |
| Blower motor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-york-tg9s-furnace-gas-residential-problems&k=Blower+motor&tag=errorcodefixes-20) \| Bearings fail or capacitor weakens, causes limit trips and reduced airflow |
