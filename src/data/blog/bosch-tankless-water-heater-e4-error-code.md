...
description: "E4 means backflow temperature over 309°F. Most often caused by blocked venting or a failed secondary fan. Check vent and fan first."
pubDatetime: 2026-05-31T14:58:53Z
modDatetime: 2026-05-31T14:58:53Z
author: "Marcus Webb"
featured: false
draft: false
tags:
...
- **Blocked or restricted venting** Exhaust or intake pipes that are obstructed, kinked, or installed with excessive length or too many elbows prevent proper airflow and cause internal overheating.
- **Failed or obstructed secondary fan** The secondary fan may have stopped spinning due to a burned-out motor, damaged bushings, debris in the blades, or wiring faults, cutting off the airflow needed to cool the heat exchanger.
- **Faulty backflow temperature sensor or wiring** The sensor itself may have drifted out of calibration, or its connector and harness may be loose, corroded, or damaged, sending false overheat signals to the control board.
- **Poor combustion-air conditions or vent leakage** If the appliance is installed in a confined space without adequate fresh air or if vent joints are leaking exhaust back into the combustion chamber, the unit will overheat and trip the sensor.
...
| Part | Notes |
|------|-------|
| Bosch backflow temperature sensor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-bosch-tankless-water-heater-e4-error-code&k=Bosch+backflow+temperature+sensor&tag=errorcodefixes-20) \| Match the sensor part number to your specific Bosch tankless model (Greentherm, Therm, AquaStar series). |
| Bosch secondary fan motor assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-bosch-tankless-water-heater-e4-error-code&k=Bosch+secondary+fan+motor+assembly&tag=errorcodefixes-20) \| Order the correct fan assembly by your model number if the motor is noisy, won't spin, or has damaged bushings. |
| Wiring harness for temperature sensor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-bosch-tankless-water-heater-e4-error-code&k=Wiring+harness+for+temperature+sensor&tag=errorcodefixes-20) \| Use an OEM Bosch harness if the original connector or wiring is corroded, melted, or broken. |
