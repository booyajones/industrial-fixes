...
| Part | Notes |
|------|-------|
| Thermal fuse (outlet) | Rinnai OEM; one-time device, must be replaced after trip |
| Outlet thermistor | NTC type; match model-specific part number |
| Descaling solution | White vinegar or Rinnai-approved descaler |
