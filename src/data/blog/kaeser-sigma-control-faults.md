...
| Part | Notes |
|------|-------|
| Oil separator element | [Amazon](https://www.amazon.com/s?k=Oil+separator+element&tag=errorcodefixes-20) \| Kaeser-specific — match model |
| Oil filter element | [Amazon](https://www.amazon.com/s?k=Oil+filter+element&tag=errorcodefixes-20) \| Match package model |
| Pressure transducer | [Amazon](https://www.amazon.com/s?k=Pressure+transducer&tag=errorcodefixes-20) \| Check signal output (typically 4–20 mA) |
