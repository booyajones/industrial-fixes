...
| Part | Notes |
|------|-------|
| Oil separator element | Kaeser-specific — match model |
| Oil filter element | Match package model |
| Pressure transducer | Check signal output (typically 4–20 mA) |
| Temperature sensor | NTC thermistor — check resistance |
| Condensate drain solenoid | Match voltage and orifice size |
| Fan motor contactor | Check contact condition |
