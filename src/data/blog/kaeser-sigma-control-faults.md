...
|--------------|----------|--------------|--------|
| Final compression temp ΓÇö Warning | Warning | Approaching high temp limit | Clean coolers, check oil |
| Final compression temp ΓÇö Shutdown | Shutdown | Excessive temperature | Clean coolers, check oil, check ambient |
| Motor protection ΓÇö Shutdown | Shutdown | Motor overload | Check motor amps and load |
| Emergency stop ΓÇö Active | Shutdown | E-stop circuit open | Check all E-stop switches |
| Pressure sensor ΓÇö Fault | Warning | Failed pressure transducer | Check sensor wiring and signal |
| Temperature sensor ΓÇö Fault | Warning | Failed temperature sensor | Check sensor resistance |
| Dryer ΓÇö Fault | Warning | Integrated dryer alarm | Check refrigerant dryer operation |
| Service ΓÇö Required | Maintenance | Service interval reached | Perform scheduled service |
| Fan motor ΓÇö Fault | Shutdown | Cooling fan motor fault | Check fan motor amps and contactor |
| Condensate drain ΓÇö Fault | Warning | Drain solenoid not operating | Check drain solenoid and timer |
| Oil filter ΓÇö Service | Maintenance | Oil filter replacement due | Replace oil filter element |
| Differential pressure ΓÇö High | Warning | Separator element clogged | Replace separator element |
| Communication ΓÇö Fault | Warning | Network communication loss | Check Ethernet and network config |
| Phase ΓÇö Fault | Shutdown | Phase loss or reversal | Check input power quality |

## Most Common SIGMA CONTROL 2 Faults

### Final Compression Temp ΓÇö Shutdown
Kaeser's shutdown threshold is typically 110┬░C (230┬░F). Warning precedes shutdown by approximately 5┬░C. Root cause is almost always a dirty cooler. Kaeser SIGMA CONTROL 2 logs the temperature trend ΓÇö review to see if temp is climbing progressively or suddenly.
