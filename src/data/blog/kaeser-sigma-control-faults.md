...
| Temperature sensor | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-kaeser-sigma-control-faults&k=Kaeser+Temperature+sensor&tag=errorcodefixes-20) \| NTC thermistor — check resistance |
...
| Fan motor contactor | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-kaeser-sigma-control-faults&k=Kaeser+Fan+motor+contactor&tag=errorcodefixes-20) \| Check contact condition |
