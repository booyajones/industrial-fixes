---
title: "Amana Dryer Won't Tumble - Causes & Fix"
description: "A broken drive belt is the most common cause when an Amana dryer won't tumble. Check if the drum spins freely by hand to confirm."
pubDatetime: 2026-06-09T13:19:29Z
modDatetime: 2026-06-09T13:19:29Z
...
1. Unplug the dryer and confirm the breaker has not tripped.
2. Open the door and try to rotate the drum by hand. If it spins very freely with little resistance the drive belt is likely broken.
3. Remove the top or front panel according to your model's service access and visually inspect the drive belt for breakage, fraying, or being off its pulleys.
4. If the belt is intact, check that the idler pulley spins freely on its shaft and is not seized or cracked.
5. Inspect the drum rollers and glides for wear, flat spots, or binding that would prevent smooth rotation.
6. If the motor hums but does not turn, remove the belt from the motor and check the blower wheel for lint or foreign objects, then try spinning the drum by hand with the belt off to confirm it is not binding.
7. Test the thermal fuse for continuity with a multimeter if the dryer is completely dead, and test the door switch if the unit powers on but does not start.
8. Replace any failed component, reassemble the cabinet, plug in the dryer, and run a test cycle to verify smooth drum rotation and normal operation.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Drive belt | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-amana-dryer-wont-tumble&k=Drive+belt&tag=errorcodefixes-20) \| Match the belt length and width to your Amana model number. |
| Idler pulley | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-amana-dryer-wont-tumble&k=Idler+pulley&tag=errorcodefixes-20) \| Often replaced at the same time as the belt to prevent repeat failures. |
| Drum roller kit | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-amana-dryer-wont-tumble&k=Drum+roller+kit&tag=errorcodefixes-20) \| Includes front or rear rollers and shafts for models that use roller support. |
| Thermal fuse | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-amana-dryer-wont-tumble&k=Thermal+fuse&tag=errorcodefixes-20) \| One-time use component that must be replaced if open, not reset. |
