...
| Part | Notes |
|------|-------|
| BOP-2 operator panel | Plug-in display for fault reading |
| Cooling fan | Internal fan — match G120X size |
| Power stack module | Only for IGBT failure confirmed by Siemens |
| Input choke | Reduces harmonic distortion |
| Output reactor | Required for long cable runs |
