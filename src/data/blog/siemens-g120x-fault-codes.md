...
| Part | Notes |
|------|-------|
| BOP-2 operator panel | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-siemens-g120x-fault-codes&k=BOP-2+operator+panel&tag=errorcodefixes-20) \| Plug-in display for fault reading |
| Cooling fan | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-siemens-g120x-fault-codes&k=Cooling+fan&tag=errorcodefixes-20) \| Internal fan — match G120X size |
| Power stack module | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-siemens-g120x-fault-codes&k=Power+stack+module&tag=errorcodefixes-20) \| Only for IGBT failure confirmed by Siemens |
| Input choke | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-siemens-g120x-fault-codes&k=Input+choke&tag=errorcodefixes-20) \| Reduces harmonic distortion |
| Output reactor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-siemens-g120x-fault-codes&k=Output+reactor&tag=errorcodefixes-20) \| Required for long cable runs |
