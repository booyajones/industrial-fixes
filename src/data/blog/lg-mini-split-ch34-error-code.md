...
| Part | Notes |
|------|-------|
| Outdoor condenser fan motor | [Amazon](https://www.amazon.com/dp/B0D2L5NSMM?ascsubtag=ecf-lg-mini-split-ch34-error-code&tag=errorcodefixes-20) \| Match RPM, frame size, and rotation |
| Condenser fan capacitor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lg-mini-split-ch34-error-code&k=Condenser+fan+capacitor&tag=errorcodefixes-20) \| Test before ordering a new motor |
| Outdoor unit inverter board | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lg-mini-split-ch34-error-code&k=Outdoor+unit+inverter+board&tag=errorcodefixes-20) \| OEM required; match exact model number |
| Refrigerant (R-410A or R-32) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lg-mini-split-ch34-error-code&k=Refrigerant+%28R-410A+or+R-32%29&tag=errorcodefixes-20) \| Licensed tech only |
## When to Call a Pro
