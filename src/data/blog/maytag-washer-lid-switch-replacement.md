---
title: "Maytag Washer Lid Switch Replacement - Signs & How-To"
description: "Washer won't start, agitate, or spin when lid is closed. Replacing the failed lid switch or lid lock assembly restores normal operation."
pubDatetime: 2026-06-01T15:40:45Z
modDatetime: 2026-06-01T15:40:45Z
...
- **Washer will not start at all** You press Start but nothing happens, even with the lid fully closed.
- **Fills but won't agitate or spin** The washer fills with water but the drum never moves, or it agitates but refuses to spin.
- **No click when lid closes** On older models you normally hear a click when you close the lid, but now you hear nothing.
- **Lid lock does not engage** On newer machines the lid stays unlocked during the cycle, or you see a lid-lock fault on the display.
- **Intermittent operation** The washer works sometimes and other times refuses to start, depending on how hard you push the lid down.
- **Drum spins even with lid open** The basket spins at high speed when you lift the lid, a dangerous safety failure that means the switch is stuck closed.
...
| Part | Notes |
|------|-------|
| Maytag lid switch assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-maytag-washer-lid-switch-replacement&k=Maytag+lid+switch+assembly&tag=errorcodefixes-20) \| For older direct-drive top-loaders. Genuine Maytag part WP8318084 or equivalent OEM parts 12001908, 22003804, and 22004243 depending on your model. Find your exact model and serial number on the data plate inside the lid or on the rear panel, then cross-reference the correct switch assembly. |
| Maytag lid lock assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-maytag-washer-lid-switch-replacement&k=Maytag+lid+lock+assembly&tag=errorcodefixes-20) \| For newer Whirlpool-built Maytag top-loaders with electronic controls. Part W11307244 is a common replacement. Verify fitment using your full model number before ordering. |
