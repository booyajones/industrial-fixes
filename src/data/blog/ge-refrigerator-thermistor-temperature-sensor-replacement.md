---
title: "GE Refrigerator Thermistor Replacement - Signs & How-To"
description: "Wrong temps, frost buildup, or error codes mean a bad thermistor. Replacing the evaporator sensor restores accurate cooling and defrost cycles."
pubDatetime: 2026-06-01T20:34:40Z
modDatetime: 2026-06-01T20:34:40Z
author: "Marcus Webb"
featured: false
draft: false
tags:
...
- **Temperature error code on the display** The control panel shows a fault code related to temperature sensing or the thermistor circuit.
- **Compressor runs constantly or not at all** The board can't read temperature correctly so it either never shuts off the compressor or never starts it.
- **Excessive frost or ice buildup on the evaporator** A bad sensor can prevent the defrost cycle from running when it should, leading to a frozen coil and reduced airflow.
- **Food too warm in the fresh-food or freezer compartment** The control system thinks the temperature is colder than it really is and under-cools the cabinet.
- **Food freezing in the fresh-food section** The sensor reports a warmer-than-actual temperature so the board over-cools the fresh-food compartment.
- **Visible damage to the thermistor bulb, clip, or wiring** Cracks, burns, corrosion, or a loose clip on the evaporator tube will cause an implausible resistance reading.
...
| Part | Notes |
|------|-------|
| GE refrigerator evaporator thermistor / temperature sensor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-refrigerator-thermistor-temperature-sensor-replacement&k=GE+refrigerator+evaporator+thermistor+%2F+temperature+sensor&tag=errorcodefixes-20) \| WR55X10025 is common on many GE models. Find your exact part number on the model and serial plate inside the fresh-food compartment or on the left sidewall, then cross-reference it with GE parts lookup or your service sheet. |
| Butt connectors or wire nuts (electrical splice kit) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-refrigerator-thermistor-temperature-sensor-replacement&k=Butt+connectors+or+wire+nuts+%28electrical+splice+kit%29&tag=errorcodefixes-20) \| Use appropriately sized connectors for the wire gauge on your thermistor leads, and seal each splice with heat-shrink or silicone to keep moisture out. |
