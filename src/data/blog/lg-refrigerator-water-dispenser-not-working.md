---
title: "LG Refrigerator Water Dispenser Not Working - Causes & Fix"
description: "Control Lock is usually engaged. Hold the lock button for 3 seconds to unlock. If that doesn't work, check the door switch and water supply."
pubDatetime: 2026-06-01T15:25:37Z
modDatetime: 2026-06-01T15:25:37Z
...
1. Check the display panel for any visible error code and note your exact model number before you start.
2. Look for a locked padlock icon on the display and hold the lock button for 3 seconds to disable Control Lock.
3. Press the dispenser lever and listen closely for a hum from the dispenser mechanism or water valve.
4. If there is no hum, push the door switch (or hold a magnet at the magnetic sensor locations on the door frame) and confirm the interior lights turn off.
5. Open the top hinge cover on each door and check that the wire harness connectors are fully seated and not loose.
6. Verify the household water supply shutoff is turned on and inspect the water line behind the refrigerator for kinks or crushing.
7. Pull the water filter and check for clogs or replace it if it's old or restricted.
8. If the dispenser hums but no water comes out and the filter is clear, check for a frozen water line by unplugging the refrigerator, shutting off the water, and allowing the internal line and reservoir to thaw before retesting.

## Parts You Might Need

| Part | Notes |
|------|-------|
| LG refrigerator door switch or door sensor assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lg-refrigerator-water-dispenser-not-working&k=LG+refrigerator+door+switch+or+door+sensor+assembly&tag=errorcodefixes-20) \| Required if the switch does not turn off the interior lights or the dispenser will not hum. |
| LG refrigerator water inlet valve | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lg-refrigerator-water-dispenser-not-working&k=LG+refrigerator+water+inlet+valve&tag=errorcodefixes-20) \| Replace if the valve hums during a dispense call but no water flows and supply pressure is confirmed good. |
| LG refrigerator water filter | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lg-refrigerator-water-dispenser-not-working&k=LG+refrigerator+water+filter&tag=errorcodefixes-20) \| Replace if clogged or overdue per your model's service interval. |
