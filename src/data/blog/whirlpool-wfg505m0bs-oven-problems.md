---
title: "Whirlpool WFG505M0BS Oven Problems & Error Codes"
description: "F3/F4 sensor codes are the most frequent failure on this gas range. Replace the oven temperature sensor (RTD) after confirming it tests open or shorted."
pubDatetime: 2026-06-01T17:18:17Z
modDatetime: 2026-06-01T17:18:17Z
author: "Marcus Webb"
featured: false
draft: false
tags:
...
| Part | Notes |
|------|-------|
| Oven temperature sensor (RTD) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-whirlpool-wfg505m0bs-oven-problems&k=Oven+temperature+sensor+%28RTD%29&tag=errorcodefixes-20) \| Most common failure, triggers F3 (open) or F4 (shorted) codes. |
| Electronic control board (EOC) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-whirlpool-wfg505m0bs-oven-problems&k=Electronic+control+board+%28EOC%29&tag=errorcodefixes-20) \| Fails when codes return immediately after reset or when sensor/keypad circuits test good. |
| Keypad / user interface assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-whirlpool-wfg505m0bs-oven-problems&k=Keypad+%2F+user+interface+assembly&tag=errorcodefixes-20) \| Causes F2/E0-family faults if the ribbon cable or cancel-key circuit is damaged. |
| Door lock assembly (if equipped) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-whirlpool-wfg505m0bs-oven-problems&k=Door+lock+assembly+%28if+equipped%29&tag=errorcodefixes-20) \| Switch or latch defects can produce F5-family errors on self-clean models. |
