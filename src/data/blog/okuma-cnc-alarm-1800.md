...
| Part | Notes |
|------|-------|
| ATC arm proximity switch | Replace if failed or misaligned |
| Spindle air cylinder / draw bar spring | Replace if tool won't release cleanly |
| ATC cam follower | Replace if worn and causing incomplete arm motion |
