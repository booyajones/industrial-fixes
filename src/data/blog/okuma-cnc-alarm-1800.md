...
| Part | Notes |
|------|-------|
| ATC arm proximity switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-okuma-cnc-alarm-1800&k=ATC+arm+proximity+switch&tag=errorcodefixes-20) \| Replace if failed or misaligned |
| Spindle air cylinder / draw bar spring | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-okuma-cnc-alarm-1800&k=Spindle+air+cylinder+%2F+draw+bar+spring&tag=errorcodefixes-20) \| Replace if tool won't release cleanly |
| ATC cam follower | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-okuma-cnc-alarm-1800&k=ATC+cam+follower&tag=errorcodefixes-20) \| Replace if worn and causing incomplete arm motion |
## When to Call a Pro
