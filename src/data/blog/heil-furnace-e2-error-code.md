...
| Part | Notes |
|------|-------|
| Pressure switch | Use the OEM water column rating; aftermarket switches must match exactly |
| Pressure switch hose | Replace if cracked or if condensate was present |
