---
title: "GE Dishwasher F56 Error Code - Causes & Fix"
description: "F56 means the dishwasher did not drain. Check the drain hose for kinks, the air gap for clogs, and the disposer knockout plug first."
pubDatetime: 2026-06-08T06:21:45Z
modDatetime: 2026-06-08T06:21:45Z
...
1. **Cancel the cycle and power off** the dishwasher at the breaker or by unplugging it. If water remains in the tub, bail or sponge it out for safety.
2. **Inspect the drain hose** from the dishwasher to the sink or disposer connection. Look for kinks, crushing, or low spots that trap water. Disconnect the hose at the sink end and flush it with a garden hose outdoors or into a bucket to confirm it is clear.
3. **Check the air gap** if your installation has one. Remove the chrome cap on the sink deck, lift out the plastic diverter, and rinse both under running water to clear food debris or grease buildup.
4. **Verify the garbage disposer knockout plug** was removed if a disposer is installed. Shine a light into the disposer drain inlet from underneath the sink. If you see a plastic disc blocking the opening, remove the disposer drain elbow and knock out the plug with a screwdriver and hammer.
5. **Clean the sump and filter area** inside the dishwasher. Remove the lower spray arm and lift out the filter assembly. Rinse the filters under hot water and inspect the sump well for any glass, bones, or other debris that could block the drain path.
6. **Access the drain pump** by removing the lower front access panel (and possibly the toe kick). Disconnect power, then disconnect the hoses and wiring from the pump. Inspect the pump inlet and impeller for obstructions. If the pump is jammed, clear it. If the motor windings test open or shorted, replace the pump.
7. **Inspect the pressure sensor** if the dishwasher drains fully but still shows F56. Locate the pressure switch or sensor (usually mounted on the side of the tub or near the sump). Disconnect the small sensing tube and blow through it to confirm it is not clogged with scale or grease. Clean or replace the sensor if the port is blocked or the sensor tests faulty.

## Parts Often Needed

| Part | Notes |
|------|-------|
| Drain hose | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-dishwasher-f56-error-code&k=Drain+hose&tag=errorcodefixes-20) \| Typically 5/8-inch or 3/4-inch ribbed hose; measure the old hose length and diameter before ordering. |
| Drain pump assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-dishwasher-f56-error-code&k=Drain+pump+assembly&tag=errorcodefixes-20) \| Match your model number; GE uses several pump styles depending on the series. |
| Pressure sensor or water-level switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-dishwasher-f56-error-code&k=Pressure+sensor+or+water-level+switch&tag=errorcodefixes-20) \| Verify part number from the dishwasher's tech sheet or label; sensors vary by control generation. |
| Air gap cap and diverter | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-dishwasher-f56-error-code&k=Air+gap+cap+and+diverter&tag=errorcodefixes-20) \| Standard chrome or stainless cap with internal plastic diverter; generic sizes fit most sinks. |
