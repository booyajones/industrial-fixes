...
| Part | Notes |
|------|-------|
| Motor output cable | [Amazon](https://www.amazon.com/s?k=Motor+output+cable&tag=errorcodefixes-20) \| Replace if damaged or megohm test reveals insulation failure |
| Drive (ATV212) | [Amazon](https://www.amazon.com/s?k=Drive+%28ATV212%29&tag=errorcodefixes-20) \| Required if IGBT failure is confirmed |
## When to Call a Pro
