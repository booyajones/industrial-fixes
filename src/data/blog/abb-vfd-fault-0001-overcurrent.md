...
| Part | Notes |
|------|-------|
| IGBT power module | If the drive was damaged by a severe short; requires drive specialist |
| Motor (replacement) | If winding insulation tests below 1 MΩ |
| Motor cable (shielded VFD-rated) | Replace if any conductor shows insulation damage |
