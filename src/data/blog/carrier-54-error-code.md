...
| Part | Notes |
|------|-------|
| Condensate trap | [Amazon](https://www.amazon.com/s?k=Condensate+trap&tag=errorcodefixes-20) \| Brand-specific; check model label for Carrier part number |
| Pressure switch | [Amazon](https://www.amazon.com/s?k=Pressure+switch&tag=errorcodefixes-20) \| 0.60" or 0.80" WC setpoint depending on model |
| Pressure switch hose | [Amazon](https://www.amazon.com/s?k=Pressure+switch+hose&tag=errorcodefixes-20) \| 3/8" ID rubber vacuum hose, ~6–12" length |
| Inducer motor assembly | [Amazon](https://www.amazon.com/s?k=Inducer+motor+assembly&tag=errorcodefixes-20) \| LH680016 or similar — match by model number |
## When to Call a Pro
