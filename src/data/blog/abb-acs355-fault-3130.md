...
| Part | Notes |
|------|-------|
| Input fuses | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-abb-acs355-fault-3130&k=Input+fuses&tag=errorcodefixes-20) \| Match voltage and amp rating; ABB specifies fuse type in the ACS355 hardware manual |
| Upstream contactor | [Amazon](https://www.amazon.com/dp/B0CJFZQVPT?ascsubtag=ecf-abb-acs355-fault-3130&tag=errorcodefixes-20) \| Replace if one contact shows high resistance |
| ACS355 rectifier bridge | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-abb-acs355-fault-3130&k=ACS355+rectifier+bridge&tag=errorcodefixes-20) \| Only if input fuse and terminal checks are clean but 3130 persists — rare |
## When to Call a Pro
