...
| Part | Notes |
|------|-------|
| Door contacts (UCM rated) | Replace when worn |
| Brake coil / armature | Replace on brake fault |
| Motor encoder | Replace on encoder fault |
| Drive module (Otis regen) | Replace on persistent drive fault |
| LiNX controller board | Replace on controller fault |
