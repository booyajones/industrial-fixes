---
title: "Weil-McLain A82 Error Code - Causes & Fix"
description: "A82 is not a standard Weil-McLain code. Check your exact model manual for the fault definition. Most ignition lockouts trace to gas, flame sensor, or vent issues."
pubDatetime: 2026-06-15T11:39:30Z
modDatetime: 2026-06-15T11:39:30Z
...
diy_or_pro: "pro"
free_checks:
  - "Confirm the manual gas shutoff is fully open and gas is flowing to other appliances."
  - "Check the boiler nameplate and control label for the exact model number and look up the fault code in that model's installation or service manual."
...
- **Dirty or failed flame sensor (~30%)** Carbon or soot on the flame-sensing rod prevents the control from proving flame even when the burner lights.
- **No gas supply or closed manual shutoff (~25%)** The boiler cannot ignite if the gas valve upstream is closed, the meter is off, or incoming pressure is too low.
- **Failed or fouled ignitor (~20%)** A cracked, corroded, or out-of-spec ignitor will not produce a strong enough spark or glow to light the gas.
- **Blocked venting or combustion air (~15%)** Ice, condensate freeze-up, bird nests, or disconnected piping starve the burner of air or block exhaust, triggering a safety lockout.
- **Condensate trap or drain blockage (~10%)** On condensing boilers a plugged trap or frozen drain line raises pressure in the heat exchanger and trips a safety switch.

## Quick Diagnosis

Answer these to narrow it down fast.

<details class="dtree"><summary>Does the display show a different code or number when you power-cycle the boiler?</summary>
<div class="dtree-body"><strong>Yes:</strong> The code may have been misread or the control has multiple faults stored. Write down the exact sequence and consult your model manual.<br><strong>No:</strong> The fault is persistent. Proceed to verify gas supply and check the flame sensor and ignitor.</div>
</details>

<details class="dtree"><summary>Can you hear the gas valve click and the ignitor spark or glow when the boiler tries to fire?</summary>
<div class="dtree-body"><strong>Yes:</strong> Gas and ignition are present. The flame sensor or flame-proving circuit is the most likely problem.<br><strong>No:</strong> No ignition attempt means the control is not commanding the gas valve. Check incoming power, control fuses, and safety-circuit interlocks.</div>
</details>

<details class="dtree"><summary>Is there visible ice, water, or debris at the outdoor vent termination?</summary>
<div class="dtree-body"><strong>Yes:</strong> Clear the blockage, check the condensate drain path, and reset the boiler once airflow is restored.<br><strong>No:</strong> The vent system is clear. Focus on gas supply, flame sensor, and ignitor condition inside the boiler.</div>
</details>
...
| Part | Notes |
|------|-------|
| Flame sensor rod | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-weil-mclain-boiler-a82-error-code&k=Flame+sensor+rod&tag=errorcodefixes-20) \| Model-specific; verify the part number in your boiler's service manual or on the existing sensor. |
| Hot-surface ignitor or spark electrode | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-weil-mclain-boiler-a82-error-code&k=Hot-surface+ignitor+or+spark+electrode&tag=errorcodefixes-20) \| Match the exact ignitor type and voltage rating to your boiler model. |
