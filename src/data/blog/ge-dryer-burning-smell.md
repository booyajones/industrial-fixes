---
title: "GE Dryer Burning Smell - Causes & Fix"
description: "Usually caused by lint buildup near the heater or in the vent system. Clean the lint path, vent, and heater housing first."
pubDatetime: 2026-06-09T13:07:13Z
modDatetime: 2026-06-09T13:07:13Z
...
1. Unplug the dryer immediately and remove any laundry inside. Do not run the dryer again if you see smoke, scorch marks, or visible damage.
2. Remove and clean the lint screen, then inspect and clean the lint chute, blower housing, and entire exhaust vent path from the dryer to the outside vent cap for blockages, kinks, or heavy lint buildup.
3. Open the dryer cabinet and visually inspect the drum area, heater housing, blower housing, motor, and wiring for lint accumulation, scorch marks, melted plastic, or blackened connectors.
4. Check the drive belt for cracks, glazing, fraying, melting, or misalignment. Spin the drum by hand to feel for drag or resistance from the idler pulley or drum rollers.
5. Locate and test the thermostat, thermal fuse, thermal cut-out, or thermistor (depending on your model) with a multimeter for continuity or correct resistance. Replace any component that is open or out of range.
6. Inspect the heating element for breaks, sagging coils, or contact with the housing. Check the element terminals and wiring harness for discoloration, melting, or signs of arcing.
7. If the smell is electrical or metallic and airflow and belt are normal, inspect the motor for overheating, binding, or burnt windings. Test the motor windings for continuity and check that the drum spins freely.
8. Reassemble the dryer, restore power, and run a short supervised test cycle with no load. Confirm normal airflow, normal heat, no odor, and no unusual sounds or overheating.

## Parts You Might Need

| Part | Notes |
|------|-------|
| GE dryer drive belt | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-dryer-burning-smell&k=GE+dryer+drive+belt&tag=errorcodefixes-20) \| Model-specific. Replace if cracked, glazed, frayed, or melted. |
| GE dryer heating element | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-dryer-burning-smell&k=GE+dryer+heating+element&tag=errorcodefixes-20) \| Model-specific. Replace if broken, sagging, or shorted to housing. |
| GE dryer thermal fuse or thermal cut-out | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-dryer-burning-smell&k=GE+dryer+thermal+fuse+or+thermal+cut-out&tag=errorcodefixes-20) \| One-time use. Replace if open. Check airflow and thermostat before replacing to prevent repeat failure. |
| GE dryer blower motor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-dryer-burning-smell&k=GE+dryer+blower+motor&tag=errorcodefixes-20) \| Model-specific. Replace if windings are burnt, bearings are seized, or motor will not start. |

## Related Error Codes

If your appliance also shows a code on the display, these match this problem:

- [Ge Dryer E02 error code](/posts/ge-dryer-e02-error-code/)
- [Ge Dryer E03 error code](/posts/ge-dryer-e03-error-code/)
