...
| Part | Notes |
|------|-------|
| Yaskawa control board (PCB) | Order by drive model and frame size; match control software version |
| Line reactor (3%) | Add upstream of drive to reduce voltage spikes from power line |
| Surge suppressor | Install on control wiring if noise is suspected cause |
