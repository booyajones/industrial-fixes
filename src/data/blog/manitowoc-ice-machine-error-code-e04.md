...
| Part | Notes |
|------|-------|
| Condenser fan motor | Replace when motor doesn't run or runs slowly; verify replacement is correct CFM rating |
| Run capacitor (condenser fan) | Test before replacing motor; often the capacitor fails, not the motor |
| Condenser coil cleaner (Nu-Calgon) | Use for routine cleaning every 3–6 months in commercial kitchens |
