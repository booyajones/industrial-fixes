---
title: "AMSCO (STERIS) Sterilizer Fault Codes - Complete Guide"
...
| Part | Notes |
|------|-------|
| Door gasket | Replace on sealing faults |
| RTD temperature sensor | Replace on temp faults |
| Pressure transducer | Replace on chamber pressure faults |
| Steam trap | Replace on drain temp issues |
| Door interlock switch | Replace on latch confirmation faults |
