...
tags:
  ...
  - pressure-switch
description: "Hoshizaki ice machine E7 error means the high-side pressure switch has tripped. Learn what causes high head pressure, how to diagnose, and when refrigerant work is needed."
---
...
- **Dirty condenser coil (air-cooled units)** — A clogged condenser is the #1 cause of E7. Grease, lint, dust, and debris block airflow, causing head pressure to climb until the high-pressure switch trips.
- **Inadequate ventilation** — Insufficient clearance around the machine, or a hot ambient environment (above 100°F), causes the condenser to struggle to reject heat.
- **Failed condenser fan motor** — On air-cooled machines, if the condenser fan motor slows or stops, heat builds in the condenser and head pressure rises rapidly.
- **Refrigerant overcharge** — Too much refrigerant in the system elevates high-side pressure abnormally. This is an installation or service error.
- **Non-condensable gases in the refrigerant circuit** — Air or nitrogen trapped in the refrigerant system raises high-side pressure.
- **Failed or stuck hot gas bypass valve** — If the hot gas bypass valve sticks open, it recirculates high-pressure discharge gas, driving head pressure up.
...
- **Dirty condenser:** Clean thoroughly. This alone resolves the majority of E7 faults on machines over 12 months old.
- **Fan motor failure:** Replace the condenser fan motor with an OEM part matched to your Hoshizaki model number.
- **Failed high-pressure switch:** Replace with the correct OEM switch. The refrigerant system will need to be isolated if the switch is in a wet part of the circuit (requires technician).
- **Refrigerant overcharge or non-condensables:** A technician must recover refrigerant, evacuate, and recharge to the nameplate specification.
- **Stuck hot gas bypass valve:** Replace the valve (technician required — refrigerant recovery needed).
