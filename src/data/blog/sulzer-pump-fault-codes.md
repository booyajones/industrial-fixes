...
| Part | Notes |
|------|-------|
| Mechanical seal kit | Match pump model and size |
| Moisture sensor cable | Sulzer-specific — match pump series |
| Impeller | Replace if worn or damaged |
| Bearing kit | Match pump bearing specification |
| Thermistor | Match motor winding type |
