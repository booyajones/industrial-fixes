...
| Part | Notes |
|------|-------|
| Flame sensor | Match York OEM; universal versions also work |
| Sandpaper (400-grit) or steel wool | For sensor cleaning |
| Gas valve | Replace only after confirming correct voltage at valve terminals with no output |
