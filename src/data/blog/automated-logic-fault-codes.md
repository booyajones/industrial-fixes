...
| Part | Notes |
|------|-------|
| MCB/LGR controller | Replace on hardware fault |
| VMA VAV controller | Replace on hardware fault |
| Zone sensor (ZS) | Replace on sensor fault |
| Damper actuator | Replace on valve/damper fault |
| WebCTRL server hardware | Replace on server fault |
