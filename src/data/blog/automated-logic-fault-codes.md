...
| Part | Notes |
|------|-------|
| MCB/LGR controller | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-automated-logic-fault-codes&k=MCB%2FLGR+controller&tag=errorcodefixes-20) \| Replace on hardware fault |
| VMA VAV controller | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-automated-logic-fault-codes&k=VMA+VAV+controller&tag=errorcodefixes-20) \| Replace on hardware fault |
| Zone sensor (ZS) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-automated-logic-fault-codes&k=Zone+sensor+%28ZS%29&tag=errorcodefixes-20) \| Replace on sensor fault |
| Damper actuator | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-automated-logic-fault-codes&k=Damper+actuator&tag=errorcodefixes-20) \| Replace on valve/damper fault |
| WebCTRL server hardware | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-automated-logic-fault-codes&k=WebCTRL+server+hardware&tag=errorcodefixes-20) \| Replace on server fault |
## When to Call a Pro
