---
title: "GE Washer Shaking and Loud - Causes & Fix"
description: "An unbalanced load or washer not level is the most common cause. Redistribute clothes evenly and check all four legs are locked and level."
pubDatetime: 2026-06-01T15:05:18Z
modDatetime: 2026-06-01T15:05:18Z
author: "Marcus Webb"
featured: false
draft: false
tags:
...
1. Run a no-load spin or rinse cycle to separate load imbalance from a machine failure.
2. Redistribute the load evenly if the shaking only happens with clothes, and avoid mixing one heavy item with light fabrics.
3. Check that all four leveling legs are locked, the washer is level side-to-side and front-to-back, and the floor is solid and stable.
4. On front-load models, confirm all shipping bolts and transit braces were removed from the rear panel at installation.
5. Inspect the drain pump filter and drain hose for clogs or kinks if the shaking is worst during drain and spin.
6. On top-load washers, check the suspension rods for sagging or loss of tension and inspect the inner wash basket for wobble by hand with the power off.
7. Look for a loose hub nut or basket drive hardware by rocking the inner basket and listening for play or clunking.
8. If the control has a stored flash code, retrieve it using the service mode for your model platform and cross-reference the code (for example, 2 flashes for belt slipping, 5 flashes for motor problem) to isolate the failing component.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Suspension rod kit (top-load GE washer) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-washer-shaking-and-loud&k=Suspension+rod+kit+%28top-load+GE+washer%29&tag=errorcodefixes-20) \| Set of damping rods that support and stabilize the wash basket during spin. |
| Drain pump (GE washer) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-washer-shaking-and-loud&k=Drain+pump+%28GE+washer%29&tag=errorcodefixes-20) \| Replaces a clogged or failed pump that causes vibration or slow draining. |
| Speed sensor (GE top-load washer) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-washer-shaking-and-loud&k=Speed+sensor+%28GE+top-load+washer%29&tag=errorcodefixes-20) \| Provides spin-speed feedback to the control for electronic balance adjustment. |
