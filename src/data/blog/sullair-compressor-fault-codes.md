...
| Part | Notes |
|------|-------|
| Air/oil separator element | Replace every 2,000–4,000 hours |
| Oil filter | Replace with separator service |
| Discharge temperature sensor | Common on high-hour units |
| Inlet valve kit | Common cause of motor overloads |
| Minimum pressure valve | Fails open causing high sump pressure |
