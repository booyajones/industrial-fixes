...
| Part | Notes |
|------|-------|
| SINAMICS encoder cable | Replace on F07805 encoder faults |
| Hydraulic filter | Replace on lubrication/hydraulic alarms |
| Tool changer cam followers | Inspect on ATC faults |
| Lubrication pump | Replace on lubrication alarms |
