---
title: "Frigidaire Dishwasher Error Code i30 — Water in Base Fix"
description: "Frigidaire dishwasher error i30 (also displayed as \"30\" or \"iE30\" on some models) means the anti-flood float switch at the bottom of the base pan has..."
pubDatetime: 2026-05-21T17:00:00Z
modDatetime: 2026-05-21T17:00:00Z
author: "Industrial Error Code Fixes"
slug: frigidaire-dishwasher-error-code-i30
featured: false
draft: false
tags:
  - frigidaire
...
- You can't locate the leak source after a full inspection. The leak may be at the sump pump housing or a hidden hose connection — requires partial disassembly.
- You see rust on the base pan or signs of long-term water damage to the floor. Floor damage requires professional remediation before reinstall.
- The dishwasher is making a grinding noise during pump operation — pump impeller may be failing and approaching catastrophic leak.
- The unit is under Frigidaire / Electrolux warranty (1 year parts standard).

## FAQs

**My base pan is dry but i30 still shows. Why?**
The float switch is stuck up or has corroded contacts. Remove the float, test the switch, and replace if it doesn't return to open with no water present.

**Can I disconnect the float switch to clear i30?**
No. The float switch is in the UL-required safety chain. Disconnecting it leaves the dishwasher without anti-flood protection — illegal in most jurisdictions and a flood risk.

**My dishwasher is 4 years old and showing i30. Common at that age?**
The 4-6 year mark is when detergent dispenser hinges typically start cracking on Frigidaire units. Check the dispenser first.

**Will using powder detergent instead of liquid prevent dispenser leaks?**
Marginally — powder is less likely to leak through small cracks. But the cracks themselves are a structural failure that gets worse over time; eventually even powder leaks. Replace the dispenser when it cracks.

**Difference between i30 and 5C error?**
i30 = water in base pan (flood detection). 5C = sensor or board communication fault. Different paths.
