...
| Part | Notes |
|------|-------|
| Low-stage pressure switch | Match to exact model; Rheem/Ruud switches are model-specific |
| Pressure switch hose | Available at HVAC supply houses; measure ID/OD before ordering |
| Inducer motor assembly | Replace if motor is seized, humming, or capacitor has failed |
| Condensate drain trap | Clean or replace if blocked, which causes pressure switch issues |
