...
| Part | Notes |
|------|-------|
| Low-pressure switch | Replace if switch tests open at normal operating pressure |
| Refrigerant charge (R-404A, R-448A per model) | Add only after finding and fixing the leak; EPA 608 certification required |
| Evaporator descaler (Hoshizaki Scale-Away) | Use if evaporator is heavily scaled, contributing to poor freeze performance |
