---
title: "Lincoln Impinger Conveyor Oven Fault Codes — Complete Guide"
...
1. Gas supply pressure at the manifold (typically 4–7 inches WC for natural gas)
2. Igniter condition — visually inspect, listen for spark during ignition attempt
3. Flame sensor (thermocouple or ionization rod) — check continuity
4. Gas valve operation — verify coil resistance (typically 600–1000 ohms on main valve)
...
| Part | Notes |
|------|-------|
| Type K thermocouple | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-lincoln-foodservice-oven-fault&k=Lincoln+Type+K+thermocouple&tag=errorcodefixes-20) \| Common wear item |
