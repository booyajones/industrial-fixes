...
| Part | Notes |
|---|---|
| Hot surface igniter | Silicon nitride; handle carefully, avoid touching ceramic |
| Flame sensor | Clean first; replace if cracked or reading <0.5 µA |
| ECM blower motor | Verify correct motor model; programmed to unit |
| Inducer motor | Match frame size and speed rating |
| High-limit switch | L170°F or L200°F depending on unit config |
| Pressure switch | Check tubing for blockage before replacing |
