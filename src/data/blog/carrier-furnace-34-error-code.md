---
title: "Carrier Error Code 34 - Ignition Proving Failure Fix"
description: "Code 34 means the Carrier furnace tried to light but the board didn't sense flame. Clean or replace the flame sensor first."
pubDatetime: 2026-05-30T23:47:40Z
modDatetime: 2026-05-30T23:47:40Z
...
| Part | Notes |
|------|-------|
| Carrier flame sensor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-carrier-furnace-34-error-code&k=Carrier+flame+sensor&tag=errorcodefixes-20) \| Match the mounting bracket and lead length to your model. |
| Hot-surface ignitor (HSI) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-carrier-furnace-34-error-code&k=Hot-surface+ignitor+%28HSI%29&tag=errorcodefixes-20) \| Verify voltage rating and ceramic bracket style before ordering. |
| Gas valve assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-carrier-furnace-34-error-code&k=Gas+valve+assembly&tag=errorcodefixes-20) \| Required if the valve does not open with correct control voltage. |
| Furnace control board | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-carrier-furnace-34-error-code&k=Furnace+control+board&tag=errorcodefixes-20) \| Use the exact Carrier part number from your rating plate if all field components test good. |
