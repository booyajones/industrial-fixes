...
| Part | Notes |
|------|-------|
| DRIVE-CLiQ cable | Replace if damaged or intermittent |
| Motor encoder cable | Replace if signal loss is confirmed |
| S120 Motor Module | Replace if drive module has failed internally |
