---
title: "A.O. Smith Water Heater Thermocouple Replacement - Signs & How-To"
description: "Pilot won't stay lit, or it lights briefly then shuts off. Replace the thermocouple (pilot flame sensor) to restore gas flow and heating."
pubDatetime: 2026-06-01T21:32:44Z
modDatetime: 2026-06-01T21:32:44Z
...
- **Pilot lights but will not stay lit when you release the control knob** The thermocouple is not generating a valid signal to hold the gas valve open, so the valve closes as soon as you stop manually holding it.
- **Pilot lights briefly then shuts off within seconds or minutes** The thermocouple signal is weak or intermittent, so the gas control does not receive continuous flame proof.
- **Pilot flame is present but main burner will not fire** The gas control is not receiving a stable thermocouple signal and refuses to open the main gas valve for safety.
- **Thermocouple tip is not positioned in the pilot flame or is bent away** The sensor cannot heat properly and generate the holding signal if it is misaligned or not seated in the mounting bracket.
- **Visible damage, kinks, or corrosion on the thermocouple wire or tip** Physical damage interrupts the sensor's ability to generate or transmit the flame-proving signal to the gas valve.
- **Pilot relights normally after the thermocouple is cleaned or repositioned but still fails within hours** The thermocouple junction is failing internally and cannot maintain a stable output even when properly aligned.
...
| Part | Notes |
|------|-------|
| Thermocouple (pilot flame sensor) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-a-o-smith-water-heater-thermocouple-gas-pilot-sensor-replacement&k=Thermocouple+%28pilot+flame+sensor%29&tag=errorcodefixes-20) \| Available in 24-inch and 36-inch versions depending on model. Use your water heater model and serial number (on the data plate) to find the correct OEM replacement part from A.O. Smith's parts page or an authorized supplier. |
