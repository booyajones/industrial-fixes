---
title: "LG Dryer Loud Banging - Causes & Fix"
description: "Loud banging in an LG dryer is usually caused by worn drum rollers. Replace the rollers, idler pulley, and belt to restore quiet operation."
pubDatetime: 2026-06-09T13:02:36Z
modDatetime: 2026-06-09T13:02:36Z
...
1. Run the dryer empty and then with a normal load to determine if the noise is load-related or caused by the machine itself.
2. Disconnect power, open the dryer door, and inspect the drum interior for loose objects, coins, buttons, and damaged or loose baffles.
3. Confirm with the customer that loads are not overloaded and do not mix very heavy items with light garments in the same cycle.
4. Remove the cabinet panels and drum access components according to your model's service procedure to expose the drum support assembly.
5. Inspect the drum rollers, idler pulley, and drive belt for wear, flat spots, cracks, glazing, binding, or misalignment.
6. Spin each roller and the idler pulley by hand to check for roughness, wobble, or seizure instead of smooth free rotation.
7. Check the blower housing and surrounding area for foreign objects, cracked parts, or loose hardware that can rattle during operation.
8. Reassemble the dryer, verify the drum spins freely by hand and the belt tracks properly, then test through a full cycle to confirm quiet operation.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Drum roller kit | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lg-dryer-loud-banging&k=Drum+roller+kit&tag=errorcodefixes-20) \| Most common repair for loud LG dryer noise. Replace all rollers at once. |
| Idler pulley | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lg-dryer-loud-banging&k=Idler+pulley&tag=errorcodefixes-20) \| Replace if bearing is rough or seized. |
| Drive belt | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lg-dryer-loud-banging&k=Drive+belt&tag=errorcodefixes-20) \| Replace if worn, glazed, cracked, or when replacing rollers and pulley. |
