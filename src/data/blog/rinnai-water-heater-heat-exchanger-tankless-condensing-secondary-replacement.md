---
title: "Rinnai Tankless Heat Exchanger Replacement - Signs & How-To"
description: "Overheating codes, scale buildup, inconsistent hot water, and persistent error 14 mean your Rinnai heat exchanger is blocked or failing. Replacing it restores performance."
pubDatetime: 2026-06-01T21:40:05Z
modDatetime: 2026-06-01T21:40:05Z
...
1. Turn off electrical power at the breaker and shut off the gas supply valve and the cold-water inlet valve to the heater.
2. Relieve system pressure by opening a hot-water tap downstream and let any residual water drain from the unit.
3. Disconnect the water inlet and outlet unions or compression fittings using two wrenches to avoid twisting the exchanger piping.
4. Unplug the temperature sensor wiring harness from the heat exchanger and from the control board, noting connector positions for reassembly.
5. Remove the mounting screws or brackets securing the heat exchanger assembly to the chassis, then carefully lift the exchanger out of the cabinet.
6. Position the new heat exchanger in the same orientation and secure it with the original mounting hardware, torquing fasteners evenly to prevent leaks.
7. Reconnect the temperature sensor harness to the new exchanger and to the board, making sure each connector clicks fully into place.
8. Reattach the water inlet and outlet lines, tightening unions finger-tight plus one quarter turn with a wrench, and install new gaskets or O-rings if supplied.
9. Open the cold-water inlet valve slowly and inspect all joints for leaks, then open the gas valve, restore power, and run a full cycle to verify hot water delivery and confirm no error codes appear.

## The Part You Need

| Part | Notes |
|------|-------|
| Rinnai heat exchanger assembly (primary or secondary) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rinnai-water-heater-heat-exchanger-tankless-condensing-secondary-replacement&k=Rinnai+heat+exchanger+assembly+%28primary+or+secondary%29&tag=errorcodefixes-20) \| Match your model and serial number from the rating plate inside the front cover. Condensing units have separate primary and secondary exchangers, so verify which one the fault code indicates. |
| Heat exchanger temperature sensor / thermistor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rinnai-water-heater-heat-exchanger-tankless-condensing-secondary-replacement&k=Heat+exchanger+temperature+sensor+%2F+thermistor&tag=errorcodefixes-20) \| Often sold separately or included with the exchanger kit. Cross-reference the model number on your unit's data plate to order the correct sensor. |
| Water connection gaskets or O-rings | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rinnai-water-heater-heat-exchanger-tankless-condensing-secondary-replacement&k=Water+connection+gaskets+or+O-rings&tag=errorcodefixes-20) \| Rinnai recommends replacing seals any time you break a water joint. Part numbers are listed in the installation manual for your specific model. |
