...
| Part | Notes |
|------|-------|
| ATC door air cylinder | [Amazon](https://www.amazon.com/s?k=ATC+door+air+cylinder&tag=errorcodefixes-20) \| Common wear item |
| Door open/close switch | [Amazon](https://www.amazon.com/s?k=Door+open%2Fclose+switch&tag=errorcodefixes-20) \| Adjust before replacing |
| Solenoid valve | [Amazon](https://www.amazon.com/s?k=Solenoid+valve&tag=errorcodefixes-20) \| Match Haas air manifold spec |
