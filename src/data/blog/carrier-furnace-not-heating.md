---
title: "Carrier Furnace Not Heating - Causes & Fix"
description: "Most often caused by a thermostat not calling for heat or a clogged filter tripping the limit. Check mode, setpoint, and filter first."
pubDatetime: 2026-06-01T18:56:53Z
modDatetime: 2026-06-01T18:56:53Z
author: "Marcus Webb"
featured: false
draft: false
tags:
...
- **Airflow restriction** Dirty or clogged filter, closed or blocked supply or return vents, or related airflow issues overheat the exchanger and trip limit safeties.
- **Limit or rollout safety open** Carrier's guide associates Code 33 with a limit circuit fault and Code 13 or 33 with an open flame rollout switch, often caused by overheating or improper combustion air.
- **Pressure-switch or venting problems** Blocked venting, condensate or trap problems, weak inducer, or pressure-switch issues prevent ignition or keep the furnace locked out (Code 23 is pressure switch stuck closed).
- **Ignition failure** Failed ignitor, flame-proving issues, gas valve problems, or gas-supply issues are common when the furnace tries to start but does not light.
- **Control, fuse, or power problems** Carrier's manual references the 24-V fuse and control-board checks when the furnace is not operating as expected.
...
| Part | Notes |
|------|-------|
| Furnace air filter | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-carrier-furnace-not-heating&k=Furnace+air+filter&tag=errorcodefixes-20) \| Match the size stamped on the old filter frame. |
| Carrier 24-V fuse | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-carrier-furnace-not-heating&k=Carrier+24-V+fuse&tag=errorcodefixes-20) \| Check your model's manual for the correct amp rating. |
| Hot-surface ignitor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-carrier-furnace-not-heating&k=Hot-surface+ignitor&tag=errorcodefixes-20) \| Model-specific part; professional installation recommended for gas components. |
