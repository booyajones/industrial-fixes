...
| Part | Notes |
|------|-------|
| Indoor BLDC fan motor | Samsung model-specific; verify by model number |
| Indoor PCB | If fan driver confirmed failed |
| Evaporator fan cleaner (coil cleaner) | Prevents recurrence; clean annually |
