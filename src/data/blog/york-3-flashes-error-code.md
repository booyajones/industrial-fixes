...
| Part | Notes |
|------|-------|
| Pressure switch | Match the WC rating; York uses several different ratings across their lineup |
| Draft motor run capacitor | Cheap; often the real culprit when motor hums but doesn't spin |
| Pressure switch hose | 3/8" ID rubber tubing; cut to length |
| Condensate trap | Replace if cracked or permanently fouled |
