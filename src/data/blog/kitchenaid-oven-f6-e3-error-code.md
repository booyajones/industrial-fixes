...
description: "F6 E3 on a KitchenAid oven signals a control/communication fault. Power-cycle the oven first, then check wiring and controls."
pubDatetime: 2026-05-31T05:50:15Z
modDatetime: 2026-05-31T05:50:15Z
...
| Part | Notes |
|------|-------|
| Appliance Manager Control | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-kitchenaid-oven-f6-e3-error-code&k=Appliance+Manager+Control&tag=errorcodefixes-20) \| Main control board named by KitchenAid for F6 E3 faults. |
| Converter Control | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-kitchenaid-oven-f6-e3-error-code&k=Converter+Control&tag=errorcodefixes-20) \| Secondary control module that communicates with the manager board. |
| Control wiring harness | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-kitchenaid-oven-f6-e3-error-code&k=Control+wiring+harness&tag=errorcodefixes-20) \| Connector assembly or individual wires between the two control boards. |
