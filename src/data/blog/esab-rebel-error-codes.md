...
| Part | Notes |
|------|-------|
| MIG gun | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-esab-rebel-error-codes&k=MIG+gun&tag=errorcodefixes-20) \| For F02 if cable fault found |
| Drive rolls | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-esab-rebel-error-codes&k=Drive+rolls&tag=errorcodefixes-20) \| Replace if worn and slipping wire |
| Inlet guide / liner | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-esab-rebel-error-codes&k=Inlet+guide+%2F+liner&tag=errorcodefixes-20) \| Replace if wire bird-nests occur |
## When to Call a Pro
