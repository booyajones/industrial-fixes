---
title: "GE Washer Won't Drain - Causes & Fix"
description: "Most often a clogged pump filter or failed drain pump. Clean the filter first, then test the pump in service mode and replace if needed."
pubDatetime: 2026-06-01T15:03:26Z
modDatetime: 2026-06-01T15:03:26Z
...
1. Check the washer display or enter service mode to retrieve any stored fault codes and confirm the exact model before ordering parts.
2. Locate and clean the pump filter if your model has one (common on GE Profile Combo washers), removing lint, coins, and debris.
3. Inspect the drain hose from the back of the washer to the standpipe for kinks, clogs, or excessive insertion depth, and pull the hose back if it is pushed more than a few inches into the pipe.
4. Enter diagnostic or service mode and manually trigger the drain/pump test to confirm whether the pump runs and whether water evacuates.
5. If the pump does not run, disconnect power, pull the pump harness connector, and check for loose pins or corrosion, then reconnect and re-test.
6. Remove the drain pump (typically accessed from the front or bottom), inspect the impeller and housing for trapped objects, and test pump winding continuity with a multimeter (one GE pump measured approximately 19.4–19.5 ohms when good).
7. If continuity is open or the pump hums but does not spin, replace the drain pump assembly.
8. Reinstall all components, run a full drain test and a short wash cycle to verify water evacuates completely and no fault code returns.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Drain pump assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-washer-wont-drain&k=Drain+pump+assembly&tag=errorcodefixes-20) \| Most common replacement when pump fails electrical or mechanical test. |
| Pump filter (if equipped) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-washer-wont-drain&k=Pump+filter+%28if+equipped%29&tag=errorcodefixes-20) \| Factory or aftermarket filter for models with a removable cleanout. |
| Drain hose and clamps | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-washer-wont-drain&k=Drain+hose+and+clamps&tag=errorcodefixes-20) \| Replace if hose is split, permanently kinked, or clogged beyond cleaning. |
