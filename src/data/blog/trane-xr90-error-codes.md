...
| Part | Notes |
|---|---|
| Hot surface igniter | Norton 601, silicon carbide; fragile — don't touch the ceramic |
| Flame sensor | Rod-type; clean with steel wool before replacing |
| Inducer motor capacitor | 5 or 7.5 µF; measure before replacing motor |
| Pressure switch | Two switches on some XR90 versions (high and low) |
| High-limit switch | L200°F on most XR90 configurations |
| Blower capacitor | PSC blower motor; dedicated capacitor |
