...
| Part | Notes |
|------|-------|
| Drive cooling fan (internal) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-johnson-controls-vfd-fault&k=Drive+cooling+fan+%28internal%29&tag=errorcodefixes-20) \| Match voltage and airflow to original; JCI part number cross-references to Hitachi or other OEM |
| Input fuse set | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-johnson-controls-vfd-fault&k=Input+fuse+set&tag=errorcodefixes-20) \| Match voltage and amp rating from drive nameplate |
| Dynamic braking resistor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-johnson-controls-vfd-fault&k=Dynamic+braking+resistor&tag=errorcodefixes-20) \| For OV faults on high-inertia fans without adequate deceleration ramp |
| Replacement VFD | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-johnson-controls-vfd-fault&k=Replacement+VFD&tag=errorcodefixes-20) \| For output IGBT failure confirmed by no-load OC test |
## When to Call a Pro
