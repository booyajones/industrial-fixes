...
| Part | Notes |
|------|-------|
| Sinamics S120 motor module | Specific to axis current rating; part number from drive module label |
| Servo motor | Replace if winding insulation fails megohm test |
| Motor power cable (pre-assembled, shielded) | Siemens specifies cable type for Sinamics; use correct shield termination |
