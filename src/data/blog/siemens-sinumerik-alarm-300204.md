...
| Part | Notes |
|------|-------|
| Sinamics S120 motor module | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-siemens-sinumerik-alarm-300204&k=Sinamics+S120+motor+module&tag=errorcodefixes-20) \| Specific to axis current rating; part number from drive module label |
| Servo motor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-siemens-sinumerik-alarm-300204&k=Servo+motor&tag=errorcodefixes-20) \| Replace if winding insulation fails megohm test |
| Motor power cable (pre-assembled, shielded) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-siemens-sinumerik-alarm-300204&k=Motor+power+cable+%28pre-assembled%2C+shielded%29&tag=errorcodefixes-20) \| Siemens specifies cable type for Sinamics; use correct shield termination |
## When to Call a Pro
