...
1. Watch one complete defrost cycle. The outdoor fan should stop, steam should rise, the ice should clear, and the unit should return to heating within about 15 minutes.
2. Look at the outdoor coil after the cycle ends. A little moisture is fine. A heavy sheet of ice that remains on the entire coil is not.
3. Check the area around the outdoor unit. Remove leaves, snow drifts, trash bags, or stacked items that block airflow.
4. Replace the indoor air filter if it is dirty. Low indoor airflow can make the refrigerant circuit run at the wrong temperatures and increase icing problems.
5. Make sure water can drain away from the unit. If melted frost refreezes into a thick ice slab under the condenser, the fan blade or coil can get damaged.
6. If the unit seems stuck in defrost, shut it off at the thermostat for a few minutes, then restart it. If the same behavior returns, move to component checks.
7. Check your thermostat settings. Emergency Heat should only be used when the outdoor unit has failed or during service. Leaving it on will lock out the heat pump and make it look like defrost issues are happening when the unit is simply not allowed to run normally.
...
| [HVAC Air Filter Pleated 1 Inch](https://www.amazon.com/dp/B0CLBFXLYJ?ascsubtag=ecf-heat-pump-defrost-mode-explained&tag=errorcodefixes-20) | Restores indoor airflow and helps keep coil temperatures in the proper range | $15–$40 |
| [Heat Pump Condenser Pad Riser](https://www.amazon.com/s?ascsubtag=ecf-heat-pump-defrost-mode-explained&k=heat+pump+condenser+pad+riser&tag=errorcodefixes-20) | Helps lift the unit above standing water or refreezing ice in snowy climates | $40–$120 |
