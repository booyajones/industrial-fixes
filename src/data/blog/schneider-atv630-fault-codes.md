...
| Part | Notes |
|------|-------|
| Cooling fans | Internal drive fans — match voltage and size |
| Input fuses | Match voltage and ampere rating |
| Brake resistor | Match ohm rating and wattage |
| HMI panel | Match drive series |
| I/O extension cards | Match catalog number |
