...
| Part | Notes |
|------|-------|
| Semiconductor input fuses | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lenze-i550-fault-lf&k=Semiconductor+input+fuses&tag=errorcodefixes-20) \| Use Lenze-specified aR or gR fuse type; do not substitute standard HRC fuses |
| Input terminal block | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lenze-i550-fault-lf&k=Input+terminal+block&tag=errorcodefixes-20) \| Replace if arcing damage or severe corrosion is present |
## When to Call a Pro
