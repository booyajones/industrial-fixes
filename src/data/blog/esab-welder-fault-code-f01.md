...
| Part | Notes |
|------|-------|
| Cooling fan assembly | Match to ESAB model — fan specs vary across Rebel generations |
| Thermistor / thermal sensor | If F01 trips immediately even when cool |
| Compressed air / vent brush | For preventive cleaning every 3–6 months |
