...
| Part | Notes |
|------|-------|
| Backup battery | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-okuma-cnc-alarm-3000&k=Backup+battery&tag=errorcodefixes-20) \| Replace on schedule to avoid memory loss |
| Cabinet cooling fan / filter | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-okuma-cnc-alarm-3000&k=Cabinet+cooling+fan+%2F+filter&tag=errorcodefixes-20) \| Overheating damages control boards |
| CNC power supply module | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-okuma-cnc-alarm-3000&k=CNC+power+supply+module&tag=errorcodefixes-20) \| Check outputs before replacing CPU boards |
