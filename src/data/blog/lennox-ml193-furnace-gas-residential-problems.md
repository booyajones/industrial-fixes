---
title: "Lennox ML193 Furnace Problems & Error Codes"
description: "Most common ML193 failure is 3-flash ignition fault caused by dirty flame sensor. Clean sensor rod with fine abrasive pad to restore operation."
pubDatetime: 2026-06-01T17:25:41Z
modDatetime: 2026-06-01T17:25:41Z
...
| Part | Notes |
|------|-------|
| Flame sensor (ML193UHE control board circuit) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lennox-ml193-furnace-gas-residential-problems&k=Flame+sensor+%28ML193UHE+control+board+circuit%29&tag=errorcodefixes-20) \| Combustion residue buildup causes false low-signal readings and 3- or 4-flash codes. |
| Pressure switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lennox-ml193-furnace-gas-residential-problems&k=Pressure+switch&tag=errorcodefixes-20) \| Diaphragm failure or stuck contacts prevent closure and trigger 9-flash fault codes. |
| Integrated control board (ML193UHE) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lennox-ml193-furnace-gas-residential-problems&k=Integrated+control+board+%28ML193UHE%29&tag=errorcodefixes-20) \| Stores last 10 error codes in memory; board failure causes off or erratic code display. |
| Hot surface igniter | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lennox-ml193-furnace-gas-residential-problems&k=Hot+surface+igniter&tag=errorcodefixes-20) \| Cracked or failed igniter prevents gas ignition and produces 3-flash ignition fault. |
