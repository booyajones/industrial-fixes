---
title: "Bosch EA Error Code - Causes & Fix"
description: "EA means your Bosch tankless water heater fails to ignite. Most often it's a gas supply problem, low pressure, or air in the line."
pubDatetime: 2026-05-30T23:50:45Z
modDatetime: 2026-05-30T23:50:45Z
author: "Marcus Webb"
featured: false
draft: false
tags:
...
1. **Confirm water flow demand** by opening a hot-water tap and verifying that the heater display shows an active heat call before troubleshooting ignition components.
2. **Check all manual gas shutoff valves** upstream of the heater and confirm they are fully open, then verify the nameplate fuel type matches your supply (natural gas or propane).
3. **Measure gas supply pressure** with a manometer at the heater inlet during high fire to confirm it meets the minimum 5 inches water column for natural gas and does not exceed 14 inches maximum.
4. **Purge air from the gas line** by resetting the heater and running several hot-water draw cycles if the unit was recently installed or the gas supply was interrupted.
5. **Inspect the ignition electrodes and flame sensor** for corrosion, carbon buildup, cracks in the ceramic insulator, or loose yellow braided wires at the connector, and clean or replace as needed.
6. **Observe spark and flame** through the sight window during ignition; if you see spark but no flame, measure voltage across the gas valve leads with water flowing to confirm approximately 24 VDC.
7. **Inspect vent and air-intake pipes** for blockage, bird nests, ice, excessive length, or improper termination, and clear or correct any issues, then check that the condensate trap is not plugged and the burner area is dry.

## Parts Often Needed

| Part | Notes |
|------|-------|
| Ignition electrode and flame sensor assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-bosch-tankless-water-heater-ea-error-code&k=Ignition+electrode+and+flame+sensor+assembly&tag=errorcodefixes-20) \| Order the assembly specific to your Bosch tankless model; includes ceramic insulators and yellow braided electrode cables. |
| Gas valve | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-bosch-tankless-water-heater-ea-error-code&k=Gas+valve&tag=errorcodefixes-20) \| Replace if voltage is correct but the valve does not open or if combustion calibration cannot be restored after electrode and vent repairs. |
| Condensate trap kit | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-bosch-tankless-water-heater-ea-error-code&k=Condensate+trap+kit&tag=errorcodefixes-20) \| Necessary if the existing trap is cracked, plugged with debris, or missing the water seal that prevents combustion gases from recirculating. |
