...
|---------|---------|-------------|
| 51V — Voltage-Restrained OC | Overcurrent with voltage constraint | Fault during voltage sag |
| 40 — Loss of Excitation | Generator field loss | AVR failure or field winding open |
| 81O/U — Over/Underfrequency | Frequency out of range | Speed governor problem |
| 27 — Undervoltage | Voltage below setpoint | Generator or supply problem |
| 59 — Overvoltage | Voltage above setpoint | AVR or regulator fault |
| 32 — Reverse Power | Real power flowing backward | Engine failure or backfeed |
| 87G — Generator Differential | Internal generator fault | Winding fault |
| 46 — Neg Sequence | Phase unbalance | Unbalanced load or open phase |
