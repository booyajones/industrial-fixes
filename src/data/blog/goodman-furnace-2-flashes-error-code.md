---
title: "Goodman Furnace 2 Flashes - Causes & Fix"
description: "Goodman 2-flash code means pressure switch stuck closed. Usually a failed switch, shorted wiring, or draft problem. Fix guide inside."
pubDatetime: 2026-05-31T00:03:44Z
modDatetime: 2026-05-31T00:03:44Z
author: "Marcus Webb"
featured: false
draft: false
tags:
...
- **Failed or mechanically stuck pressure switch** The switch contacts remain closed even when draft pressure is wrong, often due to internal contact failure or mechanical jamming inside the switch body.
- **Shorted or miswired pressure-switch circuit** Damaged wiring, pinched harness insulation, corroded terminals, or incorrect connections create a continuous closed circuit the board reads as a stuck switch.
- **Cracked, pinched, or blocked pressure-switch tubing** The rubber or silicone hose that senses draft pressure has a crack, kink, or blockage that prevents the switch from sensing true furnace pressure and cycling correctly.
- **Inducer blower or venting problem** A failing inducer motor, blocked flue pipe, or restricted combustion-air intake can create abnormal draft that holds the pressure switch in the wrong state during startup.
- **Loose or corroded electrical connectors** Poor contact at the pressure-switch spade terminals or control-board connector can mimic a closed or shorted circuit and trigger the fault code.
...
| Part | Notes |
|------|-------|
| Goodman pressure switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-goodman-furnace-2-flashes-error-code&k=Goodman+pressure+switch&tag=errorcodefixes-20) \| Model-specific. Verify the pressure rating stamped on your original switch (in inches water column) and cross-reference your furnace model number before ordering. |
| Pressure switch tubing (rubber or silicone hose) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-goodman-furnace-2-flashes-error-code&k=Pressure+switch+tubing+%28rubber+or+silicone+hose%29&tag=errorcodefixes-20) \| Flexible draft-sensing hose, typically 1/4 inch or 5/16 inch inside diameter. Match the original length and fitting type. |
| Inducer draft blower motor assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-goodman-furnace-2-flashes-error-code&k=Inducer+draft+blower+motor+assembly&tag=errorcodefixes-20) \| Required if the inducer will not spin or creates insufficient draft. Confirm your furnace model and voltage before purchase. |
