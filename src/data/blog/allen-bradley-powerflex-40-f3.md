...
| Part | Notes |
|------|-------|
| Input fuses | Match class and amp rating to the installation |
| Line contactor | Replace if contacts are burned or voltage drop is excessive |
| Terminal block hardware | Replace damaged lugs or screws |
| PowerFlex 40 drive | If internal bus or rectifier section is failed |
