...
| Part | Notes |
|------|-------|
| [Input fuses](https://www.amazon.com/s?k=Input%20fuses&tag=errorcodefixe-20) | Match class and amp rating to the installation |
| [Line contactor](https://www.amazon.com/s?k=Line%20contactor&tag=errorcodefixe-20) | Replace if contacts are burned or voltage drop is excessive |
| [Terminal block hardware](https://www.amazon.com/s?k=Terminal%20block%20hardware&tag=errorcodefixe-20) | Replace damaged lugs or screws |
| [PowerFlex 40 drive](https://www.amazon.com/s?k=PowerFlex%2040%20drive&tag=errorcodefixe-20) | If internal bus or rectifier section is failed |
