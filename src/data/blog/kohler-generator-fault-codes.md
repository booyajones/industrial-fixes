...
| [Fail to Start](https://www.amazon.com/s?ascsubtag=ecf-kohler-generator-fault-codes&k=Fail+to+Start&tag=errorcodefixes-20) | Shutdown | Engine did not start after retries | Check fuel, battery, starter |
| [Low Oil Pressure](https://www.amazon.com/s?ascsubtag=ecf-kohler-generator-fault-codes&k=Low+Oil+Pressure&tag=errorcodefixes-20) | Shutdown | Oil pressure below limit | Check oil level and condition |
| [High Engine Temperature](https://www.amazon.com/s?ascsubtag=ecf-kohler-generator-fault-codes&k=High+Engine+Temperature&tag=errorcodefixes-20) | Shutdown | Coolant or oil over-temp | Check coolant, oil, fan |
| [Overspeed](https://www.amazon.com/s?ascsubtag=ecf-kohler-generator-fault-codes&k=Overspeed&tag=errorcodefixes-20) | Shutdown | Engine RPM too high | Governor fault |
| [Underspeed](https://www.amazon.com/s?ascsubtag=ecf-kohler-generator-fault-codes&k=Underspeed&tag=errorcodefixes-20) | Shutdown | Engine RPM too low | Load, governor, or fuel issue |
| [High AC Voltage](https://www.amazon.com/s?ascsubtag=ecf-kohler-generator-fault-codes&k=High+AC+Voltage&tag=errorcodefixes-20) | Shutdown | Generator output voltage high | AVR fault |
| [Low AC Voltage](https://www.amazon.com/s?ascsubtag=ecf-kohler-generator-fault-codes&k=Low+AC+Voltage&tag=errorcodefixes-20) | Shutdown | Generator output voltage low | AVR fault; high load |
| [Overcurrent](https://www.amazon.com/s?ascsubtag=ecf-kohler-generator-fault-codes&k=Overcurrent&tag=errorcodefixes-20) | Shutdown | Load exceeds generator capacity | Reduce load; check for fault |
| [Ground Fault](https://www.amazon.com/s?ascsubtag=ecf-kohler-generator-fault-codes&k=Ground+Fault&tag=errorcodefixes-20) | Shutdown | Ground fault in system | Inspect wiring; call electrician |
| [Exercise Overdue](https://www.amazon.com/s?ascsubtag=ecf-kohler-generator-fault-codes&k=Exercise+Overdue&tag=errorcodefixes-20) | Warning | Generator hasn't run exercise | Run manual exercise; check schedule |
| [Line Power Available](https://www.amazon.com/s?ascsubtag=ecf-kohler-generator-fault-codes&k=Line+Power+Available&tag=errorcodefixes-20) | Status | Utility power has returned | Normal status — transfer pending |
