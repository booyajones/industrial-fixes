...
| Part | Notes |
|------|-------|
| Flow switch (chilled or condenser side) | Trane OEM preferred; confirm differential pressure setpoint |
| Oil pump | For persistent oil pressure faults with correct oil level |
| Purge unit components | Purge compressor, desiccant, and purge valves — annual service item |
| Condenser tube brush set | For tube fouling cleaning |
