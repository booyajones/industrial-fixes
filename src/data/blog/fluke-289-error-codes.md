...
### OL — Overload
OL appears when the input voltage, current, or resistance exceeds the selected range. On voltage: maximum input is 1000 VDC / 1000 VAC. On current through A jacks: maximum is 10A (11A momentary). On the mA/µA jack: maximum is 440mA. If OL appears at low ranges, check that leads are in the correct jacks.
