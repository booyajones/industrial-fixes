...
| Part | Notes |
|------|-------|
| Thermocouple / RTD sensor | Most common fault source |
| SSR or contactor | Heater output device |
| Watlow controller | Replace after I/O is verified |
| Fuse or heater element | Common with Htr alarms |
