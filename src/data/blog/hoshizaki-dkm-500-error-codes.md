...
| Part | Notes |
|---|---|
| Water inlet valve | Solenoid coil or complete valve assembly |
| Float switch | Specific to DKM dispenser design |
| Dispenser motor | Check for ice jam before ordering |
| Evaporator thermistor | For E4; check resistance at room temperature |
| High-pressure switch | Manual-reset; check cutout pressure rating |
| Condenser fan motor | Match existing HP and blade size |
