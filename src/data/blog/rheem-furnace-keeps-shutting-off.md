---
title: "Rheem Furnace Keeps Shutting Off - Causes & Fix"
description: "Usually caused by a dirty flame sensor preventing the control from detecting flame. Clean the sensor rod with fine steel wool or emery cloth."
pubDatetime: 2026-06-11T11:40:38Z
modDatetime: 2026-06-11T11:40:38Z
...
| Part | Notes |
|------|-------|
| Rheem flame sensor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rheem-furnace-keeps-shutting-off&k=Rheem+flame+sensor&tag=errorcodefixes-20) \| Verify the sensor bracket and rod length match your model before ordering. |
| Rheem pressure switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rheem-furnace-keeps-shutting-off&k=Rheem+pressure+switch&tag=errorcodefixes-20) \| Match the switch closing pressure (in inches water column) stamped on the original switch. |
| Rheem integrated furnace control board | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rheem-furnace-keeps-shutting-off&k=Rheem+integrated+furnace+control+board&tag=errorcodefixes-20) \| Confirm the exact model and revision number; many Rheem boards are model-specific and not interchangeable. |
