---
title: "Samsung Dryer Squeaking - Causes & Fix"
description: "Samsung dryer squeaking usually means the load is too heavy. Stop the cycle, remove some items, and restart to stop the noise."
pubDatetime: 2026-06-01T15:12:11Z
modDatetime: 2026-06-01T15:12:11Z
...
1. Confirm the symptom is a noise complaint, not an electronic fault code displayed on the control panel.
2. Stop the cycle and remove some laundry if the load is heavy, then restart the dryer to see if the noise stops.
3. Run the dryer empty or with a small normal load to separate load noise from mechanical noise.
4. Check the dryer for level by placing a carpenter's level on top, then adjust the leveling feet if needed.
5. Inspect the exhaust vent connection and nearby items for contact or rattling against the cabinet.
6. Open the drum and check for loose objects such as buttons, pens, or coins.
7. If the noise persists with a normal load, unplug the dryer and remove the cabinet panels to access the drive system.
8. Spin the idler pulley by hand to check for roughness or seizure, then inspect the drum support rollers for flat spots or bearing noise, check the drive belt for cracks or glazing, and examine the blower wheel for debris or cracks.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Idler pulley assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-dryer-squeaking&k=Idler+pulley+assembly&tag=errorcodefixes-20) \| Maintains tension on the drive belt and commonly seizes, causing squeaking. |
| Drum support roller assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-dryer-squeaking&k=Drum+support+roller+assembly&tag=errorcodefixes-20) \| Supports the drum as it rotates and wears out, creating grinding or squealing noise. |
| Drive belt | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-dryer-squeaking&k=Drive+belt&tag=errorcodefixes-20) \| Turns the drum and can crack, fray, or glaze, leading to slipping and squeaking. |
| Blower wheel | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-dryer-squeaking&k=Blower+wheel&tag=errorcodefixes-20) \| Moves air through the dryer and can crack or slip on the hub, causing noise. |
