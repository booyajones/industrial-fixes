---
title: "Bradford White Water Heater Popping Noise - Causes & Fix"
description: "Sediment buildup at tank bottom traps steam bubbles that collapse and create popping sounds. Flush the tank to remove mineral deposits."
pubDatetime: 2026-06-11T22:48:21Z
modDatetime: 2026-06-11T22:48:21Z
...
1. Confirm the noise is popping or rumbling and not hissing (leak) or whistling (flow restriction) by listening near the tank base during heating cycles.
2. Turn off power at the circuit breaker for electric units or set the gas control valve to Pilot position for gas units, then close the cold water inlet valve.
3. Allow the tank to cool for 30 to 60 minutes to prevent scalding during the drain process.
4. Attach a heavy-duty garden hose to the drain valve at the tank bottom and route it to a floor drain or safe outdoor location, then open a hot water faucet somewhere in the house to break the vacuum.
5. Open the tank drain valve and let water flow out completely, watching for sediment chunks or cloudy water exiting the hose.
6. If water runs clear immediately, briefly open the cold water inlet valve while the drain is still open to create turbulence and dislodge compacted sediment at the bottom.
7. Continue flushing until the water exiting the hose runs completely clear with no visible particles, then close the drain valve and remove the hose.
8. Refill the tank by opening the cold water inlet valve, close the hot water faucet once water flows steadily, and restore power or return the gas valve to On position.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Sacrificial anode rod | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-bradford-white-water-heater-making-popping-noise&k=Sacrificial+anode+rod&tag=errorcodefixes-20) \| Inspect during flushing and replace if less than 1/2 inch of core wire remains. |
| Drain valve | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-bradford-white-water-heater-making-popping-noise&k=Drain+valve&tag=errorcodefixes-20) \| Replace if corroded or fails to seal after flushing, plastic or brass models available. |
