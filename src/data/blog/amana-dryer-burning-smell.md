---
title: "Amana Dryer Burning Smell - Causes & Fix"
description: "A burning smell usually means lint buildup restricting airflow or a slipping drive belt. Clean the lint system and vent first, then inspect the belt and idler pulley."
pubDatetime: 2026-06-09T13:21:06Z
modDatetime: 2026-06-09T13:21:06Z
...
1. De-energize the dryer by unplugging the cord or shutting off the circuit breaker, and do not run it again until you complete the inspection.
2. Remove and clean the lint screen, then vacuum out the lint housing and internal blower path using a crevice tool or dryer vent brush.
3. Disconnect and inspect the external vent ducting from the dryer to the outdoor termination for blockages, kinks, or heavy lint accumulation, and clean or replace as needed.
4. Access the cabinet and inspect the drive belt for glazing, fraying, or stretching, and check that it is seated correctly on the drum, motor pulley, and idler pulley.
5. Spin the idler pulley and each drum roller by hand to confirm they turn freely without binding or excessive noise.
6. Inspect the terminal block, power cord connections, door switch, and all visible wiring for scorch marks, melted insulation, or burned connectors.
7. Check the main control board for discolored or burnt components, and examine the heating element or burner area for lint buildup or signs of arcing.
8. Replace any failed component and address the root cause, such as cleaning venting if restricted or replacing a seized idler that caused belt slip.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Dryer drive belt | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-amana-dryer-burning-smell&k=Dryer+drive+belt&tag=errorcodefixes-20) \| Replace if frayed, glazed, or stretched; verify model-specific belt length before ordering. |
| Idler pulley assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-amana-dryer-burning-smell&k=Idler+pulley+assembly&tag=errorcodefixes-20) \| Includes the pulley wheel and spring; replace if the pulley does not spin freely. |
| Drum roller kit | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-amana-dryer-burning-smell&k=Drum+roller+kit&tag=errorcodefixes-20) \| Sold in pairs or sets of four; replace all rollers at once for even wear. |
| Terminal block kit | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-amana-dryer-burning-smell&k=Terminal+block+kit&tag=errorcodefixes-20) \| Use when power terminals show visible burn or corrosion; includes block and wire connectors. |
