---
title: "GE Microwave Magnetron Replacement - Signs & How-To"
description: "Microwave runs but won't heat, turntable spins, fan runs, or food stays cold. Replacing a failed magnetron restores normal heating."
pubDatetime: 2026-06-01T21:18:13Z
modDatetime: 2026-06-01T21:18:13Z
...
| Part | Notes |
|------|-------|
| GE microwave magnetron | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-microwave-magnetron-replacement&k=GE+microwave+magnetron&tag=errorcodefixes-20) \| Find your model and serial number on the metal plate inside the door frame or on the back panel, then cross-reference to the correct magnetron part number (common GE replacement is WB27X11079, but verify your exact model fitment before ordering). |
| Thermal protector and bracket (if not included with new magnetron) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-microwave-magnetron-replacement&k=Thermal+protector+and+bracket+%28if+not+included+with+new+magnetron%29&tag=errorcodefixes-20) \| Some replacement magnetrons come with a new thermal protector; if not, reuse the protector and bracket from the old unit. |
