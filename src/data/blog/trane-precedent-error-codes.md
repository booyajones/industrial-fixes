...
| Part | Notes |
|------|-------|
| UCM control board | Match to unit model and refrigerant type |
| SAT/OAT/RAT sensors | Thermistor type — check resistance vs. temp chart |
| Flame sensor | Clean with emery cloth before condemning |
| Run capacitor | Check µF value with capacitor meter |
| Limit switch | Match opening temperature rating |
