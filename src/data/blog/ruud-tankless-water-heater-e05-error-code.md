---
title: "Ruud E05 Error Code - Causes & Fix"
description: "E05 on a Ruud tankless water heater signals a water flow problem. The most common fix is cleaning the inlet filter screen."
pubDatetime: 2026-05-31T15:00:27Z
modDatetime: 2026-05-31T15:00:27Z
author: "Marcus Webb"
featured: false
draft: false
tags:
...
1. **Shut off power** to the water heater at the circuit breaker and close the inlet water valve to make the work area safe.
2. **Remove and inspect the inlet filter screen** by unscrewing the cold-water service valve cap, pull out the mesh screen, rinse it under tap water, and clear any visible debris or sediment.
3. **Check supply plumbing** for kinks, partially closed valves, or undersized piping that could restrict flow, and verify that upstream shutoff valves are fully open.
4. **Flush the heat exchanger** following your model's descaling procedure using a manufacturer-approved descaling solution and a recirculation pump to remove scale deposits from the internal coils.
5. **Restore power and water supply** to the unit, open a hot-water tap, and observe whether the heater fires normally and whether the E05 code returns.
6. **Test the flow sensor** if the error persists by checking continuity and voltage output according to the service manual, or have a technician verify sensor operation with diagnostic tools.
7. **Replace the flow sensor** if testing confirms it is faulty, ensuring the replacement part matches your exact Ruud model number and platform generation.

## Parts Often Needed

| Part | Notes |
|------|-------|
| Inlet filter screen | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ruud-tankless-water-heater-e05-error-code&k=Inlet+filter+screen&tag=errorcodefixes-20) \| Factory mesh screen for your model. Clean first before replacing. |
| Flow sensor assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ruud-tankless-water-heater-e05-error-code&k=Flow+sensor+assembly&tag=errorcodefixes-20) \| Match the part number in your service manual. Sensor design varies by heater generation. |
| Heat exchanger | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ruud-tankless-water-heater-e05-error-code&k=Heat+exchanger&tag=errorcodefixes-20) \| Required only if severe scale or corrosion prevents effective descaling. Expensive component. |
