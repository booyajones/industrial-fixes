---
title: "Kenmore Dryer Won't Tumble - Causes & Fix"
description: "A Kenmore dryer that won't tumble usually has a broken drive belt. Check the belt for breakage or slack and replace if damaged."
pubDatetime: 2026-06-01T15:21:22Z
modDatetime: 2026-06-01T15:21:22Z
...
1. Unplug the dryer or switch off the breaker before any access or testing.
2. Verify the symptom by noting whether the motor hums but the drum does not move (suspect belt, idler, rollers, or motor) or there is no motor response (check door switch, thermal fuse, timer, wiring, and motor).
3. Check the door switch for continuity with the door closed using a multimeter, and replace it if it does not show continuity or the actuator tab is broken.
4. Inspect the drive belt by removing access panels and looking for breakage, glazing, slack, or dislodgement, then replace if damaged.
5. Inspect the idler pulley and drum support rollers or bearings for seizure, flat spots, wobble, or excess wear, and replace worn parts.
6. Test the thermal fuse for continuity (a good fuse reads near 0 ohms, an open reading indicates failure), replace if open, and then correct the airflow problem that likely caused it.
7. Test the drive motor circuit if the dryer still will not tumble after the above checks, and if the motor fails the electrical or mechanical test or will not run under load, replace it.
8. Check timer or control contacts and wiring if the motor circuit is not receiving power, and repair or replace failed components, then run a functional test with the cabinet reassembled to confirm the drum starts, tumbles smoothly, and no abnormal noise or overheating is present.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Dryer drive belt | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-kenmore-dryer-wont-tumble&k=Dryer+drive+belt&tag=errorcodefixes-20) \| Connects motor to drum, prone to breakage or stretch |
| Dryer door switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-kenmore-dryer-wont-tumble&k=Dryer+door+switch&tag=errorcodefixes-20) \| Should show continuity when closed, prevents start if failed |
| Dryer thermal fuse | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-kenmore-dryer-wont-tumble&k=Dryer+thermal+fuse&tag=errorcodefixes-20) \| Reads near 0 ohms when good, open if blown |
| Dryer idler pulley | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-kenmore-dryer-wont-tumble&k=Dryer+idler+pulley&tag=errorcodefixes-20) \| Maintains belt tension, replace if seized or wobbly |
