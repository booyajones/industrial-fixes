---
title: "Maytag Refrigerator Water Dispenser Not Working - Causes & Fix"
description: "Usually caused by a clogged or improperly seated water filter. Remove the filter and test dispense to confirm flow is blocked."
pubDatetime: 2026-06-09T23:17:49Z
modDatetime: 2026-06-09T23:17:49Z
...
1. Confirm the dispenser lock is off (hold the lock button for 3 seconds on models with that feature) and that the refrigerator is connected to a cold water supply with the shutoff valve open.
2. Remove the water filter and test dispense without it installed. If flow returns, the filter or its housing is the fault.
3. Reinstall the filter correctly and flush the system per the filter's instructions. Maytag says required flush volume varies by filter.
4. Inspect the supply line from the house valve to the refrigerator and the water tube through the door or hinge area for kinks, pinches, or frozen sections.
5. Measure household water pressure at the supply valve. If pressure is low, correct the plumbing issue before replacing parts.
6. Test the dispenser switch and door switch with a multimeter for continuity when actuated. Replace any switch that tests open.
7. Test the water inlet valve by checking for power at the solenoid when the dispenser is commanded and testing the coil for proper resistance. Replace the valve if it does not open or tests out of range.
8. If a line is frozen, thaw the blocked section carefully and correct the underlying cold-air or temperature issue so it does not recur.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Water filter | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-maytag-refrigerator-water-dispenser-not-working&k=Water+filter&tag=errorcodefixes-20) \| Maytag OEM or compatible filter for your model |
| Water inlet valve | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-maytag-refrigerator-water-dispenser-not-working&k=Water+inlet+valve&tag=errorcodefixes-20) \| Solenoid valve at the rear of the refrigerator |
| Dispenser switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-maytag-refrigerator-water-dispenser-not-working&k=Dispenser+switch&tag=errorcodefixes-20) \| Actuator switch behind the dispenser paddle |
| Door switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-maytag-refrigerator-water-dispenser-not-working&k=Door+switch&tag=errorcodefixes-20) \| Switch that detects when the refrigerator door is closed |
