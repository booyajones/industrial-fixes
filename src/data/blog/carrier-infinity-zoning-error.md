...
| Part | Notes |
|------|-------|
| Infinity zone controller | Replace on repeated zone controller faults |
| Zone damper actuator | Replace on damper fault or stuck blade |
| Zone temperature sensor | Replace on sensor fault |
| Infinity bus cable | Replace on communication errors |
