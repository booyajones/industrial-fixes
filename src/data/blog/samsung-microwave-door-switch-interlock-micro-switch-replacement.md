---
title: "Samsung Microwave Door Switch Replacement - Signs & How-To"
description: "Won't start, stops mid-cycle, or runs with door ajar? A failed door interlock switch blocks operation. Replacing it restores safe door sensing."
pubDatetime: 2026-06-01T21:19:42Z
modDatetime: 2026-06-01T21:19:42Z
...
- **Microwave will not start when you press Start** The control panel lights up and accepts input, but pressing Start does nothing because the interlock circuit never closes.
- **Unit stops abruptly mid-cycle** The microwave runs for a few seconds then shuts off as if the door opened, even though it stayed closed.
- **Display shows door error or beeps repeatedly** Some Samsung models flash an error code or beep continuously when the interlock signal is missing or intermittent.
- **Microwave runs with the door slightly open** If the normally-closed interlock contact has welded shut, the oven may run unsafely without proper door closure (this is rare but extremely dangerous).
- **Door latch feels loose or doesn't click firmly** The latch hook no longer fully depresses the switch actuator, so the switch never changes state even though the door appears closed.
- **Burnt or melted connector at the switch terminal** Arcing or heat damage at the switch plug indicates high resistance or intermittent contact inside the switch body.
...
| Part | Notes |
|------|-------|
| Samsung door interlock switch / micro-switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-microwave-door-switch-interlock-micro-switch-replacement&k=Samsung+door+interlock+switch+%2F+micro-switch&tag=errorcodefixes-20) \| Samsung part number 3405-001034 fits many models. Check your model and serial plate inside the door frame and verify switch count (some units use two or three switches) on the parts diagram before ordering. |
