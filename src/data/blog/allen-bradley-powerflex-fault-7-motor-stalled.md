...
|------|------------|-------------|-------------|
| Replacement PowerFlex 4 Drive (if damaged) | 22A-D2P3N104 (varies by HP) | $350–$900 | [Amazon](https://www.amazon.com/s?k=22A-D2P3N104+%28varies+by+HP%29+Replacement+PowerFlex+4+Drive+%28if+damaged%29&tag=errorcodefixes-20) \| Automation Direct / Rockwell dealer |
| Motor Coupling (if sheared) | Application-specific | $20–$150 | [Amazon](https://www.amazon.com/s?k=Application-specific+Motor+Coupling+%28if+sheared%29&tag=errorcodefixes-20) \| Grainger / McMaster-Carr |
| Replacement Motor Bearings | Match motor frame size | $15–$80 | [Amazon](https://www.amazon.com/s?k=Match+motor+frame+size+Replacement+Motor+Bearings&tag=errorcodefixes-20) \| Grainger / bearing supply |
