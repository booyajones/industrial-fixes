---
title: "Samsung Oven Burner Won't Light - Causes & Fix"
description: "A weak igniter that glows but doesn't draw enough current to open the gas valve is the most common cause. Replace the igniter."
pubDatetime: 2026-06-01T18:40:07Z
...
1. Verify the symptom by confirming whether the oven igniter glows but the burner never lights, or whether the cooktop burner sparks when turned to LITE.
2. Disconnect power and shut off the gas supply before beginning any service work.
3. Inspect the igniter, wiring, and burner area for cracks, carbon deposits, grease, loose connectors, or burned terminals.
4. Clean visible grease and debris from the igniter and burner area if contamination is present.
5. For cooktop burners, confirm the burner head and cap are clean and seated correctly, and clear the orifice if blocked.
6. For oven burners, measure igniter current with an amp probe during a heat call. A good hot-surface igniter typically draws about 2.9 amps or higher to reliably open the gas valve.
7. Replace the igniter if it is cracked, does not glow, glows weakly, or fails the amperage test.
8. After replacement, run a heat call test to confirm the burner ignites normally and stays lit.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Samsung oven hot-surface igniter | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-oven-burner-wont-light&k=Samsung+oven+hot-surface+igniter&tag=errorcodefixes-20) \| The bake igniter that opens the gas valve when it draws sufficient current. |
| Gas safety valve | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-oven-burner-wont-light&k=Gas+safety+valve&tag=errorcodefixes-20) \| The valve opened by igniter current to allow gas flow to the burner. |
| Igniter wiring harness or connectors | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-oven-burner-wont-light&k=Igniter+wiring+harness+or+connectors&tag=errorcodefixes-20) \| Replacement wiring or connectors if terminals are burned or loose. |
