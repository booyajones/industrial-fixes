---
title: "Frigidaire Washer Won't Drain - Causes & Fix"
description: "Most likely a main control board relay fault (E23 code) preventing pump power, or a clogged pump/coin trap. Check pump circuit first."
pubDatetime: 2026-06-01T15:06:02Z
modDatetime: 2026-06-01T15:06:02Z
...
- **Wiring harness or connector problem** Loose, corroded, or damaged connectors between the control board and the drain pump will interrupt the signal or power path.
- **Drain pump electrical fault** An open winding, short, or internal failure in the pump motor itself can cause the control to detect a fault and shut down the drain cycle.
- **Blocked pump or coin trap** Lint, coins, pet hair, or small objects lodge in the coin trap or impeller housing and stop water flow even when the pump tries to run.
- **Kinked or clogged drain hose** A crushed, pinched, or debris-blocked drain hose restricts flow and can cause slow drain or no-drain symptoms.
- **Failing pump impeller** A cracked, broken, or loose impeller inside the pump assembly will not move water even if the motor spins.
- **Control board output problem** The main control board may fail to send the correct voltage or signal to the pump circuit, even when the relay and wiring are intact.
...
| Part | Notes |
|------|-------|
| Drain pump assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-washer-wont-drain&k=Drain+pump+assembly&tag=errorcodefixes-20) \| Includes motor, impeller, and housing; match your model number. |
| Main control board | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-washer-wont-drain&k=Main+control+board&tag=errorcodefixes-20) \| Also called electronic control board; verify board part number before ordering. |
| Wiring harness | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-washer-wont-drain&k=Wiring+harness&tag=errorcodefixes-20) \| Order only if connectors or wires are visibly damaged or corroded. |
