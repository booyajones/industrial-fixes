...
| Part | Notes |
|------|-------|
| Encoder feedback cable | [Amazon](https://www.amazon.com/s?k=Encoder+feedback+cable&tag=errorcodefixes-20) \| Must be shielded; match connector type to drive interface |
| Rotary encoder (motor-mounted) | [Amazon](https://www.amazon.com/s?k=Rotary+encoder+%28motor-mounted%29&tag=errorcodefixes-20) \| Match to servo motor model and Sinumerik interface type |
| Linear scale read head | [Amazon](https://www.amazon.com/s?k=Linear+scale+read+head&tag=errorcodefixes-20) \| OEM replacement for Heidenhain/Renishaw scale |
| DRIVE-CLiQ cable | [Amazon](https://www.amazon.com/s?k=DRIVE-CLiQ+cable&tag=errorcodefixes-20) \| For newer SINAMICS drives with DRIVE-CLiQ encoder interface |
## When to Call a Pro
