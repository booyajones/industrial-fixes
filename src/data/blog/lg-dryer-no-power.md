---
title: "LG Dryer No Power - Causes & Fix"
description: "Most often a tripped circuit breaker or loose power cord. Reset the breaker, check the cord connection at the outlet and dryer, then test."
...
1. Open the dryer door and check whether the drum light comes on. LG uses this as a quick indicator of whether low-voltage power is present.
2. If the light is off, verify the power cord is pushed fully into the outlet and secured at the terminal block on the back of the dryer.
3. Reset the circuit breaker by turning it off, waiting at least 10 seconds, then turning it back on. Remember that electric dryers typically use two breakers, so check both.
4. Recheck the drum light and try to start a cycle.
5. If still dead, perform LG's hard reset by unplugging the dryer, holding the Power or Start button for 5 seconds, then holding the Play or Pause button for 5 seconds, reconnecting power, and testing again.
6. If the drum light is on but the dryer will not start or shows nP, check the outlet voltage. LG advises having a licensed electrician verify the outlet is delivering 240 V as required.
7. If the dryer still does not power on after all external checks, the unit requires service by a qualified technician.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Power cord | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lg-dryer-no-power&k=Power+cord&tag=errorcodefixes-20) \| Three- or four-wire cord rated for 240 V, if the existing cord is damaged or does not match the outlet. |
| Circuit breaker | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lg-dryer-no-power&k=Circuit+breaker&tag=errorcodefixes-20) \| Replacement breaker for the home panel if the existing breaker trips repeatedly or will not stay on. |
