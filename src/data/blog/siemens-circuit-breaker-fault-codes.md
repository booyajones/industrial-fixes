...
| Part | Notes |
|------|-------|
| ETU trip unit | [Amazon](https://www.amazon.com/s?k=ETU+trip+unit&tag=errorcodefixes-20) \| Replace on display or trip failure |
| COM module (Modbus/PROFIBUS) | [Amazon](https://www.amazon.com/s?k=COM+module+%28Modbus%2FPROFIBUS%29&tag=errorcodefixes-20) \| Replace on communication fault |
| Auxiliary switch block | [Amazon](https://www.amazon.com/s?k=Auxiliary+switch+block&tag=errorcodefixes-20) \| Replace on worn contacts |
| Arc chutes (3WL) | [Amazon](https://www.amazon.com/s?k=Arc+chutes+%283WL%29&tag=errorcodefixes-20) \| Inspect after multiple SC trips |
| Motor drive for 3WL | [Amazon](https://www.amazon.com/s?k=Motor+drive+for+3WL&tag=errorcodefixes-20) \| Replace on spring charge failure |
## When to Call a Pro
