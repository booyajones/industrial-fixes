...
| Part | Notes |
|------|-------|
| Hot surface igniter (silicon nitride) | [View on Amazon](https://www.amazon.com/dp/B00BTLLJ40?ascsubtag=ecf-carrier-11-error-code&tag=errorcodefixes-20) \| Match OEM part number; Carrier uses several variants across model years |
...
| Gas valve | [View on Amazon](https://www.amazon.com/dp/B0015KAHHA?ascsubtag=ecf-carrier-11-error-code&tag=errorcodefixes-20) \| Replace only after confirming proper inlet pressure and wiring |
## When to Call a Pro
