---
title: "GE Dryer Heating Element Replacement - Signs & How-To"
description: "Dryer tumbles but won't heat, takes forever to dry, or shuts off mid-cycle. Replacing a failed heating element or cleaning vents restores heat."
pubDatetime: 2026-06-01T15:51:58Z
modDatetime: 2026-06-01T15:51:58Z
...
- **Dryer tumbles but produces no heat at all** The drum spins and the timer counts down, but clothes come out cold and wet after a full cycle.
- **Clothes take two or three cycles to dry** The dryer gets slightly warm but never reaches full temperature, doubling or tripling dry time.
- **Heat works for a few minutes then stops** The dryer starts warm, then shuts off heat mid-cycle and tumbles cold air until the timer runs out.
- **Visible break or gap in the heating coil** When you inspect the element housing through the access panel, you see a broken or separated section of wire coil.
- **Burnt or melted wiring at the heater terminals** Spade connectors on the heater or terminal block show scorch marks, melted insulation, or loose connections.
- **Multimeter shows infinite resistance across element** With one wire disconnected, your ohm meter reads open or OL instead of the expected 43 ohms across the coil.
...
| Part | Notes |
|------|-------|
| GE dryer heating element | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-dryer-heating-element-replacement&k=GE+dryer+heating+element&tag=errorcodefixes-20) \| Check your model and serial number plate on the dryer door opening or rear panel to find the correct element part number. Common GE numbers include WE11X10007 (alternate 5300622034). Some models use a heater coil insert, others require the full heater-pan assembly. |
| Thermal fuse or thermostat | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-dryer-heating-element-replacement&k=Thermal+fuse+or+thermostat&tag=errorcodefixes-20) \| Replace any safety fuse or thermostat that shows infinite resistance during testing. These devices mount directly on the heater housing and are often sold individually or in a kit with the element. |
