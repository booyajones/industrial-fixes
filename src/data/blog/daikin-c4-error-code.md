...
| Part | Notes |
|------|-------|
| Indoor coil thermistor | [Amazon](https://www.amazon.com/s?i=industrial&k=Indoor+coil+thermistor&tag=errorcodefixes-20) \| Model-specific Daikin sensor |
| Indoor PCB | [Amazon](https://www.amazon.com/dp/B0CNZGZ1HS?tag=errorcodefixes-20) \| Only if thermistor and wiring test good |
## When to Call a Pro
