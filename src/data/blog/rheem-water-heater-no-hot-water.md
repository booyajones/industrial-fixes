---
title: "Rheem Water Heater No Hot Water - Causes & Fix"
description: "Most often caused by ignition failure, flame loss, or insufficient water flow. Check the fault code on your unit's display first."
pubDatetime: 2026-06-01T19:10:40Z
modDatetime: 2026-06-01T19:10:40Z
...
- **Insufficient water flow through the unit** Flow restrictors, low-flow taps, or a clogged inlet filter can drop flow below the 2 to 3 liters per minute minimum, keeping the heater from firing or staying on.
- **Blocked or restricted venting and combustion air** Obstructions at the flue inlet, exhaust termination, air inlet filter, or closed ventilation openings will trigger combustion or ignition faults.
- **Faulty ignition or flame sensor** A worn ignitor, dirty or corroded flame sensor, or damaged wiring prevents the unit from lighting or causes it to shut down after a few seconds.
- **Scale or mineral buildup in the heat exchanger** Hard water deposits restrict water passages and can cause over-temperature or flow-related shutdowns.
- **Failed temperature sensor or over-temperature sensor** A bad inlet, outlet, or overheating sensor will give false readings and shut down the burner to protect the unit.
...
| Part | Notes |
|------|-------|
| Rheem ignitor kit | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rheem-water-heater-no-hot-water&k=Rheem+ignitor+kit&tag=errorcodefixes-20) \| Match to your exact model number. |
| Rheem flame sensor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rheem-water-heater-no-hot-water&k=Rheem+flame+sensor&tag=errorcodefixes-20) \| Confirm part number from the wiring diagram on the unit. |
| Rheem inlet or outlet temperature sensor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rheem-water-heater-no-hot-water&k=Rheem+inlet+or+outlet+temperature+sensor&tag=errorcodefixes-20) \| Order by model and code definition. |
