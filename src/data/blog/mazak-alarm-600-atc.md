...
| Part | Notes |
|------|-------|
| ATC proximity switch | [Amazon](https://www.amazon.com/s?k=ATC+proximity+switch&tag=errorcodefixes-20) \| Match the Mazak machine model and switch thread/body size |
| Retention knob (pull stud) | [Amazon](https://www.amazon.com/s?k=Retention+knob+%28pull+stud%29&tag=errorcodefixes-20) \| Must match the spindle taper (CAT40, BT40, HSK-A63, etc.) |
| ATC pneumatic solenoid valve | [Amazon](https://www.amazon.com/s?k=ATC+pneumatic+solenoid+valve&tag=errorcodefixes-20) \| Replace if actuator does not respond to commanded position |
## When to Call a Pro
