...
| Part | Notes |
|---|---|
| Outdoor fan motor | Match HP, RPM, blade pitch, and rotation |
| Run capacitor | Match µF and voltage rating exactly |
| Outdoor PCB | Model-specific — match firmware revision if applicable |
