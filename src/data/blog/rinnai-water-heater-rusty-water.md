---
title: "Rinnai Water Heater Rusty Water - Causes & Fix"
description: "Usually a corroded heat exchanger or scale buildup. Flush with four gallons of vinegar or replace the heat exchanger if leaking."
pubDatetime: 2026-06-11T22:43:57Z
modDatetime: 2026-06-11T22:43:57Z
...
1. Confirm whether the discoloration appears only on hot water or also on cold. Hot-only discoloration points to the heater or hot-side piping.
2. Inspect the heat exchanger area and all fittings for active leaks or moisture. If the heat exchanger is leaking, it must be replaced.
3. Look for visible hot spots, scale deposits, or corrosion on the heat exchanger copper fins. Hot spots indicate blockage from scale buildup.
4. Flush the heat exchanger using four gallons of vinegar if scale is present. Follow Rinnai's vinegar flush procedure for descaling.
5. Check the vent system and condensate path to confirm condensate is draining away from the unit. Install a condensate drain line at the top of the heater if moisture is running back in.
6. Inspect the burner manifold, burner assembly, and heat exchanger for debris or blockage if you also see performance or combustion symptoms.
7. If the heat exchanger shows damage from poor maintenance or neglect, replace it rather than attempting further cleaning.
8. Isolate the heater from the building plumbing by closing the inlet valve and opening a hot tap. If the water clears, the rust is coming from house pipes, not the heater.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Rinnai heat exchanger (model-specific) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rinnai-water-heater-rusty-water&k=Rinnai+heat+exchanger+%28model-specific%29&tag=errorcodefixes-20) \| Required when leaking or damaged by scale. Verify your exact Rinnai model number before ordering. |
| White vinegar (four gallons) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rinnai-water-heater-rusty-water&k=White+vinegar+%28four+gallons%29&tag=errorcodefixes-20) \| Rinnai specifies four gallons for heat exchanger descaling flush. |
| Condensate drain fitting and line | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rinnai-water-heater-rusty-water&k=Condensate+drain+fitting+and+line&tag=errorcodefixes-20) \| Needed if vent condensate is running back into the top of the heater. |
