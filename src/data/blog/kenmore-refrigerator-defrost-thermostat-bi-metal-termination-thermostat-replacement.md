---
title: "Kenmore Refrigerator Defrost Thermostat Replacement Guide"
description: "Frost buildup, warm temps, and constant running mean your defrost thermostat failed. Replacing this bi-metal switch restores proper defrost cycles."
pubDatetime: 2026-06-01T16:17:55Z
modDatetime: 2026-06-01T16:17:55Z
...
- **Heavy frost or ice buildup on the evaporator coils** Thick frost covering the coils in the freezer compartment indicates the defrost cycle is not completing because the thermostat is not signaling the heater to run or is not terminating the cycle correctly.
- **Refrigerator or freezer running warmer than normal** When frost blocks airflow over the evaporator, cooling performance drops and compartment temperatures rise above the setpoint.
- **Compressor running constantly without cycling off** The unit runs non-stop trying to reach temperature because the iced-over coils cannot transfer heat efficiently.
- **No continuity at cold temperature or continuity at warm temperature during testing** A properly working thermostat should be closed (continuity) at about 20°F and open (no continuity) at about 40°F, so any other reading confirms the switch has failed.
- **Water pooling inside the refrigerator or freezer** Excessive frost melting during off cycles or a clogged drain line (often found alongside thermostat failures) can cause water leaks inside the compartments.
- **Defrost heater does not warm up during the defrost cycle** If the thermostat is stuck open, the defrost heater circuit cannot complete and the heater will not energize to melt frost off the coils.
