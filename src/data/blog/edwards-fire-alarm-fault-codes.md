...
| Part | Notes |
|------|-------|
| Signature detector head | Replace if cleaning does not resolve trouble |
| Sealed lead-acid battery | Match capacity to panel requirements |
| SLC module | Replace on persistent loop communication faults |
