---
title: "True Refrigerator Error Code E1 / P1: Thermostat Probe Failure Causes and Fix"
...
- **Failed cabinet temperature probe**. The NTC thermistor has drifted out of range or failed open.
- **Damaged probe wiring**. Wires can rub through near the evaporator cover, fan shroud, control housing, or door hinge chase.
- **Moisture in the connector**. Condensation or washdown moisture can corrode the plug and create unstable readings.
- **Loose connection at the controller**. A half seated plug can produce an intermittent E1 or P1 fault.
- **Wrong replacement probe installed**. True controllers need the correct resistance curve. A generic sensor with the wrong spec can create the same alarm.
- **Failed controller input**. Less common, but possible if a known good probe still reads as failed.
...
- [Cabinet temperature sensor probe](https://www.amazon.com/s?ascsubtag=ecf-true-refrigeration-e1-p1-error&k=Cabinet+temperature+sensor+probe&tag=errorcodefixes-20)
...
- True Refrigeration E3 Error Code: Defrost Time Causes and Fix
