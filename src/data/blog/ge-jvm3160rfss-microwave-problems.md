---
title: "GE JVM3160RFSS Microwave Problems & Error Codes"
description: "Most JVM3160RFSS units throw F-codes from failed sensors or touch panel shorts. Reset the control first, then replace the bad part."
pubDatetime: 2026-06-01T17:18:51Z
modDatetime: 2026-06-01T17:18:51Z
...
| Part | Notes |
|------|-------|
| Thermal sensor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-jvm3160rfss-microwave-problems&k=Thermal+sensor&tag=errorcodefixes-20) \| Triggers F1 (open) or F2 (shorted) codes when it fails or overheats. |
| Touch panel or touch screen assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-jvm3160rfss-microwave-problems&k=Touch+panel+or+touch+screen+assembly&tag=errorcodefixes-20) \| Causes F3 or F10 shorts from stuck keys or moisture damage. |
| Temperature probe | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-jvm3160rfss-microwave-problems&k=Temperature+probe&tag=errorcodefixes-20) \| Throws F6 or Probe errors when shorted, open, or not seated in the jack. |
| Main electronic control board | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-jvm3160rfss-microwave-problems&k=Main+electronic+control+board&tag=errorcodefixes-20) \| Implicated in 18 power watch codes and persistent faults that don't clear. |
