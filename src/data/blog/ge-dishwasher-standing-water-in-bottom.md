---
title: "GE Dishwasher Standing Water in Bottom - Causes & Fix"
description: "A clogged filter or sump area is usually the culprit. Pull the filters and clear food debris, then check the drain hose for kinks."
pubDatetime: 2026-06-10T12:53:39Z
modDatetime: 2026-06-10T12:53:39Z
...
1. Confirm whether the water is a normal shallow amount (one to two cups) or actual retained dirty water after a complete cycle.
2. Run your kitchen sink and garbage disposal to verify the drain system is clear and water flows freely.
3. Open the dishwasher door and remove the fine and ultra fine filters from the bottom, then inspect the sump area and clear any visible debris like food, labels, or bones.
4. Check the drain hose under the sink for kinks, pinches, or blockage, and confirm it is routed with a high loop at least 32 inches above the floor if no air gap is installed.
5. If you have an air gap on the countertop or sink, remove the cap and clean out any debris blocking the ports.
6. If the disposal was recently installed, disconnect the drain hose from the disposal inlet and verify the knockout plug was removed from inside the disposal.
7. Run a drain or cancel cycle after clearing the path and watch to see if the dishwasher pumps water out.
8. If the drain plumbing, filters, and hose are all clear but water still remains, test the drain pump motor and its control circuit for electrical or mechanical failure.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Drain pump | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-dishwasher-standing-water-in-bottom&k=Drain+pump&tag=errorcodefixes-20) \| Part number varies by model. Replace if the pump does not run or hums but will not move water after all drain path checks pass. |
| Fine and ultra fine filters | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-dishwasher-standing-water-in-bottom&k=Fine+and+ultra+fine+filters&tag=errorcodefixes-20) \| Model-specific. Replace if cracked, warped, or damaged during cleaning. |
| Drain hose | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-dishwasher-standing-water-in-bottom&k=Drain+hose&tag=errorcodefixes-20) \| Replace if kinked, cracked, or blocked internally. Confirm correct type and routing under the sink. |
