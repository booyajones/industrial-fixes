...
| Part | Notes |
|------|-------|
| Proximity switch | Replace if LED does not change state |
| Tool changer air cylinder | Replace on slow or leaking actuation |
| Drawbar rebuild kit | Replace on weak release force |
| Geneva drive components | Common on worn umbrella changers |
| Carousel motor / gearbox | Replace on indexing faults |
