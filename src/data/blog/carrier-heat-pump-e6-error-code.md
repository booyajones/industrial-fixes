...
| Part | Notes |
|------|-------|
| Outdoor ambient thermistor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-carrier-heat-pump-e6-error-code&k=Outdoor+ambient+thermistor&tag=errorcodefixes-20) \| Carrier 338818-701 or model-specific; verify pin count |
| Contact cleaner | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-carrier-heat-pump-e6-error-code&k=Contact+cleaner&tag=errorcodefixes-20) \| DeoxIT D5 for connector cleaning |
## When to Call a Pro
