...
|-----------|---------|-------------|-----------|
| OI.AC | AC output overcurrent | Short circuit; fast acceleration | Check motor; increase accel time |
...
| tunE | Autotune fail | Motor does not match entered data | Verify motor nameplate data |
...
|----------|-------------|
| Access parameter menus | Press M button |
| Navigate to trip history | Menu 10, parameters 10.20–10.29 |
| Reset fault | Press STOP/RESET after correcting fault |
| Factory reset | Set Pr 10.33 = 1000, then press ENTER |
| Save parameters | Set Pr 00.09 = 1000 |
