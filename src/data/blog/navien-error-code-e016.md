...
| Part | Notes |
|------|-------|
| Hot surface igniter (silicon nitride) | Use Navien OEM part or confirmed compatible aftermarket |
| Igniter wire harness | Replace if insulation is melted or connector is damaged |
| Control PCB | Replace only if igniter circuit output is confirmed missing |
