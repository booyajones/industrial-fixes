...
|-----------|-------|---------|-----------|
| Red LED solid | Alpha, UPS | Pump fault — overload or locked rotor | Check for air lock; verify voltage |
| Red flashing | MAGNA | Protection mode active | Check system pressure; check liquid temp |
...
| Constant red | Alpha | Blocked impeller or air-locked | Bleed air; inspect impeller |
...
| Flashing green | Auto-adapt mode — learning curve |
| Solid red | Fault — check for blockage |
| Alternating green/red | Protection mode |
