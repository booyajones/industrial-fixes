...
| Part | Notes |
|------|-------|
| Sealed lead-acid battery | 12V or 24V depending on model |
| Smoke detector head | Replace on dirty or failed detector |
| End-of-line resistor | Required on Class B circuits |
| Loop card / SLC module | Replace on persistent loop communication faults |
