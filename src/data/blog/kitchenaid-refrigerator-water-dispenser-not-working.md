---
title: "KitchenAid Refrigerator Water Dispenser Not Working - Fix"
description: "Most often a clogged or improperly installed water filter blocks flow. Remove and flush the filter or replace it and purge 1–4 gallons."
pubDatetime: 2026-06-01T18:22:09Z
modDatetime: 2026-06-01T18:22:09Z
...
1. Verify the dispenser lock is off and press the paddle firmly with a glass to confirm the user is activating it fully.
2. Remove the water filter and try dispensing without it. If water flows, the filter is clogged or installed incorrectly.
3. Reinstall or replace the filter, making sure it locks and seats properly, then flush the system per the filter instructions (1, 2, or 4 gallons depending on the filter).
4. Inspect the water supply line behind and beneath the refrigerator for kinks, pinches, or ice blockage and straighten or thaw as needed.
5. Confirm the household shutoff valve is fully open and that the refrigerator is connected to a cold water supply with at least 20 psi pressure.
6. Test the dispenser paddle switch and door switch for continuity with a multimeter when actuated. Replace any switch that shows no continuity.
7. Test the water inlet valve for continuity and mechanical function. Replace the valve if it does not open or shows electrical failure.
8. If the model has an internal reservoir and flow is still blocked after other checks, inspect for a frozen line inside the door and carefully thaw it.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Water filter (KitchenAid refrigerator) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-kitchenaid-refrigerator-water-dispenser-not-working&k=Water+filter+%28KitchenAid+refrigerator%29&tag=errorcodefixes-20) \| Match the filter model to your refrigerator. Flush 1–4 gallons after installation per filter instructions. |
| Water inlet valve | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-kitchenaid-refrigerator-water-dispenser-not-working&k=Water+inlet+valve&tag=errorcodefixes-20) \| Requires 20–120 psi to operate. Located on the rear lower panel of the refrigerator. |
| Dispenser actuator switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-kitchenaid-refrigerator-water-dispenser-not-working&k=Dispenser+actuator+switch&tag=errorcodefixes-20) \| The paddle switch inside the dispenser housing that closes when the user presses for water. |
