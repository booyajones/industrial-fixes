...
| Part | Notes |
|------|-------|
| Cooling fan | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-yaskawa-v1000-complete-guide&k=Cooling+fan&tag=errorcodefixes-20) \| Routine wear item on older V1000 drives |
| Braking resistor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-yaskawa-v1000-complete-guide&k=Braking+resistor&tag=errorcodefixes-20) \| Needed for fast stops on high-inertia loads |
| Input fuses | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-yaskawa-v1000-complete-guide&k=Input+fuses&tag=errorcodefixes-20) \| Check all three for PF and UV1 events |
| Motor cable | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-yaskawa-v1000-complete-guide&k=Motor+cable&tag=errorcodefixes-20) \| Replace if insulation tests low to ground |
| Keypad / operator | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-yaskawa-v1000-complete-guide&k=Keypad+%2F+operator&tag=errorcodefixes-20) \| Useful if display or parameter access is unreliable |
| Drive | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-yaskawa-v1000-complete-guide&k=Drive&tag=errorcodefixes-20) \| For CPF faults or repeated hardware trips after field wiring is confirmed |
## When to Call a Pro
