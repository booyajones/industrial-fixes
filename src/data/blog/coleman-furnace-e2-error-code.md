...
| Part | Notes |
|------|-------|
| Pressure switch | Match Coleman/York part number; check pressure rating |
| Pressure switch hose | 1/4" ID rubber or silicone; available in bulk |
| Inducer motor capacitor | Check before ordering a full motor assembly |
| Induced draft motor | Replace if capacitor is good but motor runs slow or noisy |
