---
title: "Mini-Split Ice Buildup on Indoor Unit - Causes and How to Fix It"
description: "Ice buildup on your mini-split indoor unit is a warning sign. Here are the causes including dirty filters, low refrigerant, and blocked drains."
pubDatetime: 2026-04-30T15:00:00Z
modDatetime: 2026-04-30T15:00:00Z
author: "Marcus Webb"
slug: mini-split-ice-buildup
featured: false
draft: false
tags:
  - mini-split
...
- [Dirty Air Filters](#1-dirty-air-filters)
- [Low Refrigerant Charge](#2-low-refrigerant-charge)
- [Restricted Airflow from Blocked Returns](#3-restricted-airflow-from-blocked-returns)
- [Condensate Drain Blockage](#4-condensate-drain-blockage)
- [Fan Speed Set Too Low](#5-fan-speed-set-too-low)
- [Dirty Evaporator Coils](#6-dirty-evaporator-coils)
- [Faulty Indoor Fan Motor](#7-faulty-indoor-fan-motor)
- [Restricted or Kinked Refrigerant Lines](#8-restricted-or-kinked-refrigerant-lines)
...
- [Heat Pump Freezing Up - Causes, Fixes, and When to Call a Tech](/blog/heat-pump-freezing-up)
- [Heat Pump Not Heating - Why It Happens and How to Fix It](/blog/heat-pump-not-heating)
- [Mini-Split Error Code List](/blog/mini-split-error-codes)
