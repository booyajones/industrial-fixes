...
| Part | Notes |
|------|-------|
| VFD-rated motor cable | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-abb-acs580-fault-2330&k=VFD+rated+motor+cable&tag=errorcodefixes-20) \| Replace damaged or moisture-soaked output cable |
| Insulation resistance tester (megohmmeter) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-abb-acs580-fault-2330&k=megohmmeter+insulation+tester&tag=errorcodefixes-20) \| Required to prove whether the cable or motor is leaking to ground |
| Replacement 3-phase motor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-abb-acs580-fault-2330&k=3+phase+motor+480v&tag=errorcodefixes-20) \| Needed when winding insulation is breaking down |
| Motor terminal block / junction box parts | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-abb-acs580-fault-2330&k=motor+junction+box+terminal+block&tag=errorcodefixes-20) \| Useful when the fault is caused by contamination or loose terminals |
| Output reactor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-abb-acs580-fault-2330&k=output+reactor+vfd&tag=errorcodefixes-20) \| Helps protect long motor leads and reduces stress on older motors |
