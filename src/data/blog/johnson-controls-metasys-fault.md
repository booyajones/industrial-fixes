...
| Part | Notes |
|------|-------|
| Metasys field controller (FEC/IOM) | [Amazon](https://www.amazon.com/s?k=Metasys+field+controller+%28FEC%2FIOM%29&tag=errorcodefixes-20) \| Replace on hardware failure |
| Temperature/humidity sensor | [Amazon](https://www.amazon.com/s?k=Temperature%2Fhumidity+sensor&tag=errorcodefixes-20) \| Replace on OOR alarm |
| MS/TP termination resistor | [Amazon](https://www.amazon.com/s?k=MS%2FTP+termination+resistor&tag=errorcodefixes-20) \| 120 ohm, one per trunk end |
| Actuator (damper/valve) | [Amazon](https://www.amazon.com/s?k=Actuator+%28damper%2Fvalve%29&tag=errorcodefixes-20) \| Replace on stuck feedback |
| Freezestat | [Amazon](https://www.amazon.com/s?k=Freezestat&tag=errorcodefixes-20) \| Replace if trips repeatedly on reset |
## When to Call a Pro
