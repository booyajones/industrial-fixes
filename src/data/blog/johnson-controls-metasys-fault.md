...
| Part | Notes |
|------|-------|
| Metasys field controller (FEC/IOM) | Replace on hardware failure |
| Temperature/humidity sensor | Replace on OOR alarm |
| MS/TP termination resistor | 120 ohm, one per trunk end |
| Actuator (damper/valve) | Replace on stuck feedback |
| Freezestat | Replace if trips repeatedly on reset |
