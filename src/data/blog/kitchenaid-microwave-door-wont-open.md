---
title: "KitchenAid Microwave Door Won't Open - Causes & Fix"
description: "Usually a stuck latch, broken door spring, or bent hook. Release the latch manually by unplugging, then inspect the hook and spring."
pubDatetime: 2026-06-11T11:36:37Z
modDatetime: 2026-06-11T11:36:37Z
...
1. Unplug the microwave completely and wait one minute to remove all power before attempting any manual release or inspection.
2. Try gently pulling the door handle while pressing the release button repeatedly to see if the latch will disengage with light pressure.
3. Inspect the latch area on both the door and the frame for any packing material, food debris, or objects that might be blocking the hook or catch.
4. Look closely at the door hook (usually visible on the inside top edge of the door) and the catch on the frame for bends, cracks, or misalignment.
5. Check that the microwave is sitting level and that the door closes squarely without tilting or binding on the hinges.
6. If the door still will not open, locate the latch release lever inside the cabinet (often accessible by removing the outer wrap or grille) and manually push or lift it to free the hook.
7. Once the door is open, test the release button and latch spring action by hand to confirm the spring returns the lever fully and the hook moves freely in and out.
8. If the latch hardware appears intact, plug the unit back in and test a short cook cycle with water to verify the door switches are reporting correctly and the unit runs normally.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Door latch spring | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-kitchenaid-microwave-door-wont-open&k=Door+latch+spring&tag=errorcodefixes-20) \| Small tension or torsion spring that retracts the latch hook when the release button is pressed. |
| Door hook and catch assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-kitchenaid-microwave-door-wont-open&k=Door+hook+and+catch+assembly&tag=errorcodefixes-20) \| Metal hook mounted on the door and corresponding catch on the frame that lock the door closed. |
| Door interlock switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-kitchenaid-microwave-door-wont-open&k=Door+interlock+switch&tag=errorcodefixes-20) \| Micro-switch that detects door closure and enables the magnetron circuit, may mechanically interfere if failed. |
