...
| Part | Notes |
|------|-------|
| Flame sensor | Navien units use an integrated sensor/igniter on some models; verify separately serviceable |
| Gas valve assembly | Replace only if confirmed leaking; this is a licensed gas technician job |
| Control PCB | Replace if sensor and valve are confirmed good but fault persists |
