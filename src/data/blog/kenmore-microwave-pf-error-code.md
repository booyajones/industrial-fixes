...
description: "PF means power failure or interruption. Press Clear/Stop/Off to dismiss the code, then check your outlet and breaker for loose or tripped connections."
pubDatetime: 2026-06-10T05:18:36Z
modDatetime: 2026-06-10T05:18:36Z
...
1. **Press Clear, Stop, or Off** on the control panel to dismiss the PF code and return the microwave to standby mode.
2. **Check your home's breaker panel** for a tripped breaker or blown fuse on the circuit feeding the microwave and reset or replace it if needed.
3. **Unplug the microwave** and inspect the power cord for cuts, fraying, or burn marks at the plug and where it enters the cabinet.
4. **Test the wall outlet** with a known-good appliance or a multimeter to confirm stable 120 V AC power and that the receptacle grips the plug firmly.
5. **Eliminate extension cords and power strips** by plugging the microwave directly into a dedicated wall outlet rated for the appliance's amperage.
6. **Plug the microwave back in** and run a heating cycle to verify normal operation and confirm the PF code does not return.
7. **If PF reappears without any external power loss**, consult a qualified technician to test the control board and user-interface panel for intermittent faults that mimic a power interruption.

## Parts Often Needed

| Part | Notes |
|------|-------|
| Kenmore microwave power cord | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-kenmore-microwave-pf-error-code&k=Kenmore+microwave+power+cord&tag=errorcodefixes-20) \| Replace if the cord jacket is damaged or the plug prongs are loose or burned. |
| Wall outlet receptacle (15 A or 20 A, 120 V) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-kenmore-microwave-pf-error-code&k=Wall+outlet+receptacle+%2815+A+or+20+A%2C+120+V%29&tag=errorcodefixes-20) \| Upgrade a loose or worn receptacle to make sure firm plug contact and stable power delivery. |
| Kenmore microwave control board / user-interface panel | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-kenmore-microwave-pf-error-code&k=Kenmore+microwave+control+board+%2F+user-interface+panel&tag=errorcodefixes-20) \| Order the board assembly matched to your model number if internal testing confirms a fault and external power is stable. |
