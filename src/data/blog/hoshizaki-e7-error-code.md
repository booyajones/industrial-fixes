...
| Part | Notes |
|------|-------|
| Drain valve solenoid assembly | Order by model number; Hoshizaki uses different valve sizes by machine capacity |
| Control board | Replace if board relay is confirmed failed after valve and wiring are ruled out |
| Ice machine cleaner | Use to prevent recurrence from scale |
