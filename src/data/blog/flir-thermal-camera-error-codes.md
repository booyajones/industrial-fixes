...
| Part | Notes |
|------|-------|
| OEM battery pack | Third-party packs are a common problem |
| SD card | Use industrial or high-endurance media |
| Lens assembly | Only on removable-lens T-series models |
| USB / charging dock | Damaged docks cause charging faults |
