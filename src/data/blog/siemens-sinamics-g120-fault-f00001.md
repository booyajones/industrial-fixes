...
| Part | Notes |
|------|-------|
| VFD-rated motor cable | Replace if insulation is damaged or leakage to ground is found |
| Motor | Replace when winding insulation is weak or winding resistance is unbalanced |
| Siemens power module or control unit | Replace only after external motor and cable faults are ruled out |
