...
| Part | Notes |
|------|-------|
| Outdoor inverter PCB | [Amazon](https://www.amazon.com/s?i=industrial&k=Outdoor+inverter+PCB&tag=errorcodefixes-20) \| Must match R-32 model exactly — not interchangeable with R-410A boards |
| 3-conductor signal cable | [Amazon](https://www.amazon.com/s?i=industrial&k=3-conductor+signal+cable&tag=errorcodefixes-20) \| Replace if physical damage is found |
| Indoor unit control PCB | [Amazon](https://www.amazon.com/s?i=industrial&k=Indoor+unit+control+PCB&tag=errorcodefixes-20) \| Secondary failure point if outdoor board swap doesn't resolve U4 |
| Surge protector (outdoor) | [Amazon](https://www.amazon.com/s?i=industrial&k=Surge+protector+%28outdoor%29&tag=errorcodefixes-20) \| Install if U4 followed a surge event to prevent recurrence |
## When to Call a Pro
