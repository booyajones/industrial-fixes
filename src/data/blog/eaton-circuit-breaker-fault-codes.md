...
| Part | Notes |
|------|-------|
| Digitrip RMS module | [Amazon](https://www.amazon.com/s?k=Digitrip+RMS+module&tag=errorcodefixes-20) \| Replace on electronics failure |
| Arc chutes | [Amazon](https://www.amazon.com/s?k=Arc+chutes&tag=errorcodefixes-20) \| Inspect after fault trips |
...
| PowerNet communication module | [Amazon](https://www.amazon.com/s?k=PowerNet+communication+module&tag=errorcodefixes-20) \| Replace on comm fault |
| Spring charging motor | [Amazon](https://www.amazon.com/s?k=Spring+charging+motor&tag=errorcodefixes-20) \| Replace on slow charge or no-charge |
## When to Call a Pro
