...
| Part | Notes |
|------|-------|
| Replacement battery | Size to UPS model — check label |
| SNMPWEBCARD network card | Replace on communication fault |
| Input/output fuses | Check after overload events |
| Fan (SmartOnline large units) | Replace on overtemp fault |
