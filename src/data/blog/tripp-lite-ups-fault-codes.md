...
| Part | Notes |
|------|-------|
| Replacement battery | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-tripp-lite-ups-fault-codes&k=Replacement+battery&tag=errorcodefixes-20) \| Size to UPS model - check label |
| SNMPWEBCARD network card | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-tripp-lite-ups-fault-codes&k=SNMPWEBCARD+network+card&tag=errorcodefixes-20) \| Replace on communication fault |
| Input/output fuses | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-tripp-lite-ups-fault-codes&k=Input%2Foutput+fuses&tag=errorcodefixes-20) \| Check after overload events |
| Fan (SmartOnline large units) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-tripp-lite-ups-fault-codes&k=Fan+%28SmartOnline+large+units%29&tag=errorcodefixes-20) \| Replace on overtemp fault |
## When to Call a Pro
