---
title: "Panasonic H99 Error Code - Causes & Fix"
description: "H99 indicates a magnetron or inverter circuit fault. Most common fix: replace the inverter board or magnetron after testing."
pubDatetime: 2026-05-31T07:45:26Z
modDatetime: 2026-05-31T07:45:26Z
author: "Marcus Webb"
featured: false
draft: false
tags:
...
1. **Confirm the H99 code** by attempting a cook cycle and verifying that H99 appears on the display, not a different message or programming error.
2. **Unplug the microwave** and wait at least five minutes, then discharge the high-voltage capacitor using insulated tools and proper grounding before opening any panels.
3. **Inspect the magnetron and inverter area** for obvious damage, including burned or loose connectors, melted wire insulation, or corrosion at terminals.
4. **Test the magnetron filament** for continuity across its terminals (should show a low resistance path) and test from each terminal to the magnetron chassis (should show infinite resistance indicating no short to ground).
5. **Replace the magnetron** if the filament is open (no continuity) or shorted to chassis, using a direct replacement part for your model.
6. **Replace the inverter board** if the magnetron tests good, as the inverter power supply is the next most common cause and Panasonic guidance warns against attempting to repair or readjust the inverter circuit.
7. **Reassemble and test** the microwave, running a cup of water on high for one minute to confirm normal heating and verify the H99 code does not return.

## Parts Often Needed

| Part | Notes |
|------|-------|
| Inverter board / inverter power supply | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-panasonic-microwave-h99-error-code&k=Inverter+board+%2F+inverter+power+supply&tag=errorcodefixes-20) \| Panasonic part F606Y8X00AP is a common replacement for H99 faults. Match the part number to your exact model. |
| Magnetron | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-panasonic-microwave-h99-error-code&k=Magnetron&tag=errorcodefixes-20) \| Common Panasonic magnetron parts include EAS42812937 and 2M261-M32KLP. Verify fit by model number before ordering. |
