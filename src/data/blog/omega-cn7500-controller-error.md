...
| Part | Notes |
|------|-------|
| Type K thermocouple | Match temperature range to process |
| Type K extension wire | Use correct alloy — not copper |
| RTD sensor (Pt100) | For CN7500 RTD versions |
| Solid-state relay (SSR) | Output to heater — match current rating |
| Replacement CN7500 | Usually more economical than repair |
