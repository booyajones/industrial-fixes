...
| Part | Notes |
|------|-------|
| Type K thermocouple | [Amazon](https://www.amazon.com/dp/B00RJF4PYQ?ascsubtag=ecf-omega-cn7500-controller-error&tag=errorcodefixes-20) \| Match temperature range to process |
| Type K extension wire | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-omega-cn7500-controller-error&k=Type+K+extension+wire&tag=errorcodefixes-20) \| Use correct alloy — not copper |
| RTD sensor (Pt100) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-omega-cn7500-controller-error&k=RTD+sensor+%28Pt100%29&tag=errorcodefixes-20) \| For CN7500 RTD versions |
| Solid-state relay (SSR) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-omega-cn7500-controller-error&k=Solid-state+relay+%28SSR%29&tag=errorcodefixes-20) \| Output to heater — match current rating |
| Replacement CN7500 | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-omega-cn7500-controller-error&k=Replacement+CN7500&tag=errorcodefixes-20) \| Usually more economical than repair |
