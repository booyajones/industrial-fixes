...
| Part | Notes |
|---|---|
| Low-pressure switch | WaterFurnace part 8733800700 or equivalent |
| TXV assembly | Must match refrigerant type and capacity |
| Loop pump | Grundfos or Bell & Gossett — match GPM and head |
| Blower run capacitor | Match µF and voltage |
