---
title: "KitchenAid Microwave Won't Start - Causes & Fix"
description: "Control Lock is the most common cause. Press and hold the dedicated lock button or the designated pad for three seconds to unlock."
pubDatetime: 2026-06-11T11:34:56Z
modDatetime: 2026-06-11T11:34:56Z
...
- **No power, tripped breaker, or unplugged unit** KitchenAid recommends verifying outlet power and the circuit breaker as the first power-related check.
- **Delay Start is engaged** KitchenAid says an active Delay Start can make it appear the microwave will not start immediately.
- **Door not fully latched or door switch failure** KitchenAid says the microwave is designed not to run if the door is ajar, and a failed door switch can prevent starting.
- **Blown line fuse** Repair Clinic states that if too much current passes through the microwave circuitry, the line fuse blows and the microwave won't start.
- **Main control board failure** Repair Clinic lists this as possible but notes it is rarely the first or most common cause and is often misdiagnosed.
...
| Part | Notes |
|------|-------|
| Line fuse | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-kitchenaid-microwave-wont-start&k=Line+fuse&tag=errorcodefixes-20) \| Blows when excess current flows through the microwave, leaving the unit completely dead. |
| Door switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-kitchenaid-microwave-wont-start&k=Door+switch&tag=errorcodefixes-20) \| Prevents the microwave from starting if the door is not fully latched or the switch fails. |
| Main control board | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-kitchenaid-microwave-wont-start&k=Main+control+board&tag=errorcodefixes-20) \| Less commonly the root cause than switches, fuse, or power issues, according to Repair Clinic. |
