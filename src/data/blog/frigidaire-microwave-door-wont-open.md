---
title: "Frigidaire Microwave Door Won't Open - Causes & Fix"
description: "Usually a broken door latch or failed release spring. Unplug, remove the cover, inspect the latch assembly, and replace broken parts."
pubDatetime: 2026-06-11T11:33:49Z
modDatetime: 2026-06-11T11:33:49Z
...
1. Unplug the microwave or switch off the circuit breaker before any disassembly.
2. Press the door release button or handle and observe whether it has normal travel or feels stuck.
3. Check for visible damage to the door frame, bent door, or any obstruction around the latch area.
4. Remove the outer cover or control panel per your model to access the door release mechanism and latch assembly.
5. Inspect the door hook, latch, spring, release button, release lever, actuator, and switch holder for cracks, broken tabs, bent parts, or misalignment.
6. Check that the spring has proper tension and that the latch moves freely when you manually actuate the release lever or button mechanism.
7. Replace the broken or worn component (do not lubricate or force the door open).
8. Reassemble, restore power, and test the door release several times before normal use.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Door latch assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-microwave-door-wont-open&k=Door+latch+assembly&tag=errorcodefixes-20) \| Includes hook, latch, and sometimes the spring in one assembly |
| Door release button or handle | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-microwave-door-wont-open&k=Door+release+button+or+handle&tag=errorcodefixes-20) \| The external button and its internal springs |
| Door interlock switch holder | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-microwave-door-wont-open&k=Door+interlock+switch+holder&tag=errorcodefixes-20) \| Plastic bracket that holds switches and can bind the latch if cracked |
| Latch actuator or release lever | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-microwave-door-wont-open&k=Latch+actuator+or+release+lever&tag=errorcodefixes-20) \| The internal lever or actuator that moves the hook when the button is pressed |
