---
title: "Rinnai Water Heater Not Enough Hot Water - Causes & Fix"
description: "Usually too much simultaneous demand for the unit's capacity, low gas supply, or a dirty inlet filter restricting flow and heating output."
pubDatetime: 2026-06-01T19:13:09Z
modDatetime: 2026-06-01T19:13:09Z
...
1. Confirm the symptom at a single fixture with good flow and verify whether the unit display shows it is firing, the burner is running, and there are no active error codes or lockouts.
2. Check the temperature setpoint and calculate your demand in gallons per minute against the unit's rated capacity at your inlet water temperature to confirm the heater is not simply undersized for simultaneous fixture use.
3. Verify all gas shutoff valves are fully open, the gas type matches the unit nameplate, and supply pressure is adequate under firing load.
4. Remove and clean the inlet water filter or screen at the cold water inlet to the heater and inspect fixture aerators and showerheads for debris that could restrict flow.
5. Flush and descale the heat exchanger with manufacturer-approved descaling solution if the unit has been in service in hard water or if performance has gradually declined.
6. Check for hot-to-cold cross-connection by isolating fixture branches and verifying there is no backfeed between hot and cold lines through a bad mixing valve or cartridge.
7. Inspect the exhaust vent for blockage, confirm the fan is spinning freely and operating normally, and verify the combustion air intake is not obstructed.
8. Test or replace the flow sensor or turbine assembly if the unit shows intermittent hot water with no code and all mechanical restrictions and gas supply have been cleared.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Rinnai inlet filter / screen | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rinnai-water-heater-not-enough-hot-water&k=Rinnai+inlet+filter+%2F+screen&tag=errorcodefixes-20) \| Factory or aftermarket screen for cold water inlet |
| Tankless descaling flush kit | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rinnai-water-heater-not-enough-hot-water&k=Tankless+descaling+flush+kit&tag=errorcodefixes-20) \| Pump, hoses, and descaler for cleaning heat exchanger |
| Flow sensor / turbine assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rinnai-water-heater-not-enough-hot-water&k=Flow+sensor+%2F+turbine+assembly&tag=errorcodefixes-20) \| Model-specific replacement for intermittent flow detection |
