...
| Part | Notes |
|------|-------|
| Oil separator element | Primary PM item |
| Air filter element | Replace per service schedule |
| Oil filter | Replace with separator |
| Cooling fan capacitor | Common on single-phase fan motors |
| Discharge temperature sensor | Thermocouple or NTC type |
