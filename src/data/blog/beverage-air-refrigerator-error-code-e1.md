...
| Part | Notes |
|------|-------|
| NTC temperature probe | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-beverage-air-refrigerator-error-code-e1&k=NTC+temperature+probe&tag=errorcodefixes-20) \| Use OEM or exact resistance spec match |
| Probe wire harness | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-beverage-air-refrigerator-error-code-e1&k=Probe+wire+harness&tag=errorcodefixes-20) \| If wire is damaged beyond the probe itself |
| Electronic controller board | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-beverage-air-refrigerator-error-code-e1&k=Electronic+controller+board&tag=errorcodefixes-20) \| Last resort if probe/wire test good |
## When to Call a Pro
