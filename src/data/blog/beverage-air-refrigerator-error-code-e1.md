...
| Part | Notes |
|------|-------|
| NTC temperature probe | Use OEM or exact resistance spec match |
| Probe wire harness | If wire is damaged beyond the probe itself |
| Electronic controller board | Last resort if probe/wire test good |
