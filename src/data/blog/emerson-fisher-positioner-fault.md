...
| Part | Notes |
|------|-------|
| I/P module | Replace if drive current alarms persist |
| Position sensor | Replace on sensor failure alerts |
| Supply pressure regulator | Replace if supply pressure alarms occur |
| Packing set | Replace on high friction diagnostics |
