---
title: "Furnace Won't Ignite - 7 Causes and How to Fix Each"
description: "Your furnace is calling for heat but the burner will not light. Here are 7 causes from a bad igniter to a blocked condensate line, with step-by-step fixes."
...
- [Bad Hot Surface Igniter](#1-bad-hot-surface-igniter)
- [Dirty or Faulty Flame Sensor](#2-dirty-or-faulty-flame-sensor)
- [Gas Valve Not Opening](#3-gas-valve-not-opening)
- [Faulty Pressure Switch](#4-faulty-pressure-switch)
- [Thermostat Wiring or Signal Issues](#5-thermostat-wiring-or-signal-issues)
- [Control Board Failure](#6-control-board-failure)
- [Blocked Condensate Drain Line](#7-blocked-condensate-drain-line)
