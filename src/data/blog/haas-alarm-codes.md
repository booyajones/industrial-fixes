...
| Part | Notes |
|------|-------|
| Way lube oil | Mobil Vactra No. 2 (ISO 68) — 1 gallon |
| Spindle encoder coupling | Haas P/N for flexible disc coupling |
| ATC arm sensor | Proximity switch for arm home position |
| E-stop relay | Safety relay in control cabinet |
