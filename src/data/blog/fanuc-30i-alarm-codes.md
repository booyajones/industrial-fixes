...
| Part | Notes |
|---|---|
| Encoder battery | Prevents position loss |
| I/O link cable | Common issue in harsh cabinets |
| Servo amplifier | For persistent VRDY/overcurrent faults |
| Spindle interface board | OEM dependent |
