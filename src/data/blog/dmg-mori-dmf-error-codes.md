...
| Part | Notes |
|------|-------|
| Lube pump parts | [Amazon](https://www.amazon.com/s?k=Lube+pump+parts&tag=errorcodefixes-20) \| A common early failure point |
| Chiller service kit | [Amazon](https://www.amazon.com/s?k=Chiller+service+kit&tag=errorcodefixes-20) \| Spindle alarms often start here |
| Prox sensors | [Amazon](https://www.amazon.com/s?k=Prox+sensors&tag=errorcodefixes-20) \| ATC and position feedback faults |
| Hydraulic filters | [Amazon](https://www.amazon.com/s?k=Hydraulic+filters&tag=errorcodefixes-20) \| Cheap compared with the faults they prevent |
| Encoder cables | [Amazon](https://www.amazon.com/s?k=Encoder+cables&tag=errorcodefixes-20) \| Intermittent axis faults on aging machines |
| Battery / backup parts | [Amazon](https://www.amazon.com/s?k=Battery+%2F+backup+parts&tag=errorcodefixes-20) \| For control memory and PLC issues |
## When to Call a Pro
