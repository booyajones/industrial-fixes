---
title: "Rheem Water Heater Rusty Water - Causes & Fix"
description: "Rusty hot water usually means a depleted anode rod or internal tank corrosion. Replace the anode if possible, otherwise replace the unit."
pubDatetime: 2026-06-11T22:41:48Z
modDatetime: 2026-06-11T22:41:48Z
...
1. Run hot water only at a faucet and check if the discoloration appears, then run cold water only to confirm the rusty water is coming from the heater and not the supply line.
2. Inspect the base and sides of the water heater for visible rust, corrosion, or leaks, which indicate the tank itself is failing.
3. Drain and flush the tank to remove sediment buildup, then run hot water again to see if the discoloration clears.
4. Locate and inspect the anode rod (usually accessed through a hex plug on top of the tank) and replace it if it is heavily corroded or worn down to the core wire.
5. Check water pressure at a nearby fixture and verify it is within 40 to 60 psi, adjusting the pressure-reducing valve if needed.
6. Evaluate the age of the unit and whether rusty water persists after flushing and anode replacement, since Rheem says recurring issues in a 10 to 15 year old heater usually mean replacement is the better option.
7. If rust returns after maintenance or the tank shows internal corrosion or leaking, plan to replace the water heater rather than attempt further repairs.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Anode rod | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rheem-water-heater-rusty-water&k=Anode+rod&tag=errorcodefixes-20) \| Rheem recommends replacement every 3 to 4 years to protect the tank from corrosion. |
| Pressure relief valve (T&P valve) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rheem-water-heater-rusty-water&k=Pressure+relief+valve+%28T%26P+valve%29&tag=errorcodefixes-20) \| Inspect during maintenance, though not the direct cause of rusty water. |
