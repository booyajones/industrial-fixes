...
| Part | Notes |
|------|-------|
| Hot surface igniter | Match voltage (120V) and mounting style; OEM or quality aftermarket |
| Flame sensor rod | Replace if cleaning does not restore normal microamp signal |
| Gas valve | Replace only after confirming 24VAC input with no output |
