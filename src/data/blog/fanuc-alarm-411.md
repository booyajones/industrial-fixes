...
| Part | Notes |
|------|-------|
| Encoder feedback cable | Replace if cable shows any physical damage or intermittent continuity |
| Servo amplifier module | Replace when amplifier-side alarm code points to internal failure |
| Servo motor | Replace when encoder or motor winding tests confirm motor-side failure |
