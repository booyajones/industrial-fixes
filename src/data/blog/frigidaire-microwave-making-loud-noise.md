---
title: "Frigidaire Microwave Making Loud Noise - Causes & Fix"
description: "A worn or obstructed cooling fan motor is the most common cause. Unplug the unit, access the fan, and check for debris or binding."
pubDatetime: 2026-06-11T11:33:54Z
modDatetime: 2026-06-11T11:33:54Z
...
1. Unplug the microwave and remove the glass tray and roller ring to inspect for food debris or obstructions in the turntable cavity.
2. Clean the roller ring and turntable motor shaft area thoroughly with a damp cloth to remove any buildup or residue.
3. Manually rotate the turntable motor shaft (visible in the center of the cavity floor) to check for binding or rough movement that indicates wear.
4. Remove the outer cabinet panels to access the cooling fan motor, then spin the fan blades by hand to test for free rotation or grinding resistance.
5. If the fan does not spin freely or makes noise when turned, replace the cooling fan motor.
6. Discharge the high-voltage capacitor by shorting its terminals to the chassis with an insulated screwdriver, then use a multimeter to test magnetron continuity between the two terminals (should read 2 to 3 ohms).
7. If the magnetron shows infinite resistance, a short to ground, or the noise is a deep electrical buzz with weak heating, replace the magnetron.
8. Test the high-voltage diode with a multimeter in resistance mode, checking for continuity in one direction only (if it shows continuity both ways or none, replace it).

## Parts You Might Need

| Part | Notes |
|------|-------|
| Cooling Fan Motor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-microwave-making-loud-noise&k=Cooling+Fan+Motor&tag=errorcodefixes-20) \| Replacement motor for the magnetron cooling fan, typically accessible from the bottom or side panel. |
| Magnetron | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-microwave-making-loud-noise&k=Magnetron&tag=errorcodefixes-20) \| High-voltage component that generates microwaves, requires proper discharge procedure before removal. |
| High-Voltage Diode | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-microwave-making-loud-noise&k=High-Voltage+Diode&tag=errorcodefixes-20) \| Part of the voltage doubler circuit, located near the capacitor and magnetron. |
| Turntable Motor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-microwave-making-loud-noise&k=Turntable+Motor&tag=errorcodefixes-20) \| Small synchronous motor that rotates the glass tray, mounted under the cavity floor. |
