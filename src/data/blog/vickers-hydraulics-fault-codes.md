...
| Part | Notes |
|------|-------|
| Hydraulic filter element | Replace on bypass fault |
| Proportional solenoid coil | Replace on coil fault |
| Vickers EEA amplifier card | Replace on electronics failure |
| Thermostatic bypass valve | Common on high-temp faults |
| Pressure transducer | Replace on sensor fault |
