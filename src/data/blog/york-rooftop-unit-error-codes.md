...
| Part | Notes |
|---|---|
| Hot surface igniter | Silicon carbide — handle with gloves |
| Flame sensor | Measure µA output; replace below 1.5 µA |
| Limit switch | Match temperature rating |
| Run capacitor | Check µF before condemning motor |
| Pressure switch | High or low side — match setting |
| IFC board | York part number varies by model year |
