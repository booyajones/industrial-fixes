...
| Part | Notes |
|---|---|
| Hot surface igniter | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-york-rooftop-unit-error-codes&k=York+Hot+surface+igniter&tag=errorcodefixes-20) \| Silicon carbide — handle with gloves |
| Flame sensor | [Amazon](https://www.amazon.com/s?k=Flame+sensor&tag=errorcodefixes-20) \| Measure µA output; replace below 1.5 µA |
| Limit switch | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-york-rooftop-unit-error-codes&k=York+Limit+switch&tag=errorcodefixes-20) \| Match temperature rating |
| Run capacitor | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-york-rooftop-unit-error-codes&k=York+Run+capacitor&tag=errorcodefixes-20) \| Check µF before condemning motor |
| Pressure switch | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-york-rooftop-unit-error-codes&k=York+Pressure+switch&tag=errorcodefixes-20) \| High or low side — match setting |
