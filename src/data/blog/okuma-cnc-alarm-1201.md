...
| Part | Notes |
|------|-------|
| Spindle amplifier cooling fan | Match voltage and airflow; Okuma spindle drives use 24VDC fans typically |
| Cutting inserts / tooling | Replace any worn cutting edges before resuming operation |
| Spindle bearings | Replace if drag is confirmed via manual spindle rotation test |
