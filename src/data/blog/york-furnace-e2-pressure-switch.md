---
title: "York Furnace Error Code E2: Pressure Switch Fault Causes and Fix"
...
- **Cracked or disconnected pressure switch hose.** The small rubber tube between the inducer housing and the pressure switch can crack, collapse, or pull loose — causing a false open reading.
- **Failed inducer motor.** If the inducer is running slowly, seized, or not running at all, it will not create enough negative pressure to close the switch.
- **Failed pressure switch.** The diaphragm inside the switch can rupture or the contacts can fail, causing a stuck-open condition even with correct pressure.
- **Blocked flue or exhaust pipe.** Bird nests, ice, leaves, or debris blocking the PVC vent pipe prevent proper draft. The switch stays open because there is no airflow.
- **Cracked heat exchanger.** A cracked heat exchanger can disrupt the pressure differential across the switch. This is the serious cause — if confirmed, the furnace must be taken out of service.
