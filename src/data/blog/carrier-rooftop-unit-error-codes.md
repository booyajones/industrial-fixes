...
| Integrated control board | Model-specific — cross-reference by part number |
| Limit switch | Match temperature rating exactly |
| Inducer motor | Check capacitor before condemning motor |
| High-pressure switch | Check setting: 410A = 590 psi, R-22 = 380 psi |
| Run capacitor | Check µF with capacitor tester |
