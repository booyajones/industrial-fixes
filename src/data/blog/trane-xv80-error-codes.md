...
| Part | Notes |
|------|-------|
| Flame sensor | Common; cost ~$15–25 |
| Hot surface ignitor | Silicon nitride, 120V; confirm part for XV80 |
| ECM blower module | Fits behind the motor; test before replacing motor |
| Pressure switch | Match to inducer model and tubing port |
| Rollout switch | Investigate cause before replacing |
| Control board (IFC) | For repeated unexplained lockouts |
