...
| Part | Notes |
|------|-------|
| Motor (replacement) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-yaskawa-vfd-fault-gf&k=Motor+%28replacement%29&tag=errorcodefixes-20) \| Required if winding insulation tests below acceptable threshold |
| VFD-rated output cable (shielded) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-yaskawa-vfd-fault-gf&k=VFD-rated+output+cable+%28shielded%29&tag=errorcodefixes-20) \| Replace if any conductor shows insulation damage |
| Output reactor (line choke) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-yaskawa-vfd-fault-gf&k=Output+reactor+%28line+choke%29&tag=errorcodefixes-20) \| Install if GF is caused by long cable capacitive leakage |
## When to Call a Pro
