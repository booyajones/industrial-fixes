...
| Part | Notes |
|---|---|
| Run capacitor | Fan motor capacitor; check before replacing motor |
| Condenser fan motor | Match existing HP, RPM, and shaft diameter |
| Supply air sensor | NTC thermistor; causes Code 8 or freeze lockout |
| High-pressure switch | Spade terminal; 610 PSIG for R-410A |
| WeatherMaker control board | For Code 10; verify fuses first |
| Compressor contactor | Check contact gap and coil resistance |
