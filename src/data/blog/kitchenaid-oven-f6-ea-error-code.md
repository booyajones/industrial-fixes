...
description: "F6 EA means the control senses over-temperature or a wiring fault. Reset power for 1 minute, then check wiring and connectors."
pubDatetime: 2026-05-31T05:51:36Z
modDatetime: 2026-05-31T05:51:36Z
...
| Part | Notes |
|------|-------|
| User Interface Control Board | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-kitchenaid-oven-f6-ea-error-code&k=User+Interface+Control+Board&tag=errorcodefixes-20) \| Replace if the board itself is reporting false over-temp and wiring checks clean. |
| Appliance Manager Control or Converter Control | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-kitchenaid-oven-f6-ea-error-code&k=Appliance+Manager+Control+or+Converter+Control&tag=errorcodefixes-20) \| Required when the fault persists after wiring and sensor checks and power reset. |
| Oven Temperature Sensor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-kitchenaid-oven-f6-ea-error-code&k=Oven+Temperature+Sensor&tag=errorcodefixes-20) \| Order the sensor matched to your model number if resistance is out of spec. |
