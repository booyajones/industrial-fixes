...
# Navien NFC Combi Boiler Error Codes

Navien NFC series combination boilers provide both space heating and domestic hot water. Error codes display on the front panel LCD. The NFC shares error code structure with other Navien products, but some codes are unique to the combi configuration.
...
| Part | Notes |
|------|-------|
| Flame sensor | Clean first, replace if signal persists |
| Flow sensor | DHW and heating flow sensors differ |
| Heat exchanger | Expensive — descale first |
| Igniter | Check resistance before replacing |
| Fan assembly | Match NFC model voltage |
| Outlet temp sensor | Match sensor resistance specification |
