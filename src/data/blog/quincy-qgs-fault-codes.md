...
| Part | Notes |
|------|-------|
| Inlet air filter | Model-specific |
| Oil/separator element | Replace per service schedule |
| Quincy QGS oil | Synthetic — match model specification |
| Auto-drain solenoid | Check coil resistance |
| Temperature thermistor | NTC type — check resistance vs. temp chart |
| Motor overload relay | Match FLA setting |
