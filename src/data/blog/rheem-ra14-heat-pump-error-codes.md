...
| Control board (47-102684-83) | Fixes continuous-on or board faults | $80–$150 — [Search on Amazon](https://www.amazon.com/s?k=Rheem+heat+pump+control+board&tag=errorcodefixes-20) |
| Capacitor (dual run, 45/5 MFD) | Common cause of fan or compressor failure | $15–$35 — [Search on Amazon](https://www.amazon.com/s?k=dual+run+capacitor+45+5+MFD+heat+pump&tag=errorcodefixes-20) |
| Contactor (40A single-pole) | Fails when the compressor won't start | $20–$40 — [Search on Amazon](https://www.amazon.com/s?k=heat+pump+contactor+40+amp&tag=errorcodefixes-20) |
...
| 3A control board fuse | Fixes no-control faults from blown fuse | $5–$10 — [Search on Amazon](https://www.amazon.com/s?k=3+amp+glass+fuse+HVAC+control+board&tag=errorcodefixes-20) |
