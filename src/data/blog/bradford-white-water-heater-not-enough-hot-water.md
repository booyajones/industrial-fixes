---
title: "Bradford White Water Heater Not Enough Hot Water - Causes & Fix"
description: "Usually a thermostat set too low or a failed thermopile/gas valve on gas models. Raise the setting first, then test pilot output."
pubDatetime: 2026-06-11T22:46:53Z
modDatetime: 2026-06-11T22:46:53Z
...
- **Failed thermopile on standing-pilot gas models** The pilot lights but thermopile output is too weak to keep the gas valve energized for full burner operation.
- **Bad gas control valve or internal valve coil** Field troubleshooting has identified out-of-range coil resistance (pilot coil around 180 ohms in one example) leading to valve replacement.
- **Failed upper or lower thermistor sensor** Incorrect temperature sensing causes the control to shut down early or prevents proper firing cycles.
- **Gas supply or combustion air problem** Insufficient gas pressure, obstructed venting, blocked air intake, or rollout-switch trips limit burner run time.
- **Sediment scale reducing heat transfer** Buildup on the tank bottom or around elements slows recovery even when the heater fires normally.
- **Excess demand or undersized heater** The unit operates correctly but cannot supply enough volume for the household usage pattern.
...
| Part | Notes |
|------|-------|
| Thermopile assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-bradford-white-water-heater-not-enough-hot-water&k=Thermopile+assembly&tag=errorcodefixes-20) \| Standing-pilot gas models; replace if voltage output is below spec with pilot lit. |
| Gas control valve | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-bradford-white-water-heater-not-enough-hot-water&k=Gas+control+valve&tag=errorcodefixes-20) \| Replace when coil resistance is out of range or valve does not open despite good thermopile signal. |
| Thermistor sensor (upper or lower) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-bradford-white-water-heater-not-enough-hot-water&k=Thermistor+sensor+%28upper+or+lower%29&tag=errorcodefixes-20) \| Electronic control models; match sensor position and harness connector to your model. |
