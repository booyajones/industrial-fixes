---
title: "Frigidaire Oven Igniter Not Working - Causes & Fix"
description: "Most often a weak or failed hot surface igniter that no longer draws enough current to open the gas valve. Replace the igniter."
pubDatetime: 2026-06-01T18:47:54Z
modDatetime: 2026-06-01T18:47:54Z
...
1. Turn off power at the breaker and verify the breaker, cord, and outlet are delivering correct power to the range.
2. Start a bake cycle and observe whether the igniter glows, glows weakly, or stays completely off.
3. If the igniter does not glow at all, verify the control board is sending voltage to the bake igniter circuit with a multimeter.
4. Turn off power, pull the oven out, remove the bottom panel, and inspect the igniter, harness, and connectors for damage, scorching, or looseness.
5. Test igniter resistance with a multimeter (a good igniter typically reads 0 to 2 ohms, an open reading indicates failure).
6. Test igniter current draw with a clamp meter during a bake cycle (normal is about 3.0 to 3.6 amps, below 3.0 amps is suspect, and below 2.6 amps is considered failed).
7. With power removed, disconnect one lead from the safety valve and check the valve coil for continuity (open or infinite resistance indicates replacement is needed).
8. Replace the failed component found by testing (igniter first in the common weak-glow scenario, safety valve if current draw is correct but gas does not flow, or control board or harness if no voltage reaches the igniter), then reassemble, restore power, call for bake, and confirm the igniter glows strongly and the burner lights within roughly 1 to 2 minutes.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Hot surface igniter (Frigidaire gas range) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-oven-igniter-not-working&k=Hot+surface+igniter+%28Frigidaire+gas+range%29&tag=errorcodefixes-20) \| Match part number to your model, typical current draw 3.0–3.6 A when new. |
| Oven gas safety valve | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-oven-igniter-not-working&k=Oven+gas+safety+valve&tag=errorcodefixes-20) \| Replace if valve coil tests open or if igniter draws correct current but burner does not light. |
