...
| Part | Notes |
|------|-------|
| No parts typically needed | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-yaskawa-vfd-fault-bb&k=No+parts+typically+needed&tag=errorcodefixes-20) \| BB is a control signal issue, not a hardware failure |
| Terminal block or wiring | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-yaskawa-vfd-fault-bb&k=Terminal+block+or+wiring&tag=errorcodefixes-20) \| If the baseblock input terminal is damaged or wiring has failed |
## When to Call a Pro
