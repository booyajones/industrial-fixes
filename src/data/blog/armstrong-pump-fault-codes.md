...
| Part | Notes |
|------|-------|
| Drive assembly | Armstrong-specific VFD — contact Armstrong |
| Pressure sensor | Differential pressure transducer |
| Motor seal kit | Annual replacement on higher-flow models |
| Impeller | Match pump model and size |
| Y-strainer basket | Clean or replace — prevents F11 and F12 |
