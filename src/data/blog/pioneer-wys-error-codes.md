...
| Indoor temperature sensor | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-pioneer-wys-error-codes&k=Pioneer+Indoor+temperature+sensor&tag=errorcodefixes-20) \| F1 fault; confirm room temp sensor vs. coil sensor |
...
| Indoor fan motor | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-pioneer-wys-error-codes&k=Pioneer+Indoor+fan+motor&tag=errorcodefixes-20) \| DC type; test before replacing PCB |
