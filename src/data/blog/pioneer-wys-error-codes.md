...
| Part | Notes |
|------|-------|
| Signal cable (3-conductor) | Replace full run if damaged during installation |
| Indoor temperature sensor | F1 fault; confirm room temp sensor vs. coil sensor |
| Indoor coil sensor | F2 fault; clip-on type on evaporator U-bend |
| Outdoor PCB | For P0 or E6 after other causes ruled out |
| Indoor fan motor | DC type; test before replacing PCB |
| Capacitor (outdoor fan) | On older WYS models with AC fan motor |
