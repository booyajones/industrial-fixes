---
title: "Rheem Furnace Won't Turn On - Causes & Fix"
description: "Most often a dirty flame sensor or air filter causing the unit to lock out on ignition failure, flame loss, or limit trip."
pubDatetime: 2026-06-01T19:03:18Z
modDatetime: 2026-06-01T19:03:18Z
...
- **Restricted airflow from dirty filter or blocked return** Low airflow causes the furnace to overheat and trip the high-limit switch (code 22), shutting down the unit to prevent damage.
- **Blocked intake or vent piping, weak inducer, or pressure-switch tubing obstruction** Inadequate draft or combustion-air flow prevents the pressure switch from closing, resulting in codes 45 or 46 and no ignition sequence.
- **Gas supply problems** Closed manual gas valve, low inlet pressure, or failed gas valve prevents burners from lighting, causing code 11 ignition failure or code 13 flame loss.
- **Rollout or combustion safety trip** Blocked flue, heat exchanger cracks, or excessive manifold pressure cause flame rollout and open the rollout switch (code 33), indicating an unsafe condition.
- **Reversed polarity or wiring issues** Incorrect line voltage wiring, poor ground connection, or loose thermostat wiring can prevent the board from operating or cause intermittent lockouts.
- **Blower or control board fault** Failed blower motor or internal board failure (codes 61 or 93) stops the furnace from completing its safety checks and starting the heating cycle.
...
| Part | Notes |
|------|-------|
| Flame sensor rod | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rheem-furnace-wont-turn-on&k=Flame+sensor+rod&tag=errorcodefixes-20) \| Inexpensive rod that sits in the burner flame, commonly replaced if cleaning does not restore proper flame sense. |
| Furnace air filter | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rheem-furnace-wont-turn-on&k=Furnace+air+filter&tag=errorcodefixes-20) \| Match the size and MERV rating to your unit, replace every 1–3 months depending on usage and dust load. |
| Pressure switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rheem-furnace-wont-turn-on&k=Pressure+switch&tag=errorcodefixes-20) \| Diaphragm switch that proves draft, replace if tubing and vent are clear but switch will not close at correct draft pressure. |
