...
| Part | Notes |
|------|-------|
| Igniter/electrode assembly | [Amazon](https://www.amazon.com/s?k=Igniter%2Felectrode+assembly&tag=errorcodefixes-20) \| Navien 30004277A (NCB series) or model-specific — verify |
| Gas valve | [Amazon](https://www.amazon.com/s?k=Gas+valve&tag=errorcodefixes-20) \| Replace only if confirmed — 24V at valve terminals, no gas output |
| Fan pressure switch | [Amazon](https://www.amazon.com/s?k=Fan+pressure+switch&tag=errorcodefixes-20) \| Test if fan runs but E002 persists without ignition attempt |
## When to Call a Pro
