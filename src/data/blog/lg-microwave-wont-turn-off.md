---
title: "LG Microwave Won't Turn Off - Causes & Fix"
description: "Usually a stuck Cancel/Off button or shorted relay on the main control board. Power-cycle the unit and check the control panel first."
pubDatetime: 2026-06-11T11:29:35Z
modDatetime: 2026-06-11T11:29:35Z
...
| Part | Notes |
|------|-------|
| Main control board | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lg-microwave-wont-turn-off&k=Main+control+board&tag=errorcodefixes-20) \| Controls all microwave functions, replace if relays or triacs are shorted and loads stay on after shutdown. |
| User control and display board | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lg-microwave-wont-turn-off&k=User+control+and+display+board&tag=errorcodefixes-20) \| The touchpad and interface assembly, replace if the Cancel/Off button does not respond or send the stop command. |
| Door interlock switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lg-microwave-wont-turn-off&k=Door+interlock+switch&tag=errorcodefixes-20) \| Safety switches that detect door closure, replace any that fail the continuity test with the door closed. |
