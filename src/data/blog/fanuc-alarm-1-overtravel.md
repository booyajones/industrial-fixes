...
| Part | Notes |
|------|-------|
| Hardware overtravel limit switch | Replace if switch is damaged or producing false signals |
| Switch mounting bracket | Replace if bracket is bent and mis-positioning the switch |
