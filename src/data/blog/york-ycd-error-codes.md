...
| Condenser fan motor | Match tonnage — 3-ton and 5-ton use different motors |
| High-pressure switch | 610 PSIG cutout for R-410A |
| Low-pressure switch | 50 PSIG cutout |
| Discharge air sensor | NTC thermistor; check resistance at known temperature |
| Unit controller board | For persistent communication or sensor faults |
