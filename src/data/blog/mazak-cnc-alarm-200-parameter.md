...
| Part | Notes |
|------|-------|
| CMOS backup battery | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-mazak-cnc-alarm-200-parameter&k=CMOS+backup+battery&tag=errorcodefixes-20) \| Replace if battery-backed parameter loss is the cause |
## When to Call a Pro
