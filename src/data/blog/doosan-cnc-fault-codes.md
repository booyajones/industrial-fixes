...
| Part | Notes |
|------|-------|
| Hydraulic filter | [Amazon](https://www.amazon.com/s?k=Hydraulic+filter&tag=errorcodefixes-20) \| Replace on pressure alarm |
| Spindle oil | [Amazon](https://www.amazon.com/s?k=Spindle+oil&tag=errorcodefixes-20) \| Fill to correct level |
| Turret position sensor | [Amazon](https://www.amazon.com/s?k=Turret+position+sensor&tag=errorcodefixes-20) \| Check on turret fault alarms |
| ATC servo motor | [Amazon](https://www.amazon.com/s?k=ATC+servo+motor&tag=errorcodefixes-20) \| Check on persistent ATC faults |
## Jump to Fix
