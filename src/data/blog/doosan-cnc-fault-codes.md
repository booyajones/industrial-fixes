...
| Part | Notes |
|------|-------|
| Hydraulic filter | Replace on pressure alarm |
| Spindle oil | Fill to correct level |
| Turret position sensor | Check on turret fault alarms |
| ATC servo motor | Check on persistent ATC faults |
