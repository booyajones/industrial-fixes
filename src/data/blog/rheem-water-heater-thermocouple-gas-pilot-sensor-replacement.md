---
title: "Rheem Water Heater Thermocouple Replacement - Signs & How-To"
description: "Pilot won't stay lit, keeps going out, or won't light at all? Replace the thermocouple (pilot sensor) to restore the flame signal to your gas valve."
pubDatetime: 2026-06-01T21:33:01Z
modDatetime: 2026-06-01T21:33:01Z
author: "Marcus Webb"
featured: false
draft: false
tags:
...
- **Pilot lights but goes out as soon as you release the button** The thermocouple is not generating enough signal to keep the gas valve open.
- **Pilot flame is weak, yellow, or flickering** A dirty pilot orifice or failing thermocouple tip can cause an unstable flame that won't heat the sensor properly.
- **Pilot goes out repeatedly after running fine** Intermittent thermocouple failure or loose connections interrupt the flame signal.
- **Pilot will not light at all** A completely failed thermocouple or blocked pilot tube prevents any gas flow to the pilot.
- **Soot or corrosion visible on the thermocouple tip** Contamination on the sensor tip blocks heat transfer and reduces millivolt output.
- **Gas control valve clicks or hisses but pilot does not stay on** The valve is trying to hold but the thermocouple signal is too weak or missing.
...
| Part | Notes |
|------|-------|
| Rheem thermocouple (pilot sensor) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rheem-water-heater-thermocouple-gas-pilot-sensor-replacement&k=Rheem+thermocouple+%28pilot+sensor%29&tag=errorcodefixes-20) \| Find your model and serial number on the label on the side of the water heater tank. Order the thermocouple by that model number or measure the length of your old thermocouple lead to match the replacement. |
| Burner door gasket | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rheem-water-heater-thermocouple-gas-pilot-sensor-replacement&k=Burner+door+gasket&tag=errorcodefixes-20) \| Replace if you removed the burner assembly during disassembly, as recommended in Rheem service procedures. |
