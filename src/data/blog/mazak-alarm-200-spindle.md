...
| Part | Notes |
|------|-------|
| Spindle drive belt | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-mazak-alarm-200-spindle&k=Spindle+drive+belt&tag=errorcodefixes-20) \| Match length, width, and tooth profile to the original |
| Spindle encoder | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-mazak-alarm-200-spindle&k=Spindle+encoder&tag=errorcodefixes-20) \| Mazak model-specific; order through Mazak or an authorized Mazak dealer |
| Spindle drive (inverter) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-mazak-alarm-200-spindle&k=Spindle+drive+%28inverter%29&tag=errorcodefixes-20) \| If drive faults are confirmed and the drive cannot be repaired |
## When to Call a Pro
