...
| Part | Notes |
|------|-------|
| Pressure switch | Match exact setpoint — Lennox 90%+ units commonly use −0.6" or −1.0" W.C. |
| Pressure switch hose | Cheap; replace any hose that's cracked, brittle, or clogged |
| Inducer housing gasket | Required if housing is leaking at the mounting interface |
