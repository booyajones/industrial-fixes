...
| Part | Notes |
|------|-------|
| Servo amplifier (Mazatrol) | Replace on persistent servo alarms |
| Spindle encoder | Replace on spindle speed/comm alarms |
| Hydraulic filter | Replace on low pressure alarms |
| ATC cam follower | Inspect on ATC mechanical faults |
