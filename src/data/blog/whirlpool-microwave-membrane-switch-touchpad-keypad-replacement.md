---
title: "Whirlpool Microwave Touchpad/Keypad Replacement - Signs & How-To"
description: "Unresponsive buttons, stuck keys, or touchpad error codes mean your membrane switch has failed. Replacing the touchpad assembly fixes it."
pubDatetime: 2026-06-01T21:27:44Z
modDatetime: 2026-06-01T21:27:44Z
...
- **One or more buttons do not respond when pressed** You press Start, Stop, or number keys and the microwave does not beep or register the input.
- **Touchpad error code displayed** The display shows a keypad-related error code and the control panel is locked out or unresponsive.
- **Buttons feel mushy or stuck in place** Certain keys no longer have the normal crisp tactile response and may stay depressed or feel soft.
- **Random or ghost inputs** The microwave beeps or starts functions on its own without you touching any button.
- **Intermittent control response** Buttons work sometimes but fail at other times, or you have to press very hard to get any response.
- **Display lights up but no buttons work** The clock or display panel is functioning normally, but the entire keypad is completely dead.
...
| Part | Notes |
|------|-------|
| Membrane switch / touchpad keypad assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-whirlpool-microwave-membrane-switch-touchpad-keypad-replacement&k=Membrane+switch+%2F+touchpad+keypad+assembly&tag=errorcodefixes-20) \| Model-specific part. Use the model and serial number from the plate inside the door frame or on the back panel to look up the exact touchpad assembly for your Whirlpool microwave. |
