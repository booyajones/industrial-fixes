...
| Outdoor ambient temperature sensor | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-lennox-xp20-heat-pump-error-codes&k=Lennox+Outdoor+ambient+temperature+sensor&tag=errorcodefixes-20) | Fixes E 180. 10K ohm thermistor. |
| Outdoor coil temperature sensor | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-lennox-xp20-heat-pump-error-codes&k=Lennox+Outdoor+coil+temperature+sensor&tag=errorcodefixes-20) | Fixes E 416. Check resistance against spec before replacing. |
| Liquid line temperature sensor | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-lennox-xp20-heat-pump-error-codes&k=Lennox+Liquid+line+temperature+sensor&tag=errorcodefixes-20) | Fixes E 424. |
| High pressure switch | [View on Amazon](https://www.amazon.com/dp/B013IHQ8CU?ascsubtag=ecf-lennox-xp20-heat-pump-error-codes&tag=errorcodefixes-20) | Related to E 412, E 413. Verify the switch itself before assuming a refrigerant problem. |
| Low pressure switch | [View on Amazon](https://www.amazon.com/dp/B013J2J97A?ascsubtag=ecf-lennox-xp20-heat-pump-error-codes&tag=errorcodefixes-20) | Related to E 410, E 411. Test switch continuity before replacing. |
