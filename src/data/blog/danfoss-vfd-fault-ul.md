...
| Part | Notes |
|------|-------|
| Drive belt (V-belt or synchronous) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-danfoss-vfd-fault-ul&k=Drive+belt+%28V-belt+or+synchronous%29&tag=errorcodefixes-20) \| Match pitch and length to OEM specification |
| Flexible coupling insert | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-danfoss-vfd-fault-ul&k=Flexible+coupling+insert&tag=errorcodefixes-20) \| Replace spider/element if coupling is used |
| Pump foot valve or check valve | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-danfoss-vfd-fault-ul&k=Pump+foot+valve+or+check+valve&tag=errorcodefixes-20) \| If pump repeatedly loses prime |
## When to Call a Pro
