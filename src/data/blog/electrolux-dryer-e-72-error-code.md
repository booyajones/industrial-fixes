...
description: "E72 means the outlet thermistor is out of range. Usually caused by a failed NTC sensor or loose wiring. Check connections first."
pubDatetime: 2026-05-31T03:54:52Z
modDatetime: 2026-05-31T03:54:52Z
author: "Marcus Webb"
featured: false
draft: false
tags:
...
- **Failed outlet thermistor** The NTC sensor at the outlet duct has drifted out of specification or failed open or shorted.
- **Loose or disconnected wiring harness** The connector at the thermistor probe or at the control board has backed out or lost contact.
- **Damaged harness or connector pins** Wiring insulation is cut, conductors are broken, or terminals are corroded or burned.
- **Poor connector contact** Oxidation or vibration has caused intermittent connection at either end of the sensor circuit.
- **Control board sensor-input failure** If sensor and wiring test good, the control's thermistor input circuitry may be faulty.
...
| Part | Notes |
|------|-------|
| Outlet thermistor / outlet NTC sensor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-electrolux-dryer-e-72-error-code&k=Outlet+thermistor+%2F+outlet+NTC+sensor&tag=errorcodefixes-20) \| Match the part number stamped on your original sensor or use your dryer's model number to cross-reference. |
| Thermistor wiring harness | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-electrolux-dryer-e-72-error-code&k=Thermistor+wiring+harness&tag=errorcodefixes-20) \| Order if connectors are melted or wire is cut. Some manufacturers sell the sensor and harness as an assembly. |
| Main control board | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-electrolux-dryer-e-72-error-code&k=Main+control+board&tag=errorcodefixes-20) \| Only required if sensor and harness test good but E72 persists. Verify your model number before ordering. |
