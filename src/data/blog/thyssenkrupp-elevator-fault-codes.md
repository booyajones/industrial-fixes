...
| Part | Notes |
|------|-------|
| Door contact (mechanical) | Replace when worn |
| Door operator belt/coupling | Replace on door fault |
| Encoder | Replace on feedback fault |
| Brake coil | Replace on drag or release fault |
| Drive module | Replace on repeated drive faults |
