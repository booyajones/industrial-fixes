...
| Part | Notes |
|------|-------|
| FAPT/FSP detector head | [Amazon](https://www.amazon.com/s?k=FAPT%2FFSP+detector+head&tag=errorcodefixes-20) \| Replace on dirty or failed head |
| 12V sealed lead-acid battery | [Amazon](https://www.amazon.com/s?k=12V+sealed+lead-acid+battery&tag=errorcodefixes-20) \| Replace as a pair on 24V systems |
| End-of-line resistor EOLR-1 | [Amazon](https://www.amazon.com/s?k=End-of-line+resistor+EOLR-1&tag=errorcodefixes-20) \| Required on NAC circuits |
| SLC isolator module | [Amazon](https://www.amazon.com/s?k=SLC+isolator+module&tag=errorcodefixes-20) \| Install if ground fault isolation needed |
## Jump to Fix
