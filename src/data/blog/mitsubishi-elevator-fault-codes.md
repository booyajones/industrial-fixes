...
| Part | Notes |
|------|-------|
| Door contact (dual-channel) | Replace when worn |
| Door operator card | Replace on door logic fault |
| Brake monitoring switch | Replace on brake fault |
| FR-series inverter board | Replace on persistent E-faults |
| Encoder | Replace on encoder fault |
