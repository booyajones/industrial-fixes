...
| Part | Notes |
|------|-------|
| Communication wire (18 AWG, 4-conductor) | Replace damaged runs; use shielded wire in high-interference environments |
| Air handler control board | Replace if communication module confirmed dead |
| Outdoor unit control board | Replace if isolation test confirms outdoor unit is generating the ER |
| ComfortLink II thermostat | Replace if thermostat is source of bus failure |
