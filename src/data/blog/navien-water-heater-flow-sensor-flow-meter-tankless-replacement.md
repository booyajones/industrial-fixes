---
title: "Navien Flow Sensor Replacement - Signs & How-To"
description: "Flow-sensor faults, no ignition on hot-water demand, error codes, or intermittent burner firing mean your sensor is clogged or failed. Replacing it restores flow detection and burner control."
pubDatetime: 2026-06-01T21:37:04Z
modDatetime: 2026-06-01T21:37:04Z
author: "Marcus Webb"
featured: false
draft: false
tags:
...
| Part | Notes |
|------|-------|
| Navien flow sensor assembly (flow meter) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-navien-water-heater-flow-sensor-flow-meter-tankless-replacement&k=Navien+flow+sensor+assembly+%28flow+meter%29&tag=errorcodefixes-20) \| Model-specific. Find your exact part number on the unit's rating plate (model and serial number) and cross-reference with Navien parts diagrams or contact a Navien-certified service provider for the correct sensor for your chassis series. |
| Flow-sensor O-ring or gasket kit | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-navien-water-heater-flow-sensor-flow-meter-tankless-replacement&k=Flow-sensor+O-ring+or+gasket+kit&tag=errorcodefixes-20) \| Often included with the sensor assembly. If sold separately, verify size and material from your unit's service manual or parts list. |
