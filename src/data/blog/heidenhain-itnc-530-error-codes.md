...
| Part | Notes |
|------|-------|
| Encoder read head | HEIDENHAIN-specific — match scale graduation |
| Encoder cable | Shielded — check at connectors first |
| SERCOS fiber optic cable | Inspect connectors for contamination |
| Compact Flash card | CF card stores iTNC software — backup before replacing |
| Safety relay | Match HEIDENHAIN safety circuit module |
