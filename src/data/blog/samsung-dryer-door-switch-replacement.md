---
title: "Samsung Dryer Door Switch Replacement - Signs & How-To"
description: "Dryer won't start with door closed or drum light stays on. Replacing the door jamb switch restores the closed-door signal to the control board."
pubDatetime: 2026-06-01T15:58:41Z
modDatetime: 2026-06-01T15:58:41Z
...
- **Dryer will not start when you press the start button** The control board inhibits tumble operation when the door-switch circuit does not show a closed-door condition.
- **Dryer stops immediately when door is fully closed** Intermittent contact inside the switch can cause the control to see the door as open even when latched.
- **Drum light stays on with door closed** On models with a drum light, the switch also controls the light circuit, so a faulty switch may leave the light illuminated.
- **Door latch feels normal but dryer shows door-open error** The latch and door strike can work perfectly but a dead switch will still prevent the control from recognizing a closed door.
- **You hear the control beep or display lights up but drum does not turn** Power reaches the control but the start relay will not energize the motor until the door-switch circuit closes.
- **Continuity does not change across switch terminals when you press the plunger manually** With the harness disconnected and a multimeter set to continuity, the switch should toggle between open and closed as you actuate the plunger.
...
| Part | Notes |
|------|-------|
| Samsung dryer door switch (door jamb switch) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-dryer-door-switch-replacement&k=Samsung+dryer+door+switch+%28door+jamb+switch%29&tag=errorcodefixes-20) \| Samsung genuine part DC64-00828B or DC64-00828A. Check your model and serial number on the tag inside the door opening or on the rear panel to confirm fitment before ordering. |
