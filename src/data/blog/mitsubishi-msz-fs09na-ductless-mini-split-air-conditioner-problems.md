---
title: "Mitsubishi MSZ-FS09NA Problems & Error Codes"
description: "Indoor fan motor failure is the most common problem on the MSZ-FS09NA. Turn off power, check for obstructions, then use failure mode recall to identify the stored code."
pubDatetime: 2026-06-01T17:27:30Z
modDatetime: 2026-06-01T17:27:30Z
...
| Part | Notes |
|------|-------|
| Indoor fan motor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-mitsubishi-msz-fs09na-ductless-mini-split-air-conditioner-problems&k=Indoor+fan+motor&tag=errorcodefixes-20) \| Most common failure on the FS09NA when the indoor fan does not operate |
| Indoor control PCB | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-mitsubishi-msz-fs09na-ductless-mini-split-air-conditioner-problems&k=Indoor+control+PCB&tag=errorcodefixes-20) \| Fails when the motor and wiring are good but the fan is still not driven |
| Indoor blower assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-mitsubishi-msz-fs09na-ductless-mini-split-air-conditioner-problems&k=Indoor+blower+assembly&tag=errorcodefixes-20) \| Replaced when the fan wheel is physically damaged or obstructed beyond cleaning |
| Motor wiring harness and connectors | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-mitsubishi-msz-fs09na-ductless-mini-split-air-conditioner-problems&k=Motor+wiring+harness+and+connectors&tag=errorcodefixes-20) \| Corroded or loose connections between the motor and control board prevent fan operation |
