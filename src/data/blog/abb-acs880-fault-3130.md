...
| Part | Notes |
|------|-------|
| Input fuses (semiconductor type) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-abb-acs880-fault-3130&k=Input+fuses+%28semiconductor+type%29&tag=errorcodefixes-20) \| ACS880 requires gR or aR semiconductor fuses — not standard HRC fuses |
| Input contactor | [Amazon](https://www.amazon.com/dp/B0CJFZQVPT?ascsubtag=ecf-abb-acs880-fault-3130&tag=errorcodefixes-20) \| Match voltage and current rating for the ACS880 frame size |
| Input cable lugs | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-abb-acs880-fault-3130&k=Input+cable+lugs&tag=errorcodefixes-20) \| Use the torque-rated lugs specified in the ACS880 hardware manual |
## When to Call a Pro
