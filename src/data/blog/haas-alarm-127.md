...
| Part | Notes |
|------|-------|
| Unclamp switch | [Amazon](https://www.amazon.com/s?k=Unclamp+switch&tag=errorcodefixes-20) \| Common on intermittent faults |
| Solenoid valve / coil | [Amazon](https://www.amazon.com/s?k=Solenoid+valve+%2F+coil&tag=errorcodefixes-20) \| Check voltage and air output |
| Pull stud | [Amazon](https://www.amazon.com/s?k=Pull+stud&tag=errorcodefixes-20) \| Replace damaged or incorrect styles |
