---
title: "GE Gas Range Spark Electrode Replacement - Signs & How-To"
description: "Burner clicks but won't light, continuous clicking, weak or no spark at one burner. Replacing the spark electrode restores ignition."
pubDatetime: 2026-06-01T21:08:04Z
modDatetime: 2026-06-01T21:08:04Z
...
- **Burner clicks but won't light** You hear the rapid clicking sound but no flame appears at that burner.
- **Continuous clicking after flame should start** The igniter keeps clicking even after you release the knob or the burner should have lit.
- **Weak or intermittent spark** You see a dim orange spark or no visible spark at the electrode tip when the burner clicks.
- **One burner won't ignite, others work fine** The problem is isolated to a single burner position while the rest of the cooktop lights normally.
- **Visible cracks or damage to the white ceramic insulator** The ceramic sleeve around the electrode wire is chipped, cracked, or broken off.
- **Loose or corroded electrode wire connection** The wire terminal at the base of the electrode is loose, burned, or shows green corrosion.
...
| Part | Notes |
|------|-------|
| GE range spark igniter surface burner electrode | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-oven-spark-electrode-igniter-gas-surface-burner-electrode-replacement&k=GE+range+spark+igniter+surface+burner+electrode&tag=errorcodefixes-20) \| Part number varies by model. Common numbers include WB13K18 and WB13K10014. Find your exact part by locating the model and serial number plate inside the oven door frame or on the back of the range and checking the GE parts catalog or an authorized parts supplier. |
