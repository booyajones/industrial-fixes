---
title: "Hoshizaki KM-515 Error Codes — Fix Guide"
...
| Part | Notes |
|------|-------|
| Hot gas bypass valve | E2 fix — test coil resistance first |
| Hoshizaki Scale Away cleaner | Quarterly |
| Condenser fan motor | Replace if not running |
