...
| Part | Notes |
|------|-------|
| SSCNET III/H fiber cable | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-mitsubishi-cnc-alarm-y96&k=SSCNET+III%2FH+fiber+cable&tag=errorcodefixes-20) \| Replace if bent or damaged |
| Servo motor encoder cable | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-mitsubishi-cnc-alarm-y96&k=Servo+motor+encoder+cable&tag=errorcodefixes-20) \| Replace if signal loss is detected |
| MDS-E/EH servo drive | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-mitsubishi-cnc-alarm-y96&k=MDS-E%2FEH+servo+drive&tag=errorcodefixes-20) \| Replace if drive internal fault is confirmed |
## When to Call a Pro
