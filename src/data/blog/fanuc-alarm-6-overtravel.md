...
| Part | Notes |
|------|-------|
| [Overtravel limit switch](https://www.amazon.com/s?k=Overtravel%20limit%20switch&tag=errorcodefixe-20) | OMRON or equivalent; match the NC (normally closed) contact rating |
| [Limit switch mounting bracket](https://www.amazon.com/s?k=Limit%20switch%20mounting%20bracket&tag=errorcodefixe-20) | Replace if the switch was physically displaced |
