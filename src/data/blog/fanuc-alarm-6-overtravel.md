...
| Part | Notes |
|------|-------|
| Overtravel limit switch | OMRON or equivalent; match the NC (normally closed) contact rating |
| Limit switch mounting bracket | Replace if the switch was physically displaced |
