---
title: "LG LSU120HSV5 Ductless Mini Split Problems & Error Codes"
description: "CH 05 communication error is most common on LSU120HSV5, usually caused by loose interconnect wiring or defective indoor/outdoor PCB."
pubDatetime: 2026-06-01T17:29:00Z
modDatetime: 2026-06-01T17:29:00Z
...
| Part | Notes |
|------|-------|
| Indoor PCB (main indoor control board) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lg-lsu120hsv5-ductless-mini-split-air-conditioner-problems&k=Indoor+PCB+%28main+indoor+control+board%29&tag=errorcodefixes-20) \| Fails after communication circuit damage or power surge, diagnosed after wiring and voltage checks confirm no external faults. |
| Outdoor PCB (main outdoor control board) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lg-lsu120hsv5-ductless-mini-split-air-conditioner-problems&k=Outdoor+PCB+%28main+outdoor+control+board%29&tag=errorcodefixes-20) \| Common failure point for CH 05 communication errors and compressor control faults, requires supply voltage verification before replacement. |
| Outdoor fan motor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lg-lsu120hsv5-ductless-mini-split-air-conditioner-problems&k=Outdoor+fan+motor&tag=errorcodefixes-20) \| Bearings wear in high-use climates, causing noise and reduced airflow across the condenser coil. |
| Compressor start capacitor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lg-lsu120hsv5-ductless-mini-split-air-conditioner-problems&k=Compressor+start+capacitor&tag=errorcodefixes-20) \| Degrades over time and prevents compressor startup while outdoor fan continues to run. |
