...
| Part | Notes |
|------|-------|
| Indoor fan motor | Model-specific; note motor winding resistance |
| Outdoor fan motor | DC inverter motor with Hall sensor |
| Indoor PCB | Fujitsu 9709481xxx — match model |
| Indoor air thermistor | Small NTC thermistor, 10 kΩ at 25°C |
