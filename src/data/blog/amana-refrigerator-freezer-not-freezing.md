---
title: "Amana Refrigerator Freezer Not Freezing - Causes & Fix"
description: "Dirty condenser coils are the most common reason an Amana freezer stops cooling. Clean the coils and check the condenser fan motor."
pubDatetime: 2026-06-09T23:24:30Z
modDatetime: 2026-06-09T23:24:30Z
...
- **Condenser fan motor failure** A failed condenser fan cannot pull air through the coils, which reduces cooling performance and can prevent the freezer from reaching temperature.
- **Evaporator fan motor failure** If the evaporator fan does not run, cold air cannot circulate from the evaporator into the freezer and refrigerator compartments.
- **Failed start relay or start capacitor** A bad start relay or capacitor at the compressor can prevent the compressor from starting or cause it to run intermittently.
- **Defrost system failure or airflow blockage** When the defrost system fails, ice builds up on the evaporator and blocks airflow, causing warm temperatures even though the compressor runs.
- **Thermistor or control board fault** A faulty thermistor or temperature control board can misread cabinet temperature or fail to send proper voltage to the compressor and fans.
- **Power supply or control settings problem** Amana lists unplugged units, tripped breakers, bad outlets, showroom mode, or controls turned off as first-check causes for no cooling.
...
| Part | Notes |
|------|-------|
| Condenser fan motor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-amana-refrigerator-freezer-not-freezing&k=Condenser+fan+motor&tag=errorcodefixes-20) \| Pulls air through the condenser coils to reject heat. |
| Evaporator fan motor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-amana-refrigerator-freezer-not-freezing&k=Evaporator+fan+motor&tag=errorcodefixes-20) \| Circulates cold air from the evaporator into the cabinet. |
| Start relay and start capacitor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-amana-refrigerator-freezer-not-freezing&k=Start+relay+and+start+capacitor&tag=errorcodefixes-20) \| Mounted on the compressor to help it start reliably. |
| Thermistor (temperature sensor) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-amana-refrigerator-freezer-not-freezing&k=Thermistor+%28temperature+sensor%29&tag=errorcodefixes-20) \| Reports cabinet temperature to the control board. |
