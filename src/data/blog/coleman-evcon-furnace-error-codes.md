...
| Part | Notes |
|---|---|
| HSI igniter — silicon carbide | Fragile; handle by wire leads only |
| Flame sensor | Clean with fine steel wool; rod-type |
| Pressure switch | Check hose first; Coleman-brand switches are direct replacements |
| Blower capacitor | Single-run capacitor on PSC motor |
| High-limit switch | Check reset type — most Coleman are auto-reset |
