...
| Part | Notes |
|------|-------|
| Magazine position proximity switch | Replace if position count is unreliable |
| Magazine drive motor | Replace if stalling confirmed |
| Tool pocket | Replace damaged pockets |
