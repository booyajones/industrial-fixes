---
title: "Rheem Furnace Igniter Not Working - Causes & Fix"
description: "Most often the igniter element has cracked or failed open. Test it with a multimeter at the leads for continuity and replace if open."
pubDatetime: 2026-06-01T19:03:58Z
modDatetime: 2026-06-01T19:03:58Z
author: "Marcus Webb"
featured: false
draft: false
tags:
...
1. Verify the thermostat is calling for heat and confirm that the furnace has power at the service switch and breaker.
2. Check that the access panel or blower door is fully seated so the door safety switch is closed and the control circuit is enabled.
3. Identify whether your Rheem furnace uses a hot surface igniter or a spark igniter by inspecting the burner compartment.
4. Observe the ignition sequence and note whether the igniter glows or sparks, whether the gas valve clicks, and whether the burners light.
5. Test the hot surface igniter with a multimeter at the igniter leads (disconnect power first). An open or infinite reading means the igniter has failed and must be replaced.
6. If the igniter glows but the burners do not light, verify the gas cock is open and gas is supplied to the furnace, then check for a failed gas valve or tripped rollout switch.
7. Inspect the flame sensor rod for heavy soot or corrosion and clean it with fine sandpaper if the burners light briefly then shut off.
8. Check for a soft lockout condition by turning off power to the furnace for one minute, then restore power and try a new call for heat. If the fault persists, inspect the control board and wiring for damage or loose connections.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Hot surface igniter (Rheem OEM or compatible) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rheem-furnace-igniter-not-working&k=Hot+surface+igniter+%28Rheem+OEM+or+compatible%29&tag=errorcodefixes-20) \| Match the connector type and mounting bracket to your model. |
| Spark igniter assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rheem-furnace-igniter-not-working&k=Spark+igniter+assembly&tag=errorcodefixes-20) \| For models with spark ignition, includes electrode and wire lead. |
| Flame sensor rod | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rheem-furnace-igniter-not-working&k=Flame+sensor+rod&tag=errorcodefixes-20) \| Replace if cleaning does not restore continuity or if the ceramic insulator is cracked. |
