---
title: "Maytag Refrigerator Fresh Food Warm But Freezer Cold - Fix"
description: "Stuck or failed evaporator fan is the most common cause. Check the fan for ice buildup or motor failure, then inspect the damper control."
pubDatetime: 2026-06-09T23:19:51Z
modDatetime: 2026-06-09T23:19:51Z
...
1. Verify the refrigerator is powered on, set to the correct temperature, and not in demo or Sabbath mode.
2. Check the fresh food air vents and remove any obstructions or overpacked food that might be blocking airflow.
3. Open the freezer and hold the door switch closed to command the evaporator fan on, then listen and feel for airflow from the vents.
4. Remove the evaporator cover and inspect the coil for heavy frost or ice buildup that would block airflow.
5. Disconnect power and spin the evaporator fan blade by hand to check for binding, then test the motor windings for continuity with an ohmmeter.
6. Inspect the damper control assembly for being broken or stuck in the closed position, and verify it opens and closes freely.
7. Test the defrost heater for continuity after disconnecting power, and check the drain tube for blockages that could cause ice buildup.
8. Pull the unit out and vacuum the condenser coils, then inspect the door gaskets for tears or gaps and verify the unit is level.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Evaporator fan motor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-maytag-refrigerator-fresh-food-warm-but-freezer-cold&k=Evaporator+fan+motor&tag=errorcodefixes-20) \| Match your model number, typically 20 to 4,000 ohm resistance range for round or C-frame motors. |
| Damper control assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-maytag-refrigerator-fresh-food-warm-but-freezer-cold&k=Damper+control+assembly&tag=errorcodefixes-20) \| Includes the damper door and actuator, often model-specific. |
| Defrost heater | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-maytag-refrigerator-fresh-food-warm-but-freezer-cold&k=Defrost+heater&tag=errorcodefixes-20) \| Test for continuity before replacing, usually mounted on or near the evaporator coil. |
| Thermistor or temperature sensor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-maytag-refrigerator-fresh-food-warm-but-freezer-cold&k=Thermistor+or+temperature+sensor&tag=errorcodefixes-20) \| Located in the fresh food or freezer section, check resistance according to temperature charts for your model. |
