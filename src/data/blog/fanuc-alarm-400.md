...
| Part | Notes |
|------|-------|
| Servo amplifier cooling fan | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-fanuc-alarm-400&k=Servo+amplifier+cooling+fan&tag=errorcodefixes-20) \| Match voltage and CFM; Fanuc uses 24VDC fans on most amplifiers |
| Ball screw nut or bearings | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-fanuc-alarm-400&k=Ball+screw+nut+or+bearings&tag=errorcodefixes-20) \| Replace if mechanical binding is the confirmed cause |
| Servo amplifier module | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-fanuc-alarm-400&k=Servo+amplifier+module&tag=errorcodefixes-20) \| Replace if amplifier fails to reset after cooling and cause is identified/corrected |
## When to Call a Pro
