---
title: "Amana Refrigerator Fresh Food Warm but Freezer Cold - Fix"
description: "Most often blocked air vents or a frosted evaporator from a failed defrost system. Check vents, then test the evaporator fan and defrost components."
pubDatetime: 2026-06-10T12:45:35Z
modDatetime: 2026-06-10T12:45:35Z
...
1. Verify the complaint by checking actual temperatures in both compartments and confirming the compressor is running and the freezer is cold.
2. Inspect all air vents between the freezer and refrigerator for blockages from food, packaging, or ice buildup and clear any obstructions.
3. Listen for the evaporator fan running when the compressor is on, typically located behind the rear panel in the freezer, and check for ice or physical blockage if the fan is silent.
4. Remove the freezer rear panel and inspect the evaporator coil for heavy frost or solid ice buildup that would block airflow.
5. If the evaporator is iced over, manually defrost the unit and then test the defrost heater, defrost thermostat, and defrost control or timer for continuity and operation.
6. Check the air damper between compartments to verify it opens and closes freely and is not stuck closed or iced shut.
7. Confirm temperature control settings match factory recommendations (37 °F refrigerator, 0 °F freezer) and allow 24 hours after any adjustment before retesting.
8. If airflow, defrost, damper, and fan all check good, test the fresh food thermistor, control board inputs, and compressor start relay for secondary faults.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Evaporator fan motor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-amana-refrigerator-fresh-food-warm-but-freezer-cold&k=Evaporator+fan+motor&tag=errorcodefixes-20) \| Moves cold air from the evaporator into both compartments. |
| Defrost heater | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-amana-refrigerator-fresh-food-warm-but-freezer-cold&k=Defrost+heater&tag=errorcodefixes-20) \| Melts frost from the evaporator coil during defrost cycles. |
| Defrost thermostat or bi-metal | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-amana-refrigerator-fresh-food-warm-but-freezer-cold&k=Defrost+thermostat+or+bi-metal&tag=errorcodefixes-20) \| Controls when the defrost heater turns on and off. |
| Air damper control | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-amana-refrigerator-fresh-food-warm-but-freezer-cold&k=Air+damper+control&tag=errorcodefixes-20) \| Regulates airflow between freezer and fresh food sections. |
