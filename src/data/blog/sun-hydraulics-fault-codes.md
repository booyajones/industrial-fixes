...
| Part | Notes |
|------|-------|
| Deutsch DT connector pins | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-sun-hydraulics-fault-codes&k=Deutsch+DT+connector+pins&tag=errorcodefixes-20) \| Most common fault location |
| Solenoid coil (12VDC or 24VDC) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-sun-hydraulics-fault-codes&k=Solenoid+coil+%2812VDC+or+24VDC%29&tag=errorcodefixes-20) \| Replace on short/open |
| Pressure transducer | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-sun-hydraulics-fault-codes&k=Pressure+transducer&tag=errorcodefixes-20) \| Replace on signal fault |
| CAN bus termination resistor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-sun-hydraulics-fault-codes&k=CAN+bus+termination+resistor&tag=errorcodefixes-20) \| 120 ohm |
| Murphy display module | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-sun-hydraulics-fault-codes&k=Murphy+display+module&tag=errorcodefixes-20) \| Replace on screen or power faults |
## When to Call a Pro
