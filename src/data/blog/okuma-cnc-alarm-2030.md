...
| Part | Notes |
|------|-------|
| Spindle encoder | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-okuma-cnc-alarm-2030&k=Spindle+encoder&tag=errorcodefixes-20) \| Okuma uses proprietary encoders; must be Okuma OEM |
| Spindle drive (PREX or DRIVE II) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-okuma-cnc-alarm-2030&k=Spindle+drive+%28PREX+or+DRIVE+II%29&tag=errorcodefixes-20) \| Replace if drive sub-fault indicates internal hardware failure |
| Spindle bearings | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-okuma-cnc-alarm-2030&k=Spindle+bearings&tag=errorcodefixes-20) \| Replace at a motor shop if bearing fault is confirmed |
## When to Call a Pro
