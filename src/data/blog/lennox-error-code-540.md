...
| Part | Notes |
|------|-------|
| iComfort S30/E30 thermostat | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lennox-error-code-540&k=iComfort+S30%2FE30+thermostat&tag=errorcodefixes-20) \| If thermostat is confirmed as the failed device |
| Communication wire (18/2 or 18/4) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lennox-error-code-540&k=Communication+wire+%2818%2F2+or+18%2F4%29&tag=errorcodefixes-20) \| Replace if continuity test reveals a break; use Lennox-approved cable |
| Outdoor unit communication board | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lennox-error-code-540&k=Outdoor+unit+communication+board&tag=errorcodefixes-20) \| Interface board specific to the condenser model |
## When to Call a Pro
