---
title: "Samsung Refrigerator Not Cooling - Causes & Fix"
description: "Most often caused by Cooling Off Mode being active or blocked vents. Check mode settings, clear obstructions, and power cycle the unit."
pubDatetime: 2026-06-01T15:22:27Z
modDatetime: 2026-06-01T15:22:27Z
...
1. Verify the unit has power and the Cooling Off Mode or demo mode is turned off.
2. Check temperature settings and confirm they are correct for normal operation.
3. Inspect door gaskets using a paper test (close the door on a sheet of paper and pull it out to check resistance) and verify doors close fully.
4. Check for blocked interior vents and remove any food or containers obstructing airflow inside the fresh-food and freezer sections.
5. Clean the condenser coils if dirty and verify condenser airflow is not restricted by clearance or obstructions.
6. Inspect the evaporator section for ice buildup or frost accumulation that could block airflow.
7. Run a forced defrost cycle or service diagnostic if your model supports it to evaluate defrost system function and clear any ice.
8. Test evaporator fan and condenser fan operation during normal run time and replace the motor if not running correctly.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Evaporator fan motor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-refrigerator-not-cooling&k=Evaporator+fan+motor&tag=errorcodefixes-20) \| Circulates air over the evaporator coil |
| Defrost heater | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-refrigerator-not-cooling&k=Defrost+heater&tag=errorcodefixes-20) \| Melts frost from the evaporator during defrost cycles |
| Condenser fan motor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-refrigerator-not-cooling&k=Condenser+fan+motor&tag=errorcodefixes-20) \| Moves air across the condenser coils for heat rejection |
