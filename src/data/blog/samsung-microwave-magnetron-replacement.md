---
title: "Samsung Microwave Magnetron Replacement - Signs & How-To"
description: "Microwave runs but won't heat, shows E-21/E-22 or F-1/F-2 errors, or sparks inside. Replacing the magnetron or its thermal cutoff restores heating."
pubDatetime: 2026-06-01T21:18:58Z
...
- **Microwave runs but food stays cold** The turntable spins, the light is on, and the timer counts down, but nothing heats.
- **E-21 or E-22 error code on display** Samsung magnetron overtemperature fault, often caused by blocked airflow or a failed sensor.
- **F-1 or F-2 error code on display** Thermal cutoff near the magnetron has opened (F-1) or shorted (F-2).
- **Sparking or arcing inside the cavity** Visible sparks near the waveguide cover can mean magnetron damage or waveguide burn-through.
- **Loud buzzing or humming with no heat** The transformer and magnetron make noise but the magnetron isn't producing microwave energy.
- **Burn smell or scorch marks near the magnetron** Overheating or internal arcing in the magnetron can leave visible damage or odor.
...
| Part | Notes |
|------|-------|
| Samsung microwave magnetron | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-microwave-magnetron-replacement&k=Samsung+microwave+magnetron&tag=errorcodefixes-20) \| Find your model and serial number on the label inside the door frame or on the back panel, then cross-reference that model number with Samsung or an aftermarket parts supplier to get the correct magnetron. |
| Magnetron waveguide gasket or seal | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-microwave-magnetron-replacement&k=Magnetron+waveguide+gasket+or+seal&tag=errorcodefixes-20) \| Usually comes with the new magnetron, but verify before you start the job because reusing a damaged gasket can cause arcing. |
| Magnetron thermal cutoff or temperature sensor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-microwave-magnetron-replacement&k=Magnetron+thermal+cutoff+or+temperature+sensor&tag=errorcodefixes-20) \| Order this separately if your error code is F-1 or F-2 and the magnetron itself tests good. |
