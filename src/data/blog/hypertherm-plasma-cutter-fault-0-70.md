...
| Part | Notes |
|------|-------|
| Input capacitor bank | Degrades with age; requires authorized service to replace |
| PFC module | Fails on heavily used machines; authorized service only |
| Input power cable | Replace if cord is damaged or plug is corroded |
