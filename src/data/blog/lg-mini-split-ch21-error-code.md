...
| Part | Notes |
|---|---|
| Outdoor fan run capacitor | LG-specific — match µF and voltage |
| Outdoor fan motor | Match HP, RPM, and shaft diameter |
| High-pressure switch | LG part — match trip pressure (590 psig for R-410A) |
| Condenser coil | Extensive fin damage — clean before condemning |
