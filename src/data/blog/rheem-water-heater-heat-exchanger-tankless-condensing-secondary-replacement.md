---
title: "Rheem Tankless Water Heater Secondary Heat Exchanger Replacement"
description: "Low outlet temp, error 29, water leaks, poor hot water flow, and visible corrosion mean your secondary heat exchanger has failed. Replacing it restores proper heating and clears the fault."
pubDatetime: 2026-06-01T21:40:38Z
modDatetime: 2026-06-01T21:40:38Z
...
- **Error code 29 on the display** The controller shows fault 29, indicating heat exchanger outlet temperature is too low and the unit shuts down or will not ignite.
- **Water dripping from the heat exchanger area** You see water pooling under the unit or dripping from seams around the secondary exchanger, meaning the exchanger has corroded through.
- **Weak or intermittent hot water flow** Hot water runs cooler than setpoint or cuts out during use because the secondary exchanger cannot transfer enough heat.
- **Visible rust or white mineral deposits on exchanger fins** The fins and tubes show heavy corrosion, flaking metal, or thick white scale buildup that restricts airflow and heat transfer.
- **Condensate backup or moisture on sensor wiring** Condensate collects around the sensor area or drips onto electrical connectors, causing false temperature readings and triggering error 29.
- **Persistent low outlet temperature after cleaning** You have cleaned the air inlet, combustion chamber, and vent path but the outlet temperature remains low and the fault returns.
...
| Part | Notes |
|------|-------|
| Rheem secondary heat exchanger assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rheem-water-heater-heat-exchanger-tankless-condensing-secondary-replacement&k=Rheem+secondary+heat+exchanger+assembly&tag=errorcodefixes-20) \| Find your exact model and serial number on the data plate inside the front cover or on the right side of the unit, then cross-reference that model number on the Rheem parts website or call a parts supplier to get the correct secondary exchanger part number for your specific tankless model. |
| Heat exchanger gasket kit | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rheem-water-heater-heat-exchanger-tankless-condensing-secondary-replacement&k=Heat+exchanger+gasket+kit&tag=errorcodefixes-20) \| Some Rheem secondary exchangers ship with new gaskets or O-rings included, but if yours does not, order the gasket set that matches your model to prevent leaks at the inlet and outlet connections. |
