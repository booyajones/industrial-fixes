...
| Part | Notes |
|------|-------|
| Way lube metering unit | [Amazon](https://www.amazon.com/s?k=Way+lube+metering+unit&tag=errorcodefixes-20) \| Replace if Z-axis is running dry |
| Servo motor brake assembly | [Amazon](https://www.amazon.com/s?k=Servo+motor+brake+assembly&tag=errorcodefixes-20) \| If brake is dragging |
| Counterbalance seals / regulator parts | [Amazon](https://www.amazon.com/s?k=Counterbalance+seals+%2F+regulator+parts&tag=errorcodefixes-20) \| If pressure will not hold |
| Z-axis thrust bearings | [Amazon](https://www.amazon.com/s?k=Z-axis+thrust+bearings&tag=errorcodefixes-20) \| Replace if ballscrew is tight or noisy |
## When to Call a Pro
