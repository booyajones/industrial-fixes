---
title: "GE Dryer Won't Tumble - Causes & Fix"
description: "Usually a broken drive belt or open thermal fuse stops the drum. Check belt first, then test the fuse and door switch for continuity."
pubDatetime: 2026-06-01T15:19:07Z
modDatetime: 2026-06-01T15:19:07Z
...
1. Verify the symptom precisely: note whether the dryer is completely dead, hums, cycles on and off, or runs without drum motion to focus your diagnostic path.
2. Check the door latch and listen for the door-switch click when you close the door, then reset the breaker and confirm the outlet is live.
3. Test the outlet under load if you have access: on electric dryers, verify about 120 V from each hot leg to neutral and about 208 V or higher across the two hot legs.
4. Unplug the dryer, remove the front or top panel, and manually spin the drum by hand to feel for resistance or grinding that indicates a mechanical bind.
5. Inspect the drive belt around the drum and motor pulley: if it is broken, off the pulley, or visibly stretched, replace it.
6. Use a multimeter to test the thermal fuse, high-limit thermostat, and door switch for continuity with power removed: an open reading means the part must be replaced.
7. Check the start switch and timer or control-board contacts for proper continuity or switching action if all safeties test good.
8. If the belt and safeties are intact but the drum still won't turn, test for voltage at the motor terminals during a start attempt and inspect the idler pulley, rollers, and motor for seizure or failure.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Dryer drum belt | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-dryer-wont-tumble&k=Dryer+drum+belt&tag=errorcodefixes-20) \| Match the belt length and width to your model number for proper tension and fit. |
| Thermal fuse | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-dryer-wont-tumble&k=Thermal+fuse&tag=errorcodefixes-20) \| A one-time safety device that opens permanently when overheated. |
| Door switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-dryer-wont-tumble&k=Door+switch&tag=errorcodefixes-20) \| Tests for continuity when the door is closed, usually a simple two-terminal component. |
| Idler pulley assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-dryer-wont-tumble&k=Idler+pulley+assembly&tag=errorcodefixes-20) \| Includes the spring-loaded arm and pulley that keeps belt tension. |
