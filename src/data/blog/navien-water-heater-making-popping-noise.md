---
title: "Navien Water Heater Popping Noise - Causes & Fix"
description: "Popping usually means scale or sediment has built up on the heat exchanger. Flush and descale the unit to remove mineral deposits."
pubDatetime: 2026-06-11T22:42:28Z
modDatetime: 2026-06-11T22:42:28Z
...
1. Check the unit display for any active error codes before disassembly, since codes narrow the diagnosis even when the complaint is noise.
2. Verify the sound source by listening carefully to determine whether the popping comes from the unit body, water piping, or the vent and exhaust path.
3. Inspect and tighten all mounting hardware, panel screws, and pipe fittings to rule out loose components vibrating during operation.
4. Check inlet water flow by confirming there is no blockage at the inlet strainer, that the shutoff valves are fully open, and that recirculation pumps (if installed) are running correctly.
5. Remove and inspect the flow sensor for sediment or debris, clean it if dirty, and confirm it is seated properly.
6. Perform a full flush and descale of the heat exchanger using a pump and descaling solution to remove mineral buildup from the water side.
7. Inspect the venting and exhaust path for obstructions, proper slope, and correct installation per manufacturer guidelines, especially if the sound comes from that area.
8. Run hot water at full flow after cleaning and reassembly, listen for the popping noise, and verify stable temperature rise and smooth operation.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Descaling kit (pump, hoses, and cleaning solution) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-navien-water-heater-making-popping-noise&k=Descaling+kit+%28pump%2C+hoses%2C+and+cleaning+solution%29&tag=errorcodefixes-20) \| Used to flush mineral scale from the heat exchanger during routine maintenance. |
| Inlet filter screen or strainer | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-navien-water-heater-making-popping-noise&k=Inlet+filter+screen+or+strainer&tag=errorcodefixes-20) \| Replace if clogged or damaged to restore proper flow and prevent sediment from reaching the flow sensor. |
| Flow sensor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-navien-water-heater-making-popping-noise&k=Flow+sensor&tag=errorcodefixes-20) \| Replace if cleaning does not restore accurate flow readings or if the sensor is visibly damaged. |
