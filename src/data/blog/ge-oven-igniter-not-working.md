---
title: "GE Oven Igniter Not Working - Causes & Fix"
description: "A weak or failed igniter is the most common cause. Replace the igniter if it glows but won't light the burner or shows no continuity."
pubDatetime: 2026-06-01T18:46:11Z
modDatetime: 2026-06-01T18:46:11Z
author: "Marcus Webb"
featured: false
draft: false
tags:
...
1. Verify the oven is a gas model and that the range is plugged in, the circuit breaker is on, and the oven controls are set correctly for bake or broil.
2. Check whether the main gas regulator at the wall or appliance connection is in the ON position, especially if the oven was recently installed or moved.
3. Turn on bake or broil and observe whether the igniter glows red after a few seconds.
4. If the igniter does not glow at all, turn off power at the breaker and use a multimeter to test the igniter for continuity (a healthy igniter typically reads 50 to 200 ohms, while an open circuit indicates failure).
5. If the igniter glows but the burner does not light after 60 to 90 seconds, the igniter is weak and should be replaced because it cannot draw the 3.2 to 3.25 amps required to open the gas valve.
6. Access the igniter by removing the oven racks, lifting or removing the oven floor panel, and disconnecting the igniter from the burner tube and wiring harness.
7. Install the new igniter, reconnect the wiring, reassemble the oven floor and racks, restore power and gas, and run a bake cycle to confirm the burner lights within 60 seconds.

## Parts You Might Need

| Part | Notes |
|------|-------|
| GE oven igniter (glow-bar igniter) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-oven-igniter-not-working&k=GE+oven+igniter+%28glow-bar+igniter%29&tag=errorcodefixes-20) \| Match your model number for the correct igniter assembly. |
| Oven gas safety valve | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-oven-igniter-not-working&k=Oven+gas+safety+valve&tag=errorcodefixes-20) \| Required only if the valve itself is defective, which is much less common than igniter failure. |
