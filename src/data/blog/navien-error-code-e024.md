...
| Part | Notes |
|---|---|
| Thermal fuse | Navien part B001-41 or equivalent — match temperature rating |
| Outlet thermistor | Navien part — check resistance at known temperature |
| Inlet filter screen | Stainless mesh — clean every 6 months in hard water areas |
| Descaling kit | Pump + hoses + solution — available from Navien or plumbing supply |
