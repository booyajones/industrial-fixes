...
1. **Shut off power at the breaker** — Turn off the circuit breaker or pull the fuse for the furnace. Do not work on wiring with power live.
2. **Locate the furnace disconnect or power entry** — Open the disconnect box mounted on or near the furnace, or locate the power inlet on the furnace cabinet.
3. **Identify wire polarity** — The black (hot) wire must connect to the hot terminal (brass screw or terminal labeled L1/HOT). The white (neutral) wire must connect to the neutral terminal (silver screw or terminal labeled N/NEUTRAL).
4. **Correct reversed wires** — If the wires are swapped, move them to their correct terminals. Secure all connections tightly.
5. **Test the outlet if applicable** — Use a three-light outlet tester to verify receptacle polarity before plugging the furnace back in.
6. **Use a multimeter to verify at the furnace** — With power restored, measure between the black wire and ground: you should read approximately 120V AC. Between white wire and ground should read near 0V.
7. **Reset the system** — Restore power, call for heat at the thermostat, and confirm the 9-flash code is cleared and the furnace operates through a full cycle.

## Parts Often Needed

| Part | Notes |
|------|-------|
| Outlet polarity tester | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rheem-furnace-9-flashes&k=Outlet+polarity+tester&tag=errorcodefixes-20) \| 3-light tester costs under $10 and identifies reversed polarity instantly |
| Wire nuts and connectors | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-rheem-furnace-9-flashes&k=Wire+nuts+and+connectors&tag=errorcodefixes-20) \| For re-terminating corrected wiring |
| Furnace control board | [Amazon](https://www.amazon.com/dp/B0CNZGZ1HS?ascsubtag=ecf-rheem-furnace-9-flashes&tag=errorcodefixes-20) \| Only if board was damaged by extended operation with reversed polarity |
## When to Call a Pro
