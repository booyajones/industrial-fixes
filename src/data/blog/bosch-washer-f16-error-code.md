...
description: "F16 means the door is open or the lock failed. Most often the door isn't fully latched or debris blocks the latch. Clean and re-test."
pubDatetime: 2026-05-31T03:26:37Z
modDatetime: 2026-05-31T03:26:37Z
author: "Marcus Webb"
featured: false
draft: false
tags:
...
1. **Open and firmly re-close the door** until you hear an audible click, confirming the latch has engaged the strike.
2. **Inspect the door gasket and latch area** for clothing, lint, detergent buildup, or any foreign object, and remove anything that would prevent a square closure.
3. **Wipe the gasket and latch strike clean** with a damp cloth, then test the door closure again.
4. **Check that the door hangs square** when closed and that the latch aligns with the strike. If the door sags or sits crooked, inspect the hinges for looseness or wear.
5. **Unplug the washer and inspect the door lock assembly connector** on the inside of the door frame for loose pins, corrosion, or damaged wires, and reseat or repair as needed.
6. **Test or replace the door lock assembly** if the mechanical latch does not engage smoothly or if the connector and wiring are intact but the code persists.
7. **Perform the control reset procedure** for your Bosch model after any lock replacement to clear any stored fault, then run a short test cycle to verify the repair.

## Parts Often Needed

| Part | Notes |
|------|-------|
| Door lock / door interlock assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-bosch-washer-f16-error-code&k=Door+lock+%2F+door+interlock+assembly&tag=errorcodefixes-20) \| Primary replacement when the latch will not engage or the electrical signal is missing. |
| Door lock wiring harness or connector | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-bosch-washer-f16-error-code&k=Door+lock+wiring+harness+or+connector&tag=errorcodefixes-20) \| Replace if pins are corroded, wires are broken, or the plug does not seat firmly. |
| Door hinge | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-bosch-washer-f16-error-code&k=Door+hinge&tag=errorcodefixes-20) \| Replace if the door sags or no longer closes square, preventing latch alignment. |
