---
title: "GE Dryer Drive Motor Replacement - Signs & How-To"
description: "A failed GE dryer motor causes no start, humming, or no drum spin. Replacing the drive motor restores proper drum and blower operation."
pubDatetime: 2026-06-01T16:04:59Z
modDatetime: 2026-06-01T16:04:59Z
author: "Marcus Webb"
featured: false
draft: false
tags:
...
- **Dryer will not start at all** You press start but nothing happens, which points to an open motor circuit or failed internal switch.
- **Motor hums but drum does not turn** The motor tries to run and makes a humming noise, but the drum stays still because of seized bearings or a failed centrifugal switch.
- **Drum spins but dryer produces no heat** If the motor's centrifugal switch is not closing, it won't send 120 VAC to the heating circuit and the dryer runs cold.
- **Dryer runs intermittently or stops mid-cycle** The motor cuts out randomly during operation, usually from failing windings or a switch that opens and closes at the wrong times.
- **Motor continuity test reads open or infinite ohms** A multimeter check on the motor terminals should read 0 ohms or very close to 0, so any open reading means the motor has failed.
- **No 120 VAC at motor red-wire terminal during heat cycle** When you test the motor red-wire terminal to the chassis ground on an AC volts setting during a regular heat cycle, you expect 120 VAC if the centrifugal switch is working.
...
| Part | Notes |
|------|-------|
| GE dryer drive motor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-dryer-drive-motor-replacement&k=GE+dryer+drive+motor&tag=errorcodefixes-20) \| Find your exact part number on the model and serial plate inside the door frame or on the rear panel, then cross-reference it with a GE parts supplier or the manufacturer's parts lookup. |
