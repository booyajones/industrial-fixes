---
title: "GE Refrigerator Not Cooling - Causes & Fix"
description: "Dirty condenser coils are the most common cause. Clean the coils at the back or bottom with a vacuum and brush to restore airflow."
pubDatetime: 2026-06-01T18:19:33Z
modDatetime: 2026-06-01T18:19:33Z
author: "Marcus Webb"
featured: false
draft: false
tags:
...
- **Failed condenser fan motor** The compressor runs but the rear or bottom fan does not spin, so the coils overheat and cooling drops off.
- **Failed evaporator fan motor** The freezer-side fan is silent, grinding, or clicking instead of moving cold air into the fresh-food compartment.
- **Defrost system failure** A bad defrost heater, thermostat, or timer lets frost pile up on the evaporator, blocking airflow and raising temperatures.
- **Demo mode active** Controls and lights work normally but cooling is completely disabled by the showroom mode setting.
- **Incorrect temperature control or failed thermistor** The control board receives wrong temperature readings or the user setting is too high, so the compressor does not run enough.
- **Compressor or inverter control problem** On variable-speed models the control board cannot drive the compressor correctly, so the unit never gets cold.
...
| Part | Notes |
|------|-------|
| Condenser fan motor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-refrigerator-not-cooling&k=Condenser+fan+motor&tag=errorcodefixes-20) \| Located near the compressor at the back or bottom of the cabinet. |
| Evaporator fan motor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-refrigerator-not-cooling&k=Evaporator+fan+motor&tag=errorcodefixes-20) \| Mounted inside the freezer behind the evaporator cover panel. |
| Defrost heater and thermostat kit | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-refrigerator-not-cooling&k=Defrost+heater+and+thermostat+kit&tag=errorcodefixes-20) \| Usually sold together for the freezer evaporator coil. |
| Thermistor sensor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-refrigerator-not-cooling&k=Thermistor+sensor&tag=errorcodefixes-20) \| At 32°F a good thermistor reads around 16,600 ohms on a meter. |
