...
| Part | Notes |
|------|-------|
| Low-pressure switch | Replace if Code 22 persists with correct refrigerant charge |
| High-pressure switch | Replace if Code 24 persists with clean coil and correct charge |
| Condenser fan motor | Replace if not spinning or spinning slow; test capacitor first |
| Outdoor unit control board | For persistent Code 11 or Code 45 after wiring confirmed |
| Discharge temperature sensor | For Code 25 or Code 31 with correct refrigerant conditions |
