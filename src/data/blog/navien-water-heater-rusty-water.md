---
title: "Navien Water Heater Rusty Water - Causes & Fix"
description: "Rusty water usually means corrosion or sediment in the heat exchanger or supply plumbing. Flush the system and check for leaks."
pubDatetime: 2026-06-11T22:42:44Z
modDatetime: 2026-06-11T22:42:44Z
...
1. Turn off power and close the gas shutoff valve before inspecting or servicing the unit.
2. Identify whether the display shows a fault code like E003 or if rusty water is the only complaint without any error.
3. Check all isolation valves on the cold and hot water lines to confirm they are fully open and inspect supply plumbing upstream for visible rust or corrosion.
4. Remove and clean the inlet water filter screen, looking for rust particles, sediment, or heavy discoloration that indicates upstream contamination.
5. Flush the heat exchanger with a descaling solution per Navien service guidelines to remove mineral buildup and dislodge trapped sediment.
6. Inspect internal water-carrying components and connections for leaks, cracks, or signs of corrosion on the heat exchanger and fittings.
7. If the code is E003, verify gas supply pressure, check that the gas shutoff is open, and inspect air intake and venting for blockages.
8. Restore power and gas, run hot water at multiple fixtures, and observe whether discoloration clears after flushing or persists, indicating component replacement is needed.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Navien heat exchanger | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-navien-water-heater-rusty-water&k=Navien+heat+exchanger&tag=errorcodefixes-20) \| Replace if cracked, leaking, or heavily corroded after flushing fails to clear rusty water. |
| Inlet water filter screen | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-navien-water-heater-rusty-water&k=Inlet+water+filter+screen&tag=errorcodefixes-20) \| Clean first, replace if the mesh is torn or too fouled to restore flow. |
| Descaling flush kit | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-navien-water-heater-rusty-water&k=Descaling+flush+kit&tag=errorcodefixes-20) \| Use with manufacturer-approved descaler to remove scale and sediment during routine maintenance. |
