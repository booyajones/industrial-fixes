...
| [Channel fault](https://www.amazon.com/s?ascsubtag=ecf-schneider-m340-error-codes&k=Channel+fault&tag=errorcodefixes-20) | Individual I/O channel failure | Test wiring on channel; replace module if channel is burned |
| [Bus communication lost](https://www.amazon.com/s?ascsubtag=ecf-schneider-m340-error-codes&k=Bus+communication+lost&tag=errorcodefixes-20) | Backplane fault or module hardware failure | Replace module; check backplane ribbon |
...
| [Time-out on remote I/O](https://www.amazon.com/s?ascsubtag=ecf-schneider-m340-error-codes&k=Time-out+on+remote+I%2FO&tag=errorcodefixes-20) | Distributed Quantum or X80 remote I/O not responding |
