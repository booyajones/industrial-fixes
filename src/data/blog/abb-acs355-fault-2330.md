...
| Part | Notes |
|---|---|
| Motor (rewound or replacement) | Match HP, voltage, frame, and poles |
| Motor cable (shielded) | Use shielded 4-conductor cable for VFD applications |
| ACS355 drive | If output IGBT confirmed failed |
