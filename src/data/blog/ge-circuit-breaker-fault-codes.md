...
| Part | Notes |
|------|-------|
| DECS trip unit | Replace on electronics failure |
| Arc chutes (AKR/PowerBreak) | Replace after multiple fault trips |
| Auxiliary/alarm contacts | Replace when worn |
| M-DECS communication module | Replace on comm fault |
| Closing spring/motor mechanism | Replace on charge failure |
