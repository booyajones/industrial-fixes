...
| Part | Notes |
|------|-------|
| Braking resistor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-yaskawa-vfd-fault-codes&k=Braking+resistor&tag=errorcodefixes-20) \| Yaskawa ERF or ERV series, sized per drive catalog |
| Cooling fan | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-yaskawa-vfd-fault-codes&k=Cooling+fan&tag=errorcodefixes-20) \| Drive-specific; V1000: YPJP31-B fan assembly |
| Control power fuse | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-yaskawa-vfd-fault-codes&k=Control+power+fuse&tag=errorcodefixes-20) \| 2A time-lag, model-specific |
## When to Call a Pro
