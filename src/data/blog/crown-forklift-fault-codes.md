...
| Part | Notes |
|------|-------|
| Steer potentiometer | Replace on 03-xx fault |
| Motor thermal sensor | Replace on overheat fault |
| Encoder (drive motor) | Replace on 01-03 fault |
| Drive controller | Replace on persistent 01-xx fault |
| Battery indicator/display | Replace on 06-xx fault |
