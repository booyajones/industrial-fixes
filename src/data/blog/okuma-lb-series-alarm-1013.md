...
| Part | Notes |
|------|-------|
| Servo encoder cable | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-okuma-lb-series-alarm-1013&k=Servo+encoder+cable&tag=errorcodefixes-20) \| Replace if damaged; must match axis motor connector |
| Servo motor encoder | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-okuma-lb-series-alarm-1013&k=Servo+motor+encoder&tag=errorcodefixes-20) \| Replace if cable is fine but feedback is erratic |
| Servo amplifier | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-okuma-lb-series-alarm-1013&k=Servo+amplifier&tag=errorcodefixes-20) \| Replace if amplifier has its own internal fault |
## When to Call a Pro
