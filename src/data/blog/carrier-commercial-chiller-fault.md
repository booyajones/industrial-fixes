...
| Part | Notes |
|------|-------|
| Condenser fan motor | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-carrier-commercial-chiller-fault&k=Carrier+Condenser+fan+motor&tag=errorcodefixes-20) \| Match voltage, HP, and frame size from motor nameplate |
...
| High/low pressure switches | [Search on Amazon](https://www.amazon.com/s?ascsubtag=ecf-carrier-commercial-chiller-fault&k=Carrier+High%2Flow+pressure+switches&tag=errorcodefixes-20) \| Replace if trips occur at incorrect pressures with confirmed refrigerant charge |
