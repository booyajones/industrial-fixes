...
| Part | Notes |
|------|-------|
| Condenser fan motor | Match voltage, HP, and frame size from motor nameplate |
| Condenser fan capacitor | Test before replacing motor — capacitor is the more common failure |
| Refrigerant charge | R-410A on most 30XA models; confirm on data plate |
| High/low pressure switches | Replace if trips occur at incorrect pressures with confirmed refrigerant charge |
| Compressor | Last resort — confirm all other causes before replacing a scroll compressor |
