---
title: "Frigidaire Oven Clicking but Won't Light - Causes & Fix"
description: "Most often a weak igniter that glows but can't draw enough current to open the gas valve. Replace the igniter to restore lighting."
pubDatetime: 2026-06-10T23:06:32Z
modDatetime: 2026-06-10T23:06:32Z
...
1. Confirm the range has power at the breaker and outlet, because loss of electrical supply can prevent ignition controls from operating.
2. Verify the gas supply is on at the manual shutoff valve and that other gas appliances in the home operate normally.
3. Start a bake cycle and watch the igniter area through the oven window or with the door cracked open to see if the igniter glows and whether gas flows.
4. Turn off power and gas, remove the oven bottom panel, disconnect the igniter, and test it with a multimeter for continuity and resistance per the model's service manual.
5. Test the oven temperature sensor with a multimeter at room temperature (it should read around 1000 to 1100 ohms when cold).
6. With gas off for safety, check whether 120 V AC is present at the igniter leads when a bake cycle is called for, to confirm the control board is commanding ignition.
7. Inspect burner ports and the gas orifice for grease, carbon, or debris, and clean with a soft brush or compressed air if clogged.
8. Replace the failed igniter, temperature sensor, or control board as indicated by your test results, then restore power and gas and run a full bake cycle to confirm the oven lights and heats normally.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Oven igniter (hot-surface or spark type) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-oven-clicking-but-wont-light&k=Oven+igniter+%28hot-surface+or+spark+type%29&tag=errorcodefixes-20) \| Match the igniter style and part number to your Frigidaire model |
| Oven temperature sensor (probe) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-oven-clicking-but-wont-light&k=Oven+temperature+sensor+%28probe%29&tag=errorcodefixes-20) \| Should read 1000–1100 ohms cold |
| Oven control board or relay | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-oven-clicking-but-wont-light&k=Oven+control+board+or+relay&tag=errorcodefixes-20) \| Only if testing confirms no voltage output to igniter circuit |
