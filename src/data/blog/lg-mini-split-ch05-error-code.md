...
| Part | Notes |
|------|-------|
| Communication wire (2 or 3-conductor) | 18-22 AWG; run separately from power wiring |
| Indoor unit control board | Replace if board communication IC is confirmed failed |
| Outdoor unit control board | Replace if outdoor board is the confirmed fault |
| Terminal block connectors | Replace corroded terminals before replacing boards |
