...
| Part | Notes |
|------|-------|
| [Input fuses](https://www.amazon.com/s?k=Input%20fuses&tag=errorcodefixe-20) | Match the type and amperage from the ACS580 hardware manual for the specific frame size |
| [AC contactor](https://www.amazon.com/s?k=AC%20contactor&tag=errorcodefixe-20) | Replace if contact inspection shows pitting or high resistance under load |
| [Power terminal lug](https://www.amazon.com/s?k=Power%20terminal%20lug&tag=errorcodefixe-20) | Replace if existing lug is corroded or cracked |
