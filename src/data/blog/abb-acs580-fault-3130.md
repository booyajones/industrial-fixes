...
| Part | Notes |
|------|-------|
| Input fuses | Match the type and amperage from the ACS580 hardware manual for the specific frame size |
| AC contactor | Replace if contact inspection shows pitting or high resistance under load |
| Power terminal lug | Replace if existing lug is corroded or cracked |
