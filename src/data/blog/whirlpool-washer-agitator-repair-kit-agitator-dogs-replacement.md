---
title: "Whirlpool Washer Agitator Dogs Replacement - Signs & How-To"
description: "Upper agitator spins freely or won't move while lower half still turns. Replacing worn agitator dogs restores ratcheting action and wash performance."
pubDatetime: 2026-06-01T15:45:12Z
modDatetime: 2026-06-01T15:45:12Z
...
1. Unplug the washer from the wall outlet to shut off all power before starting any repair work.
2. Remove the fabric softener dispenser or cap from the top center of the agitator by pulling it straight up.
3. Use a socket wrench with a 7/16-inch socket to remove the agitator bolt from the center shaft.
4. Lift the entire agitator assembly straight up off the drive shaft (if it's stuck, gently rock it side to side to free it from the shaft).
5. Separate the upper and lower halves of the agitator by twisting or pulling them apart to access the dogs and cam inside.
6. Remove the old agitator dogs from the cam and inspect the cam surface, thrust washer, spacer, and seals for damage or wear.
7. Install the new set of four agitator dogs into the cam slots in the correct direction so the curved teeth face to engage the cam during rotation.
8. Reassemble the agitator halves, slide the assembly back onto the drive shaft, and thread the agitator bolt back in snugly with the 7/16-inch socket.
9. Replace the fabric softener dispenser or cap, plug the washer back in, and run a short agitation cycle to confirm the upper agitator now ratchets properly.

## The Part You Need

| Part | Notes |
|------|-------|
| Whirlpool agitator dogs kit (Part #80040) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-whirlpool-washer-agitator-repair-kit-agitator-dogs-replacement&k=Whirlpool+agitator+dogs+kit+%28Part+%2380040%29&tag=errorcodefixes-20) \| Cross-reference part numbers 285612, 285770, 3366877, 387091, 80040VP, AP3119063, PS388034. Check your washer's model and serial number plate (usually inside the door or on the back panel) to confirm fitment for your specific agitator style. |
| Whirlpool agitator repair kit (optional) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-whirlpool-washer-agitator-repair-kit-agitator-dogs-replacement&k=Whirlpool+agitator+repair+kit+%28optional%29&tag=errorcodefixes-20) \| Includes agitator dogs, cam, thrust washer, spacer, dust cap seal, and bolt seal if you need to replace all wear parts at once. Verify kit compatibility with your washer model number. |
