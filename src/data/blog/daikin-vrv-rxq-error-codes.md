...
| Part | Notes |
|------|-------|
| Outdoor PCB | Match exact RXQ model number |
| Electronic expansion valve (EEV) | Match refrigerant and valve size |
| Fan motor | VRV units often use DC motors |
| High-pressure switch | Match refrigerant type |
| Communication cable | F1/F2 — shielded type required |
