...
| Part | Notes |
|------|-------|
| Outdoor unit control PCB | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-mini-split-e1-error-code&k=Outdoor+unit+control+PCB&tag=errorcodefixes-20) \| Most common hardware fix for persistent E1 |
| Indoor unit control PCB | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-mini-split-e1-error-code&k=Indoor+unit+control+PCB&tag=errorcodefixes-20) \| Replace if outdoor board replacement doesn't resolve E1 |
| 3-conductor signal wire | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-mini-split-e1-error-code&k=3-conductor+signal+wire&tag=errorcodefixes-20) \| Replace if communication wire is damaged in the lineset |
| Surge protector | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-mini-split-e1-error-code&k=Surge+protector&tag=errorcodefixes-20) \| Install on outdoor unit if E1 followed a lightning/surge event |
## When to Call a Pro
