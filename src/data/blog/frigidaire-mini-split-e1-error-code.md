...
| Part | Notes |
|------|-------|
| Outdoor unit control PCB | Most common hardware fix for persistent E1 |
| Indoor unit control PCB | Replace if outdoor board replacement doesn't resolve E1 |
| 3-conductor signal wire | Replace if communication wire is damaged in the lineset |
| Surge protector | Install on outdoor unit if E1 followed a lightning/surge event |
