...
| Part | Notes |
|------|-------|
| Outdoor coil thermistor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-trane-heat-pump-error-code-e2&k=Outdoor+coil+thermistor&tag=errorcodefixes-20) \| Trane SEN1584 or model-specific; verify correct part |
