...
| Part | Notes |
|------|-------|
| Safety relay (24VDC) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-abb-vfd-fault-5010&k=Safety+relay+%2824VDC%29&tag=errorcodefixes-20) \| Match safety relay series (Pilz, Schmersal, Sick, etc.) |
| ABB STO option card (FSIO) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-abb-vfd-fault-5010&k=ABB+STO+option+card+%28FSIO%29&tag=errorcodefixes-20) \| ACS880 drives with separate STO option module |
| 24VDC control power supply | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-abb-vfd-fault-5010&k=24VDC+control+power+supply&tag=errorcodefixes-20) \| Replace if STO supply is failed |
| STO wiring (24VDC, shielded) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-abb-vfd-fault-5010&k=STO+wiring+%2824VDC%2C+shielded%29&tag=errorcodefixes-20) \| Replace any damaged conductors in the STO circuit |
## When to Call a Pro
