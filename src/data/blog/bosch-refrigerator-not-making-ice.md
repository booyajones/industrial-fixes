---
title: "Bosch Refrigerator Not Making Ice - Causes & Fix"
description: "Ice maker is usually switched off or Control Lock is active. Turn on the ice maker switch or press Lock button for 3 seconds."
pubDatetime: 2026-06-09T23:22:51Z
modDatetime: 2026-06-09T23:22:51Z
...
1. Check the ice maker switch behind the ice bucket or on the dispenser panel and confirm it is set to On.
2. Look for the Control Lock icon on the display and press and hold the Lock button for 3 seconds to disengage if lit.
3. Replace the water filter if it is older than 6 months or visibly clogged with sediment.
4. Measure freezer temperature with a separate thermometer and verify it reads 10°F or lower.
5. Remove the ice bucket and inspect the water fill tube at the back of the freezer for ice blockage, then use a hair dryer on low heat for 5 minutes to melt any buildup.
6. Test water pressure by disconnecting the inlet hose and opening the valve into a bucket to confirm flow is strong (minimum 20 psi required).
7. Locate the water inlet valve at the back of the refrigerator and use a multimeter to check for continuity across the solenoid coils (should read 200-500 ohms).
8. Clear any ice stuck in the dispenser chute or ice mold by hand or with warm water, then test the ejector arm for free movement.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Bosch refrigerator water filter | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-bosch-refrigerator-not-making-ice&k=Bosch+refrigerator+water+filter&tag=errorcodefixes-20) \| Replace every 6 months with OEM filter to maintain proper water flow |
| Water inlet valve | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-bosch-refrigerator-not-making-ice&k=Water+inlet+valve&tag=errorcodefixes-20) \| Solenoid-operated valve at the rear that opens to fill the ice maker |
| Ice maker assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-bosch-refrigerator-not-making-ice&k=Ice+maker+assembly&tag=errorcodefixes-20) \| Complete module if the ejector motor or fill mechanism is mechanically failed |
