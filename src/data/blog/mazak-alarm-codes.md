...
| Part | Notes |
|------|-------|
| Servo encoder cable | Route-specific; measure length before ordering |
| Lube oil pump | Bijur or Farval pump, machine-specific |
| ATC proximity switch | PNP or NPN — check existing wiring |
| Servo drive | Mitsubishi MDS-B or MDS-C series, machine-specific |
