...
| Part | Notes |
|------|-------|
| S-wire / signal wire | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lennox-mini-split-error-code-e1&k=S-wire+%2F+signal+wire&tag=errorcodefixes-20) \| 18 AWG, 2-conductor shielded recommended |
| Outdoor control PCB | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lennox-mini-split-error-code-e1&k=Outdoor+control+PCB&tag=errorcodefixes-20) \| Lennox OEM; verify firmware compatibility |
| Indoor control PCB | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-lennox-mini-split-error-code-e1&k=Indoor+control+PCB&tag=errorcodefixes-20) \| Replace only if outdoor board swap does not resolve |
## When to Call a Pro
