---
title: "Trane Furnace Blowing Cold Air - Causes & Fix"
description: "Usually the thermostat fan is set to On instead of Auto, so the blower runs non-stop even when burners are off. Switch to Auto."
pubDatetime: 2026-06-01T19:02:03Z
modDatetime: 2026-06-01T19:02:03Z
...
- **Dirty or clogged air filter** Restricted airflow causes the furnace to overheat and trip the high-limit safety switch, shutting down the burners while the blower continues to run.
- **Thermostat set to Cool or setpoint too low** The furnace will not call for heat if the mode is wrong or the setpoint is at or below the current room temperature.
- **Ignition failure or pilot outage** The igniter does not glow hot enough, the pilot flame is out on older units, or the burners are blocked and cannot light.
- **Dirty or failed flame sensor** The sensor cannot prove flame to the control board, so the board shuts the gas valve after a few seconds even though the burners briefly lit.
- **Pressure switch or venting problem** The inducer cannot pull proper draft due to blocked intake or exhaust piping, a plugged condensate trap, or a failed pressure switch, preventing the ignition sequence from starting.
- **Gas supply or gas valve issue** The manual gas shutoff is closed, the upstream supply is interrupted, or the gas valve does not open when the board sends the 24 V call during ignition.
...
| Part | Notes |
|------|-------|
| Hot-surface igniter | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-trane-furnace-blowing-cold-air&k=Hot-surface+igniter&tag=errorcodefixes-20) \| Fragile ceramic element that cracks or weakens over time and fails to ignite gas. |
| Flame sensor rod | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-trane-furnace-blowing-cold-air&k=Flame+sensor+rod&tag=errorcodefixes-20) \| Stainless rod that corrodes or coats with soot and cannot prove flame to the board. |
| Pressure switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-trane-furnace-blowing-cold-air&k=Pressure+switch&tag=errorcodefixes-20) \| Diaphragm switch that proves proper draft before allowing ignition, common failure on high-efficiency furnaces. |
| Furnace air filter | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-trane-furnace-blowing-cold-air&k=Furnace+air+filter&tag=errorcodefixes-20) \| Disposable or washable media that must be checked monthly and replaced when dirty. |
