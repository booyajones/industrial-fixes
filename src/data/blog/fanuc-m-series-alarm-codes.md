...
| Part | Notes |
|------|-------|
| Encoder battery | A06B-6073-K001, Fanuc standard |
| Fiber optic cable | Match spindle amplifier type |
| Servo motor encoder | Alpha-i or beta-i — match spec |
| Servo amplifier | Match axis current rating |
| Control board (CNC) | Contact Fanuc for PCB replacement |
