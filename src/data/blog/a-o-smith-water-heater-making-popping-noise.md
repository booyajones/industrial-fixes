---
title: "A.O. Smith Water Heater Popping Noise - Causes & Fix"
description: "Popping noise usually means sediment buildup at the tank bottom. Flush the tank to remove sediment and stop steam bubbles from popping."
pubDatetime: 2026-06-11T22:45:55Z
modDatetime: 2026-06-11T22:45:55Z
...
1. Verify whether the unit is electric or gas, then listen for when the noise occurs during the heating cycle or at startup.
2. Inspect the base, heating element areas, burner assembly, and all connected piping for visible leaks or wet spots.
3. If there is no leak and the noise is a pop or rumble, shut off power or set the gas control to Pilot and close the cold water supply.
4. Let the unit cool if needed, then attach a hose to the drain valve and route it to a safe drain location.
5. Open a hot water faucet somewhere in the house to prevent vacuum lock, then open the drain valve and drain the tank completely.
6. Reopen the cold water supply to flush remaining sediment until the water runs clear, then close the drain valve and refill the tank.
7. Restore power or gas operation and listen for the noise again during the next heating cycle.
8. If the noise persists on a gas unit, check and clean the vent and blower wheel, confirm they move freely, and inspect the burner assembly for debris or loose components.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Aluminum-zinc anode rod | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-a-o-smith-water-heater-making-popping-noise&k=Aluminum-zinc+anode+rod&tag=errorcodefixes-20) \| A.O. Smith suggests this as an alternative if you see bead-like material during draining or have corrosion issues. |
| Drain valve | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-a-o-smith-water-heater-making-popping-noise&k=Drain+valve&tag=errorcodefixes-20) \| Used during flushing. Replace if it leaks or does not seal properly after the flush procedure. |
| Vent or blower wheel components | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-a-o-smith-water-heater-making-popping-noise&k=Vent+or+blower+wheel+components&tag=errorcodefixes-20) \| For gas units where the noise comes from the combustion or vent path rather than sediment in the tank. |
