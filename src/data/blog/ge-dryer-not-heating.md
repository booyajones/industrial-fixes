---
title: "GE Dryer Not Heating - Causes & Fix"
description: "A GE dryer not heating is usually caused by incorrect voltage at the breaker panel or a failed igniter (gas) or heating element (electric)."
pubDatetime: 2026-06-01T15:18:29Z
modDatetime: 2026-06-01T15:18:29Z
...
1. Verify the dryer is set to a heated cycle, not Air Fluff or another no-heat setting, and confirm the symptom while the unit is running.
2. Check the home breaker panel for proper voltage and reset any tripped breakers supplying the dryer circuit.
3. Remove and clean the lint screen, then inspect the rear exhaust vent for blockage or heavy lint buildup and clear any restriction.
4. Enter the GE dryer diagnostic mode to retrieve stored fault codes and run service tests that isolate heating, airflow, or control faults.
5. For gas dryers, remove the front panel and test the igniter for cracks or an open circuit using a multimeter (expect 59 to 70 ohms).
6. For electric dryers, access the heating element and test for continuity; an open element must be replaced.
7. Test thermostats and thermal safety devices in the heat circuit for continuity and replace any component that does not match expected readings.
8. Reinstall all panels, restore power, and run a full heated cycle to confirm heat output returns to normal.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Gas dryer igniter | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-dryer-not-heating&k=Gas+dryer+igniter&tag=errorcodefixes-20) \| Glows to ignite the burner; should measure 59–70 ohms when functioning. |
| Electric dryer heating element | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-dryer-not-heating&k=Electric+dryer+heating+element&tag=errorcodefixes-20) \| Coil assembly that produces heat; replaced if open or burned out. |
| Thermostat or thermal fuse | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-dryer-not-heating&k=Thermostat+or+thermal+fuse&tag=errorcodefixes-20) \| Safety controls in the heat circuit; replaced if open or out of range. |
