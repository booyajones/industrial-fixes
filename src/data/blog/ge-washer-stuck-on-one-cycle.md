---
title: "GE Washer Stuck on One Cycle - Causes & Fix"
description: "Usually caused by electronic control lockup after a power or cycle interruption. Unplug for 2 minutes, restore power, and reselect the cycle."
pubDatetime: 2026-06-08T12:54:42Z
modDatetime: 2026-06-08T12:54:42Z
...
1. Unplug the washer or shut off power at the breaker for at least 2 minutes to reset the electronic controls.
2. Restore power and, if the model has a timer knob, turn it away from final spin and back to a normal cycle position, or reselect the cycle on electronic-control models.
3. Redistribute the laundry evenly in the basket and verify the washer is level front-to-back and side-to-side using a bubble level on top of the cabinet.
4. Enter diagnostic mode and retrieve any stored fault codes before replacing parts, then run a spin test and pump test to isolate the fault.
5. Disconnect power and spin the drum or basket by hand to check for smooth rotation, grinding, or heavy resistance that points to bearing or mechanical damage.
6. Inspect suspension springs, rods, and dampers for broken or bent parts if the basket wobbles or sits unevenly when empty.
7. Remove the drain pump, check that the impeller turns freely by hand, and measure resistance across the pump terminals (should be about 20 ohms).
8. After any repairs, clear stored codes in diagnostic mode and rerun the spin test to confirm the cycle advances normally.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Drain pump | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-washer-stuck-on-one-cycle&k=Drain+pump&tag=errorcodefixes-20) \| Should measure about 20 ohms and spin freely by hand |
| Suspension spring kit | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-washer-stuck-on-one-cycle&k=Suspension+spring+kit&tag=errorcodefixes-20) \| Replace all springs together to maintain even tension |
| Inverter motor assembly (front-load models) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-ge-washer-stuck-on-one-cycle&k=Inverter+motor+assembly+%28front-load+models%29&tag=errorcodefixes-20) \| Common on front-load GE washers that spin briefly then stop |
