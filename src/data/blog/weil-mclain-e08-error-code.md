...
| Part | Notes |
|------|-------|
| DHW thermistor/sensor | Match exact Weil-McLain part number for your model; resistance spec is model-specific |
| Sensor wire harness | Replace if wire insulation is damaged between sensor and control board |
