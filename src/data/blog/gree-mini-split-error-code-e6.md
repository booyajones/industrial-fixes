...
| Part | Notes |
|------|-------|
| Communication wire (3-conductor, 18 AWG) | If the existing wire is damaged; run new wire in conduit |
| Indoor or outdoor PCB | Only after eliminating all wiring and power causes |
