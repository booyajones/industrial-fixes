...
**Sourcing note:** Sub-Zero parts are available from [Amazon](https://www.amazon.com/s?k=sub-zero+refrigerator+parts&tag=errorcodefixes-20), authorized Sub-Zero parts distributors, and model-specific parts suppliers. Always confirm part compatibility with your full model number and serial number prefix before ordering. The same EC code can require different parts across serial number breaks within the same model series.
