...
| Part | Notes |
|------|-------|
| Heidenhain encoder cable | Replace if damaged; must match encoder interface type |
| Encoder read head | Replace if contaminated beyond cleaning |
| Linear scale cleaning kit | Heidenhain-approved cleaning solution and lint-free cloth |
