---
title: "Samsung Mini Split Won't Turn On - Causes & Fix"
description: "Most likely a tripped breaker or dead remote batteries. Check the circuit breaker first, then replace remote batteries and confirm power at the unit."
pubDatetime: 2026-06-11T22:39:48Z
modDatetime: 2026-06-11T22:39:48Z
...
1. Check the circuit breaker at the main panel and reset it if tripped, then verify any fused disconnect near the outdoor unit is intact and closed.
2. Replace the batteries in the remote control with fresh ones and confirm the remote is sending a signal to the indoor unit.
3. Measure line voltage at the disconnect or the indoor unit's power inlet to confirm proper supply voltage is present (refer to your model's manual for the required voltage).
4. Inspect and clean the air filter on the indoor head, and clear any debris or obstructions from around both the indoor and outdoor units.
5. Look for any displayed error codes or flashing LEDs on the indoor unit, and record them for further diagnosis or to share with a technician.
6. Check all visible wiring connections between the indoor and outdoor units for tightness, corrosion, or damage.
7. If the indoor unit powers up but the outdoor compressor does not start, listen for clicks or hums at the outdoor unit and check for refrigerant leaks or icing on the refrigerant lines.
8. If all power checks pass and the unit still won't respond, the indoor control board or outdoor inverter board likely needs professional testing and replacement.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Remote control batteries | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-mini-split-wont-turn-on&k=Remote+control+batteries&tag=errorcodefixes-20) \| Standard AA or AAA depending on model |
| Indoor unit control board | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-mini-split-wont-turn-on&k=Indoor+unit+control+board&tag=errorcodefixes-20) \| Requires exact model match |
| Air filter (reusable or replacement) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-samsung-mini-split-wont-turn-on&k=Air+filter+%28reusable+or+replacement%29&tag=errorcodefixes-20) \| Clean reusable filters or order OEM replacements |
