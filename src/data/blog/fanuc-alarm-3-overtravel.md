...
| Part | Notes |
|------|-------|
| Overtravel limit switch | [Amazon](https://www.amazon.com/dp/B0BN3TRG9R?ascsubtag=ecf-fanuc-alarm-3-overtravel&tag=errorcodefixes-20) \| Replace if physically damaged or triggering prematurely |
| Absolute encoder battery | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-fanuc-alarm-3-overtravel&k=Absolute+encoder+battery&tag=errorcodefixes-20) \| Replace if battery failure caused position loss that led to the homing overrun |
## When to Call a Pro
