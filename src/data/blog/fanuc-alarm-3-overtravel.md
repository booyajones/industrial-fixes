...
| Part | Notes |
|------|-------|
| Overtravel limit switch | Replace if physically damaged or triggering prematurely |
| Absolute encoder battery | Replace if battery failure caused position loss that led to the homing overrun |
