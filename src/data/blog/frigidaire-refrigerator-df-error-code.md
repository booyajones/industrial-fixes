---
title: "Frigidaire Refrigerator dF Error Code - Causes & Fix"
description: "dF means a defrost-circuit fault. The most common fix is replacing the defrost control board or checking the wiring harness and connectors."
pubDatetime: 2026-06-08T06:07:31Z
modDatetime: 2026-06-08T06:07:31Z
...
1. **Record your exact model number** from the label inside the refrigerator or on the back wall. Frigidaire error codes vary by platform, and the dF code may have different diagnostic paths on different models.
2. **Power-cycle the refrigerator** by unplugging it from the wall outlet for at least one minute (some references suggest up to several minutes). Plug it back in and check whether the dF code clears. If it does not return, monitor for 24 hours.
3. **Inspect the defrost-circuit wiring and connectors.** Unplug the unit, remove the rear access panel or freezer interior panels to expose the defrost control board and main control board. Check every harness connector for loose pins, corrosion, or damage. Reconnect any loose plugs and look for burned or melted wires.
4. **Test the temperature sensor or thermistor** if your model uses one in the defrost-control path (consult your wiring diagram). Disconnect the sensor connector and measure resistance across the sensor terminals with a multimeter. Compare the reading to the resistance table in your service manual. Replace the sensor if it reads open, shorted, or far out of range.
5. **Check the defrost control board and main control board.** If wiring and sensor tests pass, the defrost control board or the main control board is the likely culprit. Look for burn marks, swollen capacitors, or obvious damage. Replace the defrost control board first if accessible, since it is less expensive than the main board.
6. **Inspect the evaporator fan motor and harness** (on models where airflow faults can trigger or accompany defrost errors). Spin the fan blade by hand to confirm it turns freely. Check the fan connector and test the motor for continuity. Replace the fan motor if it is seized or shows no continuity.
7. **Clear the code and verify defrost operation.** After replacing any component, power the refrigerator back on and manually trigger a defrost cycle using the service test mode (consult your model's service sheet). Confirm that the defrost heater energizes and the code does not return.

## Parts Often Needed

| Part | Notes |
|------|-------|
| Frigidaire defrost control board | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-refrigerator-df-error-code&k=Frigidaire+defrost+control+board&tag=errorcodefixes-20) \| Match the part number on your existing board or use your model number to find the correct replacement. |
| Frigidaire refrigerator or freezer thermistor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-refrigerator-df-error-code&k=Frigidaire+refrigerator+or+freezer+thermistor&tag=errorcodefixes-20) \| Verify which sensor is used in the defrost-control circuit on your model before ordering. |
| Frigidaire main control board | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-refrigerator-df-error-code&k=Frigidaire+main+control+board&tag=errorcodefixes-20) \| Only replace if wiring, sensor, and defrost-control-board checks all pass and the fault persists. |
| Frigidaire evaporator fan motor | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-frigidaire-refrigerator-df-error-code&k=Frigidaire+evaporator+fan+motor&tag=errorcodefixes-20) \| Needed on models where fan-circuit faults appear alongside defrost-system errors. |
