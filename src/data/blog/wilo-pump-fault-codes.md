...
| Part | Notes |
|------|-------|
| Impeller assembly | Match pump model and impeller diameter |
| Electronic insert (motor head) | Full replacement motor assembly |
| Wilo-Net gateway | For BAS integration |
| Pressure sensor | Differential pressure transducer for variable speed control |
| Service kit | Seal and O-ring set |
