---
title: "Amana Refrigerator Light Not Working - Causes & Fix"
description: "Door left open over 10 minutes trips auto shutoff. Close all doors for 1 minute to reset, then check the door switch and alignment."
pubDatetime: 2026-06-10T12:45:59Z
modDatetime: 2026-06-10T12:45:59Z
...
1. Verify whether both refrigerator and freezer lights are out or only one compartment is affected.
2. Close all doors completely and leave them shut for one full minute, then open and check whether the light has reset.
3. Manually press the door switch in and out and watch for the light to respond, checking for mechanical interference or a stuck switch.
4. Check that the refrigerator is level front to back and side to side, and inspect door alignment to confirm the door is engaging the switch when closed.
5. Remove any magnets, phones, or electronic devices within three inches of the door switch area.
6. Unplug power to the refrigerator, remove the top hinge cover, and inspect the wiring harness plug for a loose or disconnected connection, then reconnect if needed.
7. Verify the refrigerator is not in Sabbath mode by consulting your model's user guide and exiting that mode if active.
8. For models with a replaceable bulb, unplug power and check whether the bulb is loose, burnt out, or damaged, and replace it with an appliance bulb of the same size, shape, and wattage not exceeding 40 watts, or for LED models inspect the light module and connectors for damage or a poor connection.

## Parts You Might Need

| Part | Notes |
|------|-------|
| Refrigerator door switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-amana-refrigerator-light-not-working&k=Refrigerator+door+switch&tag=errorcodefixes-20) \| Activates the light when the door opens. |
| Appliance light bulb | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-amana-refrigerator-light-not-working&k=Appliance+light+bulb&tag=errorcodefixes-20) \| 40 watts maximum, same size and shape as original on older models. |
| LED light assembly | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-amana-refrigerator-light-not-working&k=LED+light+assembly&tag=errorcodefixes-20) \| Full module used on newer Amana refrigerators, typically not a simple bulb swap. |
