...
| Part | Notes |
|------|-------|
| Fanuc encoder backup battery | [Amazon](https://www.amazon.com/s?k=Fanuc+encoder+backup+battery&tag=errorcodefixes-20) \| Match to Fanuc system — A06B-6073-K001 (6V) or model-specific |
| Battery cable harness | [Amazon](https://www.amazon.com/s?k=Battery+cable+harness&tag=errorcodefixes-20) \| Replace if corroded |
## When to Call a Pro
