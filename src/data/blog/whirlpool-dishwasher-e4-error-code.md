---
title: "Whirlpool Dishwasher E4 Error Code - Causes & Fix"
description: "E4 or F8E4 means water in the base pan triggered leak protection. Most often a loose inlet hose fitting. Clear code, dry pan, tighten fill."
pubDatetime: 2026-06-08T05:02:12Z
modDatetime: 2026-06-08T05:02:12Z
...
tags:
  ...
  - dishwasher
  - whirlpool
most_likely_cause: "water in the drip tray from a loose or improperly seated inlet hose fitting"
...
1. **Disconnect power** at the breaker and turn off the water supply valve under the sink or behind the dishwasher before beginning any inspection or repair work.
2. **Clear the code** by pressing Cancel once, then pressing Cancel again to silence the alarm and reset the control after you have addressed the underlying condition.
3. **Pull the dishwasher forward** enough to access the base pan underneath, or tip the unit back carefully on a towel to inspect the drip tray area for standing water.
4. **Remove and empty the drip pan** if water is present, then dry the pan and the float switch thoroughly with towels before reinstalling.
5. **Check the inlet hose fitting** at the water valve on the rear left of the unit, verify the rubber washer is seated properly, then hand-tighten and add an additional 1/4 to 1/2 turn with pliers to compress the gasket.
6. **Inspect the drain hose and visible plumbing** for cracks, loose clamps, or wetness that could drip into the base area, and tighten or replace as needed.
7. **Verify the float switch** in the base pan is connected to the wiring harness, moves freely, and is dry; if the switch does not click or show continuity when toggled, replace it.
8. **Restore power and water**, run a short rinse cycle, and monitor for leaks or recurrence of the code; if the fault returns with no visible water, suspect a wiring or control issue and consult a technician.

## Parts Often Needed

| Part | Notes |
|------|-------|
| Dishwasher inlet hose rubber washer | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-whirlpool-dishwasher-e4-error-code&k=Dishwasher+inlet+hose+rubber+washer&tag=errorcodefixes-20) \| Standard 3/4-inch flat rubber gasket for the fill connection; check that it is not cracked or missing. |
| Dishwasher base float switch | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-whirlpool-dishwasher-e4-error-code&k=Dishwasher+base+float+switch&tag=errorcodefixes-20) \| Leak-detection sensor in the drip pan; verify your model number to match the correct Whirlpool OEM or compatible part. |
| Dishwasher drain hose | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-whirlpool-dishwasher-e4-error-code&k=Dishwasher+drain+hose&tag=errorcodefixes-20) \| Corrugated or smooth rubber discharge hose; measure length and diameter to match your installation if replacement is needed. |
