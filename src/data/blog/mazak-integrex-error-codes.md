...
| Part | Notes |
|------|-------|
| Lube components | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-mazak-integrex-error-codes&k=Lube+components&tag=errorcodefixes-20) \| Low lube creates cascading faults |
| Proximity sensors | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-mazak-integrex-error-codes&k=Proximity+sensors&tag=errorcodefixes-20) \| ATC and magazine faults often trace here |
| Hydraulic switches | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-mazak-integrex-error-codes&k=Hydraulic+switches&tag=errorcodefixes-20) \| Clamp and utility alarms |
| Encoder cables | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-mazak-integrex-error-codes&k=Encoder+cables&tag=errorcodefixes-20) \| Servo fault source on aging machines |
| Battery / control backup parts | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-mazak-integrex-error-codes&k=Battery+%2F+control+backup+parts&tag=errorcodefixes-20) \| For control and memory complaints |
| Chiller service items | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-mazak-integrex-error-codes&k=Chiller+service+items&tag=errorcodefixes-20) \| Spindle thermal alarms |
## When to Call a Pro
