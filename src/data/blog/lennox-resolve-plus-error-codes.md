...
| 411 | Flame sensor fault | Dirty or failed flame sensor | Clean sensor, measure µA |
...
| Part | Notes |
|------|-------|
| Integrated control board | Must match unit model |
| Flame sensor | Measure µA before replacing |
| Inducer motor | Check capacitor first |
| Limit switch | Match temperature rating |
| ECM blower motor | Check motor module and control board |
