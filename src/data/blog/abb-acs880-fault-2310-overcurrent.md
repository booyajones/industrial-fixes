...
| Part | Notes |
|------|-------|
| Motor (replacement) | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-abb-acs880-fault-2310-overcurrent&k=Motor+%28replacement%29&tag=errorcodefixes-20) \| Replace when megohm test shows degraded insulation |
| Output motor cable | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-abb-acs880-fault-2310-overcurrent&k=Output+motor+cable&tag=errorcodefixes-20) \| Replace if cable insulation has failed; use VFD-rated cable |
| ACS880 IGBT module | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-abb-acs880-fault-2310-overcurrent&k=ACS880+IGBT+module&tag=errorcodefixes-20) \| Replace only after confirming the fault was caused by an external short that damaged internal semiconductors |
## When to Call a Pro
