...
| Part | Notes |
|------|-------|
| Servo pack | Match axis and current rating |
| Encoder battery | Absolute encoder backup |
| ATC proximity switches | Check position in sequence diagram |
| Hydraulic pressure switch | Chuck and tailstock circuits |
| Coolant pump | Check impeller and motor amps |
