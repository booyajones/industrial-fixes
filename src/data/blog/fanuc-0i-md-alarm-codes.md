...
| Part | Notes |
|---|---|
| Encoder battery | Common maintenance item on Fanuc controls |
| Pulse coder cable | Replace if oil-soaked or damaged |
| Limit switch | For repeated overtravel alarms |
| Servo amplifier | For persistent 401/500 alarms |
