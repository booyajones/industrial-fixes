...
| Part | Notes |
|---|---|
| Crankcase heater | Match wattage — Daikin part varies by compressor |
| Inverter PCB | High-value part — verify compressor first |
| Compressor | Requires refrigerant recovery — EPA 608 certified tech |
