...
| Part | Notes |
|------|-------|
| Contact tip | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-esab-welder-fault-code-f02&k=Contact+tip&tag=errorcodefixes-20) \| Replace if burnt, spattered, or worn |
| MIG gun nozzle | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-esab-welder-fault-code-f02&k=MIG+gun+nozzle&tag=errorcodefixes-20) \| Replace if spatter bridges to contact tip |
| MIG gun / torch cable | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-esab-welder-fault-code-f02&k=MIG+gun+%2F+torch+cable&tag=errorcodefixes-20) \| Replace if internal short is found |
| IGBT power module | [Amazon](https://www.amazon.com/s?ascsubtag=ecf-esab-welder-fault-code-f02&k=IGBT+power+module&tag=errorcodefixes-20) \| If F02 persists after all external causes are cleared — authorized service |
## When to Call a Pro
