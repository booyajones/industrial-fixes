...
| Part | Notes |
|------|-------|
| Expansion tank (2–5 gallon) | Replace when bladder fails; Amtrol Extrol is a common direct replacement |
| Auto-fill valve (Watts 911) | Replace if valve is stuck open (overpressure) or stuck closed (E10 recurrence) |
| Pressure relief valve | Replace if it's been weeping; a weeping PRV causes slow pressure loss |
