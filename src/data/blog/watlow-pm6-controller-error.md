...
| Part | Notes |
|------|-------|
| Thermocouple (Type K/J/T) | Match existing sensor type |
| RTD sensor (Pt100) | For RTD input PM6 versions |
| Solid-state relay | Match output type (SSR for current output) |
| Mechanical relay | For relay output versions |
| Replacement PM6 | Document all parameter values before replacing |
