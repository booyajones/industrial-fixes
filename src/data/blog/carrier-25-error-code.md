...
| Part | Notes |
|------|-------|
| Flame sensor | Replace if insulator is cracked or sensor rod is pitted |
| Gas valve | Replace only if confirmed leaking through after shutdown |
| Control board | Last resort if sense circuit is defective on board itself |
